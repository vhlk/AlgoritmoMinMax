...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Connect3", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Connect3", null, 800, 600);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "1";
		app.meta["company"] = "vhlk";
		app.meta["file"] = "Connect3";
		app.meta["name"] = "Connect3";
		app.meta["packageName"] = "com.sample.connect3";
