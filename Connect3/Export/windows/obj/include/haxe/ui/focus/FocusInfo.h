...
HX_DECLARE_STACK_FRAME(_hx_pos_c8939703bfe92536_15_new)
...
class HXCPP_CLASS_ATTRIBUTES FocusInfo_obj : public ::hx::Object
{
	...
	public:
		...
		inline static ::hx::ObjectPtr< FocusInfo_obj > __new() {
			::hx::ObjectPtr< FocusInfo_obj > __this = new FocusInfo_obj();
			__this->__construct();
			return __this;
		}

		inline static ::hx::ObjectPtr< FocusInfo_obj > __alloc(::hx::Ctx *_hx_ctx) {
...
{
            	HX_STACKFRAME(&_hx_pos_c8939703bfe92536_15_new)
            	}
		...
		::String __ToString() const { return HX_("FocusInfo",46,70,19,bf); }
