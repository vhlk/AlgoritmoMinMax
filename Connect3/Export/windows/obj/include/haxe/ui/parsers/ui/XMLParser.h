...
class HXCPP_CLASS_ATTRIBUTES XMLParser_obj : public  ::haxe::ui::parsers::ui::ComponentParser_obj
{
	...
	public:
		...
		::String __ToString() const { return HX_("XMLParser",f6,bd,a4,31); }
		...
		static void parseLayoutNode( ::haxe::ui::parsers::ui::ComponentInfo component, ::Xml xml);
		static ::Dynamic parseLayoutNode_dyn();
