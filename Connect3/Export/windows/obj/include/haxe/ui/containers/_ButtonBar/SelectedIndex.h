...
#define INCLUDED_haxe_ui_containers__ButtonBar_SelectedIndex
...
HX_DECLARE_CLASS4(haxe,ui,containers,_ButtonBar,SelectedIndex)
...
class HXCPP_CLASS_ATTRIBUTES SelectedIndex_obj : public  ::haxe::ui::behaviours::DataBehaviour_obj
{
	...
	public:
		enum { _hx_ClassId = 0x4a162369 };

		void __construct( ::haxe::ui::core::Component component);
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="haxe.ui.containers._ButtonBar.SelectedIndex")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"haxe.ui.containers._ButtonBar.SelectedIndex"); }
...
#endif /* INCLUDED_haxe_ui_containers__ButtonBar_SelectedIndex */ 
