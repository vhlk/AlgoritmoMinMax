...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("Connect3",29,ed,65,94),::ApplicationMain_obj::create_dyn());
...
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("vhlk",31,76,4e,4e));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("Connect3",29,ed,65,94));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Connect3",29,ed,65,94));
HXLINE(  39)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.sample.connect3",a0,8f,91,7e));
...
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Connect3",29,ed,65,94))
