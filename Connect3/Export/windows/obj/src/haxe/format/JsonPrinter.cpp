...
HX_DEFINE_STACK_FRAME(_hx_pos_8bfd59d5e6f3b55d_56_new,"haxe.format.JsonPrinter","new",0xeb68de75,"haxe.format.JsonPrinter.new","D:\\Victor\\Haxe\\haxe\\std/haxe/format/JsonPrinter.hx",56,0x5e81f976)
HX_LOCAL_STACK_FRAME(_hx_pos_8bfd59d5e6f3b55d_81_write,"haxe.format.JsonPrinter","write",0x755dea34,"haxe.format.JsonPrinter.write","D:\\Victor\\Haxe\\haxe\\std/haxe/format/JsonPrinter.hx",81,0x5e81f976)
...
HX_LOCAL_STACK_FRAME(_hx_pos_8bfd59d5e6f3b55d_158_classString,"haxe.format.JsonPrinter","classString",0x9219ba3e,"haxe.format.JsonPrinter.classString","D:\\Victor\\Haxe\\haxe\\std/haxe/format/JsonPrinter.hx",158,0x5e81f976)
HX_LOCAL_STACK_FRAME(_hx_pos_8bfd59d5e6f3b55d_165_fieldsString,"haxe.format.JsonPrinter","fieldsString",0x974bd375,"haxe.format.JsonPrinter.fieldsString","D:\\Victor\\Haxe\\haxe\\std/haxe/format/JsonPrinter.hx",165,0x5e81f976)
HX_LOCAL_STACK_FRAME(_hx_pos_8bfd59d5e6f3b55d_196_quote,"haxe.format.JsonPrinter","quote",0x02f6a091,"haxe.format.JsonPrinter.quote","D:\\Victor\\Haxe\\haxe\\std/haxe/format/JsonPrinter.hx",196,0x5e81f976)
...
HX_LOCAL_STACK_FRAME(_hx_pos_8bfd59d5e6f3b55d_44_print,"haxe.format.JsonPrinter","print",0x6d8fd582,"haxe.format.JsonPrinter.print","D:\\Victor\\Haxe\\haxe\\std/haxe/format/JsonPrinter.hx",44,0x5e81f976)
namespace haxe{
namespace format{

void JsonPrinter_obj::__construct( ::Dynamic replacer,::String space){
            	HX_GC_STACKFRAME(&_hx_pos_8bfd59d5e6f3b55d_56_new)
...
void JsonPrinter_obj::write( ::Dynamic k, ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_8bfd59d5e6f3b55d_81_write)
...
void JsonPrinter_obj::classString( ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_8bfd59d5e6f3b55d_158_classString)
...
void JsonPrinter_obj::fieldsString( ::Dynamic v,::Array< ::String > fields){
            	HX_STACKFRAME(&_hx_pos_8bfd59d5e6f3b55d_165_fieldsString)
HXLINE( 166)		{
...
void JsonPrinter_obj::quote(::String s){
            	HX_STACKFRAME(&_hx_pos_8bfd59d5e6f3b55d_196_quote)
HXLINE( 203)		{
...
::String JsonPrinter_obj::print( ::Dynamic o, ::Dynamic replacer,::String space){
            	HX_GC_STACKFRAME(&_hx_pos_8bfd59d5e6f3b55d_44_print)
