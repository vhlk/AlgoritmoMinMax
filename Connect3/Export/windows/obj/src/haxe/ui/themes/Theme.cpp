...
HX_DEFINE_STACK_FRAME(_hx_pos_78d817c3c3f18acf_11_new,"haxe.ui.themes.Theme","new",0x53240349,"haxe.ui.themes.Theme.new","haxe/ui/themes/Theme.hx",11,0x61905ea8)
...
HXLINE(  12)		this->styles = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  13)		this->images = ::Array_obj< ::Dynamic>::__new(0);
            	}
