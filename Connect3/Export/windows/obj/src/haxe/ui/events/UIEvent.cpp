...
HX_DEFINE_STACK_FRAME(_hx_pos_acfcc53ce94b5d2e_41_new,"haxe.ui.events.UIEvent","new",0x3c904bd5,"haxe.ui.events.UIEvent.new","haxe/ui/events/UIEvent.hx",41,0xa50e85dc)
HX_LOCAL_STACK_FRAME(_hx_pos_acfcc53ce94b5d2e_48_cancel,"haxe.ui.events.UIEvent","cancel",0x640c4925,"haxe.ui.events.UIEvent.cancel","haxe/ui/events/UIEvent.hx",48,0xa50e85dc)
HX_LOCAL_STACK_FRAME(_hx_pos_acfcc53ce94b5d2e_53_clone,"haxe.ui.events.UIEvent","clone",0x694d1612,"haxe.ui.events.UIEvent.clone","haxe/ui/events/UIEvent.hx",53,0xa50e85dc)
...
HX_LOCAL_STACK_FRAME(_hx_pos_acfcc53ce94b5d2e_29_boot,"haxe.ui.events.UIEvent","boot",0xb9cb0f1d,"haxe.ui.events.UIEvent.boot","haxe/ui/events/UIEvent.hx",29,0xa50e85dc)
...
void UIEvent_obj::__construct(::String type, ::Dynamic __o_bubble, ::Dynamic data){
            	...
            	HX_STACKFRAME(&_hx_pos_acfcc53ce94b5d2e_41_new)
HXLINE(  42)		this->type = type;
HXLINE(  43)		this->bubble = ( (bool)(bubble) );
HXLINE(  44)		this->data = data;
HXLINE(  45)		this->canceled = false;
            	}
...
void UIEvent_obj::cancel(){
            	HX_STACKFRAME(&_hx_pos_acfcc53ce94b5d2e_48_cancel)
HXLINE(  49)		this->super::cancel();
HXLINE(  50)		this->canceled = true;
            	}


 ::haxe::ui::events::UIEvent UIEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_acfcc53ce94b5d2e_53_clone)
HXLINE(  54)		 ::haxe::ui::events::UIEvent c =  ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,this->type,null(),null());
HXLINE(  55)		c->type = this->type;
HXLINE(  56)		c->bubble = this->bubble;
HXLINE(  57)		c->target = this->target;
HXLINE(  58)		c->data = this->data;
HXLINE(  59)		c->canceled = this->canceled;
HXLINE(  60)		this->postClone(c);
HXLINE(  61)		return c;
            	}
...
::String UIEvent_obj::DRAG_START;

::String UIEvent_obj::DRAG_END;
...
static ::hx::StaticInfo UIEvent_obj_sStaticStorageInfo[] = {
	...
	{::hx::fsString,(void *) &UIEvent_obj::DRAG_START,HX_("DRAG_START",77,56,3f,b1)},
	{::hx::fsString,(void *) &UIEvent_obj::DRAG_END,HX_("DRAG_END",b0,e2,eb,a0)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
...
static void UIEvent_obj_sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(UIEvent_obj::DRAG_START,"DRAG_START");
	HX_MARK_MEMBER_NAME(UIEvent_obj::DRAG_END,"DRAG_END");
};
...
static void UIEvent_obj_sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(UIEvent_obj::DRAG_START,"DRAG_START");
	HX_VISIT_MEMBER_NAME(UIEvent_obj::DRAG_END,"DRAG_END");
};
...
HXDLIN(   8)		DESTROY = HX_("destroy",fa,2c,86,24);
            	}
{
            	HX_STACKFRAME(&_hx_pos_acfcc53ce94b5d2e_9_boot)
HXDLIN(   9)		RESIZE = HX_("resize",f4,59,7b,08);
            	}
{
            	HX_STACKFRAME(&_hx_pos_acfcc53ce94b5d2e_10_boot)
HXDLIN(  10)		CHANGE = HX_("change",70,91,72,b7);
            	}
{
            	HX_STACKFRAME(&_hx_pos_acfcc53ce94b5d2e_11_boot)
HXDLIN(  11)		BEFORE_CHANGE = HX_("beforeChange",4f,43,d6,e3);
            	}
{
            	HX_STACKFRAME(&_hx_pos_acfcc53ce94b5d2e_12_boot)
HXDLIN(  12)		MOVE = HX_("move",11,e3,60,48);
            	}
{
            	HX_STACKFRAME(&_hx_pos_acfcc53ce94b5d2e_13_boot)
HXDLIN(  13)		INITIALIZE = HX_("initialize",50,31,bb,ec);
            	}
{
            	HX_STACKFRAME(&_hx_pos_acfcc53ce94b5d2e_15_boot)
HXDLIN(  15)		RENDERER_CREATED = HX_("rendererCreated",e5,96,46,d7);
            	}
{
            	HX_STACKFRAME(&_hx_pos_acfcc53ce94b5d2e_16_boot)
HXDLIN(  16)		RENDERER_DESTROYED = HX_("rendererDestroyed",16,12,7b,d1);
            	}
{
            	HX_STACKFRAME(&_hx_pos_acfcc53ce94b5d2e_18_boot)
HXDLIN(  18)		HIDDEN = HX_("hidden",6a,ff,95,4c);
            	}
{
            	HX_STACKFRAME(&_hx_pos_acfcc53ce94b5d2e_19_boot)
HXDLIN(  19)		SHOWN = HX_("shown",d1,88,27,7c);
            	}
{
            	HX_STACKFRAME(&_hx_pos_acfcc53ce94b5d2e_21_boot)
HXDLIN(  21)		ENABLED = HX_("enabled",81,04,31,7e);
            	}
{
            	HX_STACKFRAME(&_hx_pos_acfcc53ce94b5d2e_22_boot)
HXDLIN(  22)		DISABLED = HX_("disabled",7c,41,04,7c);
            	}
{
            	HX_STACKFRAME(&_hx_pos_acfcc53ce94b5d2e_24_boot)
HXDLIN(  24)		BEFORE_CLOSE = HX_("beforeClose",b9,86,c0,cd);
            	}
{
            	HX_STACKFRAME(&_hx_pos_acfcc53ce94b5d2e_25_boot)
HXDLIN(  25)		CLOSE = HX_("close",b8,17,63,48);
            	}
{
            	HX_STACKFRAME(&_hx_pos_acfcc53ce94b5d2e_27_boot)
HXDLIN(  27)		PROPERTY_CHANGE = HX_("propertyChange",a5,bb,45,6a);
            	}
{
            	HX_STACKFRAME(&_hx_pos_acfcc53ce94b5d2e_29_boot)
HXDLIN(  29)		COMPONENT_ADDED = HX_("componentAdded",c3,86,4a,6b);
            	}
{
            	HX_STACKFRAME(&_hx_pos_acfcc53ce94b5d2e_30_boot)
HXDLIN(  30)		COMPONENT_REMOVED = HX_("componentRemoved",63,98,99,16);
            	}
{
            	HX_STACKFRAME(&_hx_pos_acfcc53ce94b5d2e_32_boot)
HXDLIN(  32)		DRAG_START = HX_("dragStart",ce,e3,60,e6);
            	}
{
            	HX_STACKFRAME(&_hx_pos_acfcc53ce94b5d2e_33_boot)
HXDLIN(  33)		DRAG_END = HX_("dragEnd",47,80,39,f1);
            	}
}
