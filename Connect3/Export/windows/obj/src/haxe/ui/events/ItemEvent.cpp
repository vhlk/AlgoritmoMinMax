...
HXLINE(  10)		this->itemIndex = -1;
HXLINE(   9)		this->sourceEvent = null();
HXLINE(   8)		this->source = null();
...
HXLINE(  14)		c->source = this->source;
HXLINE(  15)		c->sourceEvent = this->sourceEvent;
HXLINE(  16)		c->itemIndex = this->itemIndex;
HXLINE(  17)		c->type = this->type;
HXLINE(  18)		c->bubble = this->bubble;
HXLINE(  19)		c->target = this->target;
HXLINE(  20)		c->data = this->data;
HXLINE(  21)		c->canceled = this->canceled;
HXLINE(  22)		this->postClone(c);
HXLINE(  23)		return c;
            	}
...
HXDLIN(   6)		COMPONENT_EVENT = HX_("itemComponentEvent",90,6e,bc,55);
            	}
}
