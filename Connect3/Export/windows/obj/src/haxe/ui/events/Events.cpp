...
HX_DEFINE_STACK_FRAME(_hx_pos_b23cba198f770d4a_9_new,"haxe.ui.events.Events","new",0x7bd2388e,"haxe.ui.events.Events.new","haxe/ui/events/Events.hx",9,0x92158121)
HX_LOCAL_STACK_FRAME(_hx_pos_b23cba198f770d4a_12_register,"haxe.ui.events.Events","register",0x6e52d775,"haxe.ui.events.Events.register","haxe/ui/events/Events.hx",12,0x92158121)
HX_LOCAL_STACK_FRAME(_hx_pos_b23cba198f770d4a_16_unregister,"haxe.ui.events.Events","unregister",0x2c12a74e,"haxe.ui.events.Events.unregister","haxe/ui/events/Events.hx",16,0x92158121)
HX_LOCAL_STACK_FRAME(_hx_pos_b23cba198f770d4a_21_registerEvent,"haxe.ui.events.Events","registerEvent",0xf3b53865,"haxe.ui.events.Events.registerEvent","haxe/ui/events/Events.hx",21,0x92158121)
HX_LOCAL_STACK_FRAME(_hx_pos_b23cba198f770d4a_27_hasEvent,"haxe.ui.events.Events","hasEvent",0x9fd04372,"haxe.ui.events.Events.hasEvent","haxe/ui/events/Events.hx",27,0x92158121)
HX_LOCAL_STACK_FRAME(_hx_pos_b23cba198f770d4a_31_unregisterEvent,"haxe.ui.events.Events","unregisterEvent",0xa4b855ec,"haxe.ui.events.Events.unregisterEvent","haxe/ui/events/Events.hx",31,0x92158121)
HX_LOCAL_STACK_FRAME(_hx_pos_b23cba198f770d4a_35_dispatch,"haxe.ui.events.Events","dispatch",0xbc16ffcc,"haxe.ui.events.Events.dispatch","haxe/ui/events/Events.hx",35,0x92158121)
namespace haxe{
namespace ui{
namespace events{

void Events_obj::__construct( ::haxe::ui::core::Component target){
            	HX_STACKFRAME(&_hx_pos_b23cba198f770d4a_9_new)
HXDLIN(   9)		this->_target = target;
            	}
...
void Events_obj::_hx_register(){
            	HX_STACKFRAME(&_hx_pos_b23cba198f770d4a_12_register)
            	}
...
void Events_obj::unregister(){
            	HX_STACKFRAME(&_hx_pos_b23cba198f770d4a_16_unregister)
            	}
...
void Events_obj::registerEvent(::String type, ::Dynamic listener,::hx::Null< int >  __o_priority){
            	...
            	HX_STACKFRAME(&_hx_pos_b23cba198f770d4a_21_registerEvent)
HXDLIN(  21)		if ((this->hasEvent(type,listener) == false)) {
HXLINE(  22)			this->_target->registerEvent(type,listener,priority);
            		}
            	}
...
bool Events_obj::hasEvent(::String type, ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_b23cba198f770d4a_27_hasEvent)
HXDLIN(  27)		return this->_target->hasEvent(type,listener);
            	}
...
void Events_obj::unregisterEvent(::String type, ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_b23cba198f770d4a_31_unregisterEvent)
HXDLIN(  31)		this->_target->unregisterEvent(type,listener);
            	}
...
void Events_obj::dispatch( ::haxe::ui::events::UIEvent event){
            	HX_STACKFRAME(&_hx_pos_b23cba198f770d4a_35_dispatch)
HXDLIN(  35)		this->_target->dispatch(event);
            	}
