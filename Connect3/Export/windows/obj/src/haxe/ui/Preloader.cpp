...
HX_LOCAL_STACK_FRAME(_hx_pos_186b1b74991ba353_25_validateComponentLayout,"haxe.ui.Preloader","validateComponentLayout",0x0689dfe7,"haxe.ui.Preloader.validateComponentLayout","haxe/ui/Preloader.hx",25,0xe36684da)
...
HX_LOCAL_STACK_FRAME(_hx_pos_3272413211a8f5fe_370_registerBehaviours,"haxe.ui.Preloader","registerBehaviours",0x45539f03,"haxe.ui.Preloader.registerBehaviours","haxe/ui/macros/Macros.hx",370,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_7d3e1c8290b31e6a_525_cloneComponent,"haxe.ui.Preloader","cloneComponent",0x4a1983ca,"haxe.ui.Preloader.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",525,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_3272413211a8f5fe_351_self,"haxe.ui.Preloader","self",0xcd8cad36,"haxe.ui.Preloader.self","haxe/ui/macros/Macros.hx",351,0x27866361)
namespace haxe{
namespace ui{
...
bool Preloader_obj::validateComponentLayout(){
            	HX_STACKFRAME(&_hx_pos_186b1b74991ba353_25_validateComponentLayout)
HXLINE(  26)		bool b = this->super::validateComponentLayout();
HXLINE(  27)		bool _hx_tmp;
HXDLIN(  27)		if ((this->get_width() > 0)) {
HXLINE(  27)			_hx_tmp = (this->get_height() > 0);
            		}
            		else {
HXLINE(  27)			_hx_tmp = false;
            		}
HXDLIN(  27)		if (_hx_tmp) {
HXLINE(  28)			Float _hx_tmp = (::haxe::ui::core::Screen_obj::get_instance()->get_width() / ( (Float)(2) ));
HXDLIN(  28)			this->set_left((_hx_tmp - (this->get_width() / ( (Float)(2) ))));
HXLINE(  29)			Float _hx_tmp1 = (::haxe::ui::core::Screen_obj::get_instance()->get_height() / ( (Float)(2) ));
HXDLIN(  29)			this->set_top((_hx_tmp1 - (this->get_height() / ( (Float)(2) ))));
            		}
HXLINE(  31)		return b;
            	}
...
HXLINE(  42)			::String text = label->get_text();
...
HXDLIN(  51)		this->progress((this->_current + 1),this->_max);
            	}
...
void Preloader_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_3272413211a8f5fe_370_registerBehaviours)
HXDLIN( 370)		this->super::registerBehaviours();
            	}


 ::haxe::ui::core::ComponentContainer Preloader_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_7d3e1c8290b31e6a_525_cloneComponent)
HXLINE( 300)		 ::haxe::ui::Preloader c = ( ( ::haxe::ui::Preloader)(this->super::cloneComponent()) );
...
HXLINE( 323)		return c;
 ...
 ::haxe::ui::core::ComponentContainer Preloader_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_3272413211a8f5fe_351_self)
HXDLIN( 351)		return  ::haxe::ui::Preloader_obj::__alloc( HX_CTX );
            	}
