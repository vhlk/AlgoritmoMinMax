...
HX_LOCAL_STACK_FRAME(_hx_pos_7919f3505c1630e1_23_addObject,"haxe.ui.binding.PropertyInfo","addObject",0xcc6ee9b0,"haxe.ui.binding.PropertyInfo.addObject","haxe/ui/binding/BindingManager.hx",23,0xd9a5117a)
HX_LOCAL_STACK_FRAME(_hx_pos_7919f3505c1630e1_35_reset,"haxe.ui.binding.PropertyInfo","reset",0xeca5c7bf,"haxe.ui.binding.PropertyInfo.reset","haxe/ui/binding/BindingManager.hx",35,0xd9a5117a)
namespace haxe{
namespace ui{
namespace binding{
...
HXLINE(  18)		this->objects =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE(  16)		this->languageBinding = false;
            	}
...
bool PropertyInfo_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x6900edce;
}

void PropertyInfo_obj::addObject(::String objectId,::String objectProp){
            	HX_STACKFRAME(&_hx_pos_7919f3505c1630e1_23_addObject)
HXLINE(  24)		::Array< ::String > array = ( (::Array< ::String >)(this->objects->get(objectId)) );
HXLINE(  25)		if (::hx::IsNull( array )) {
HXLINE(  26)			array = ::Array_obj< ::String >::__new(0);
HXLINE(  27)			this->objects->set(objectId,array);
            		}
HXLINE(  29)		if ((array->indexOf(objectProp,null()) == -1)) {
HXLINE(  30)			array->push(objectProp);
            		}
            	}
...
void PropertyInfo_obj::reset(){
            	HX_GC_STACKFRAME(&_hx_pos_7919f3505c1630e1_35_reset)
HXDLIN(  35)		this->objects =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            	}


HX_DEFINE_DYNAMIC_FUNC0(PropertyInfo_obj,reset,(void))
...
void PropertyInfo_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(languageBinding,"languageBinding");
...
void PropertyInfo_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(languageBinding,"languageBinding");
...
::hx::Val PropertyInfo_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 9:
		...
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"languageBinding") ) { return ::hx::Val( languageBinding ); }
	}
...
::hx::Val PropertyInfo_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"languageBinding") ) { languageBinding=inValue.Cast< bool >(); return inValue; }
	}
...
void PropertyInfo_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_("languageBinding",cd,6d,f4,88));
...
static ::hx::StorageInfo PropertyInfo_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsBool,(int)offsetof(PropertyInfo_obj,languageBinding),HX_("languageBinding",cd,6d,f4,88)},
...
static ::String PropertyInfo_obj_sMemberFields[] = {
	...
	HX_("languageBinding",cd,6d,f4,88),
