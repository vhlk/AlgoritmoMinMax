...
HX_DEFINE_STACK_FRAME(_hx_pos_ce9340dee5f5d5f9_63_new,"haxe.ui.binding.BindingInfo","new",0x67f9bcaa,"haxe.ui.binding.BindingInfo.new","haxe/ui/binding/BindingManager.hx",63,0xd9a5117a)
HX_LOCAL_STACK_FRAME(_hx_pos_ce9340dee5f5d5f9_68_addProp,"haxe.ui.binding.BindingInfo","addProp",0x514ee3ae,"haxe.ui.binding.BindingInfo.addProp","haxe/ui/binding/BindingManager.hx",68,0xd9a5117a)
namespace haxe{
namespace ui{
namespace binding{

void BindingInfo_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_ce9340dee5f5d5f9_63_new)
HXDLIN(  63)		this->props =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            	}
...
bool BindingInfo_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x7c741b10;
}

 ::haxe::ui::binding::PropertyInfo BindingInfo_obj::addProp(::String name,::String script){
            	HX_GC_STACKFRAME(&_hx_pos_ce9340dee5f5d5f9_68_addProp)
HXLINE(  69)		 ::haxe::ui::binding::PropertyInfo p = ( ( ::haxe::ui::binding::PropertyInfo)(this->props->get(name)) );
HXLINE(  70)		if (::hx::IsNull( p )) {
HXLINE(  71)			p =  ::haxe::ui::binding::PropertyInfo_obj::__alloc( HX_CTX );
HXLINE(  72)			p->name = name;
HXLINE(  73)			p->script = script;
HXLINE(  74)			this->props->set(name,p);
            		}
HXLINE(  76)		return p;
            	}
