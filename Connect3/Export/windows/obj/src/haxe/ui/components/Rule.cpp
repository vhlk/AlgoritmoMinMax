...
HX_DEFINE_STACK_FRAME(_hx_pos_ed27bcaec99761fa_7_new,"haxe.ui.components.Rule","new",0x9fb31a94,"haxe.ui.components.Rule.new","haxe/ui/components/Rule.hx",7,0x51e8241b)
HX_LOCAL_STACK_FRAME(_hx_pos_e7a68a9a4a95fc5e_370_registerBehaviours,"haxe.ui.components.Rule","registerBehaviours",0x1993f825,"haxe.ui.components.Rule.registerBehaviours","haxe/ui/macros/Macros.hx",370,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_4696b533d9fe15eb_525_cloneComponent,"haxe.ui.components.Rule","cloneComponent",0x45ea23ec,"haxe.ui.components.Rule.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",525,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_e7a68a9a4a95fc5e_351_self,"haxe.ui.components.Rule","self",0x20522ed8,"haxe.ui.components.Rule.self","haxe/ui/macros/Macros.hx",351,0x27866361)
namespace haxe{
namespace ui{
namespace components{

void Rule_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_ed27bcaec99761fa_7_new)
HXLINE(   8)		super::__construct();
HXLINE(  10)		this->mouseChildren = false;
            	}
...
static ::haxe::ui::core::IDirectionalComponent_obj _hx_haxe_ui_components_Rule__hx_haxe_ui_core_IDirectionalComponent= {
};

void *Rule_obj::_hx_getInterface(int inHash) {
	switch(inHash) {
		case (int)0x4b5f75e3: return &_hx_haxe_ui_components_Rule__hx_haxe_ui_core_IDirectionalComponent;
	}
	return super::_hx_getInterface(inHash);
}

void Rule_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_e7a68a9a4a95fc5e_370_registerBehaviours)
HXDLIN( 370)		this->super::registerBehaviours();
            	}


 ::haxe::ui::core::ComponentContainer Rule_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_4696b533d9fe15eb_525_cloneComponent)
HXLINE( 300)		 ::haxe::ui::components::Rule c = ( ( ::haxe::ui::components::Rule)(this->super::cloneComponent()) );
...
HXLINE( 323)		return c;
 ...
 ::haxe::ui::core::ComponentContainer Rule_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_e7a68a9a4a95fc5e_351_self)
HXDLIN( 351)		return  ::haxe::ui::components::Rule_obj::__alloc( HX_CTX );
            	}



::hx::ObjectPtr< Rule_obj > Rule_obj::__new() {
	::hx::ObjectPtr< Rule_obj > __this = new Rule_obj();
	__this->__construct();
	return __this;
}

::hx::ObjectPtr< Rule_obj > Rule_obj::__alloc(::hx::Ctx *_hx_ctx) {
	Rule_obj *__this = (Rule_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(Rule_obj), true, "haxe.ui.components.Rule"));
...
static ::hx::StorageInfo *Rule_obj_sMemberStorageInfo = 0;
...
{
	Rule_obj _hx_dummy;
	Rule_obj::_hx_vtable = *(void **)&_hx_dummy;
	::hx::Static(__mClass) = new ::hx::Class_obj();
	__mClass->mName = HX_("haxe.ui.components.Rule",a2,80,4d,c5);
