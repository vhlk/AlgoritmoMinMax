...
HXLINE(  77)			Float _hx_tmp = scroll->get_pos();
HXDLIN(  77)			scroll->set_pos((_hx_tmp - scroll->get_pageSize()));
            		}
            		else {
HXLINE(  78)			Float p1 = p->y;
HXDLIN(  78)			Float _hx_tmp = thumb->get_screenTop();
HXDLIN(  78)			if ((p1 > (_hx_tmp + thumb->get_height()))) {
HXLINE(  79)				Float _hx_tmp = scroll->get_pos();
HXDLIN(  79)				scroll->set_pos((_hx_tmp + scroll->get_pageSize()));
            			}
            		}
