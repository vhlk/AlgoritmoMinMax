...
HX_DEFINE_STACK_FRAME(_hx_pos_8fdedfe6c5955b10_92_new,"haxe.ui.components._Slider.MinBehaviour","new",0x812913b1,"haxe.ui.components._Slider.MinBehaviour.new","haxe/ui/components/Slider.hx",92,0x55cb8456)
HX_LOCAL_STACK_FRAME(_hx_pos_8fdedfe6c5955b10_93_validateData,"haxe.ui.components._Slider.MinBehaviour","validateData",0x27dda06f,"haxe.ui.components._Slider.MinBehaviour.validateData","haxe/ui/components/Slider.hx",93,0x55cb8456)
namespace haxe{
namespace ui{
...
void MinBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_8fdedfe6c5955b10_92_new)
...
void MinBehaviour_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_8fdedfe6c5955b10_93_validateData)
HXLINE(  94)		if (::hx::IsNull( ::hx::TCast<  ::haxe::ui::components::Slider >::cast(this->_component)->get_start() )) {
HXLINE(  95)			 ::haxe::ui::components::Range _hx_tmp = this->_component->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::Range >(),null(),null()).StaticCast<  ::haxe::ui::components::Range >();
HXDLIN(  95)			_hx_tmp->set_start(::haxe::ui::util::_Variant::Variant_Impl__obj::toFloat(this->_value));
            		}
HXLINE(  97)		 ::haxe::ui::components::Range _hx_tmp = this->_component->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::Range >(),null(),null()).StaticCast<  ::haxe::ui::components::Range >();
HXDLIN(  97)		_hx_tmp->set_min(( (Float)(::haxe::ui::util::_Variant::Variant_Impl__obj::toFloat(this->_value)) ));
HXLINE(  98)		{
