...
HX_DEFINE_STACK_FRAME(_hx_pos_b6aadf93a810b213_43_new,"haxe.ui.components._VerticalSlider.Builder","new",0x9a136e2f,"haxe.ui.components._VerticalSlider.Builder.new","haxe/ui/components/VerticalSlider.hx",43,0x79dcaa00)
HX_LOCAL_STACK_FRAME(_hx_pos_b6aadf93a810b213_45_createValueComponent,"haxe.ui.components._VerticalSlider.Builder","createValueComponent",0x6e700079,"haxe.ui.components._VerticalSlider.Builder.createValueComponent","haxe/ui/components/VerticalSlider.hx",45,0x79dcaa00)
namespace haxe{
namespace ui{
...
void Builder_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_b6aadf93a810b213_43_new)
...
bool Builder_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x0472fd8d) {
		if (inClassId<=(int)0x016e4e61) {
			return inClassId==(int)0x00000001 || inClassId==(int)0x016e4e61;
		} else {
 ...
 ::haxe::ui::components::Range Builder_obj::createValueComponent(){
            	HX_GC_STACKFRAME(&_hx_pos_b6aadf93a810b213_45_createValueComponent)
HXDLIN(  45)		return  ::haxe::ui::components::VerticalRange_obj::__alloc( HX_CTX );
            	}
