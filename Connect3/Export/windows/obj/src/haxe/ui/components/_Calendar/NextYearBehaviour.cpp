...
HX_DEFINE_STACK_FRAME(_hx_pos_956c2550162f76ad_77_new,"haxe.ui.components._Calendar.NextYearBehaviour","new",0x7eead268,"haxe.ui.components._Calendar.NextYearBehaviour.new","haxe/ui/components/Calendar.hx",77,0xa4f8a419)
HX_LOCAL_STACK_FRAME(_hx_pos_956c2550162f76ad_78_call,"haxe.ui.components._Calendar.NextYearBehaviour","call",0x8744dd96,"haxe.ui.components._Calendar.NextYearBehaviour.call","haxe/ui/components/Calendar.hx",78,0xa4f8a419)
namespace haxe{
namespace ui{
...
void NextYearBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_956c2550162f76ad_77_new)
...
bool NextYearBehaviour_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType NextYearBehaviour_obj::call( ::Dynamic param){
            	HX_STACKFRAME(&_hx_pos_956c2550162f76ad_78_call)
HXLINE(  79)		 ::haxe::ui::components::Calendar calendar = ::hx::TCast<  ::haxe::ui::components::Calendar >::cast(this->_component);
HXLINE(  80)		calendar->set_date(::haxe::ui::components::_Calendar::DateUtils_obj::nextYear(calendar->get_date()));
