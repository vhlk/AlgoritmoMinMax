...
HX_DEFINE_STACK_FRAME(_hx_pos_583c58053f37acea_157_new,"haxe.ui.components._Scroll.ScrollValueBehaviour","new",0xb7f1f673,"haxe.ui.components._Scroll.ScrollValueBehaviour.new","haxe/ui/components/Scroll.hx",157,0x330a6dea)
HX_LOCAL_STACK_FRAME(_hx_pos_583c58053f37acea_158_set,"haxe.ui.components._Scroll.ScrollValueBehaviour","set",0xb7f5c1b5,"haxe.ui.components._Scroll.ScrollValueBehaviour.set","haxe/ui/components/Scroll.hx",158,0x330a6dea)
HX_LOCAL_STACK_FRAME(_hx_pos_583c58053f37acea_167_validateData,"haxe.ui.components._Scroll.ScrollValueBehaviour","validateData",0x4e57556d,"haxe.ui.components._Scroll.ScrollValueBehaviour.validateData","haxe/ui/components/Scroll.hx",167,0x330a6dea)
namespace haxe{
namespace ui{
...
void ScrollValueBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_583c58053f37acea_157_new)
...
void ScrollValueBehaviour_obj::set( ::haxe::ui::util::VariantType value){
            	HX_STACKFRAME(&_hx_pos_583c58053f37acea_158_set)
HXLINE( 159)		if (::haxe::ui::util::_Variant::Variant_Impl__obj::eq(value,this->get())) {
HXLINE( 160)			return;
            		}
HXLINE( 163)		this->super::set(value);
HXLINE( 164)		{
HXLINE( 164)			 ::haxe::ui::core::Component _this = this->_component;
...
void ScrollValueBehaviour_obj::validateData(){
            	HX_GC_STACKFRAME(&_hx_pos_583c58053f37acea_167_validateData)
HXLINE( 168)		 ::haxe::ui::components::Scroll scroll = ::hx::TCast<  ::haxe::ui::components::Scroll >::cast(this->_component);
HXLINE( 169)		Float pos = scroll->get_pos();
HXLINE( 170)		Float min = scroll->get_min();
HXLINE( 171)		Float max = scroll->get_max();
HXLINE( 172)		if ((pos < min)) {
HXLINE( 173)			scroll->set_pos(min);
            		}
            		else {
HXLINE( 174)			if ((pos > max)) {
HXLINE( 175)				scroll->set_pos(max);
            			}
            		}
HXLINE( 178)		 ::haxe::ui::events::UIEvent changeEvent =  ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,HX_("change",70,91,72,b7),null(),null());
HXLINE( 179)		scroll->dispatch(changeEvent);
            	}
