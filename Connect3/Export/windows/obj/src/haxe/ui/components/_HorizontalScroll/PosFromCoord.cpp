...
HXLINE(  49)			Float maxX = deinc->get_width();
HXDLIN(  49)			maxX1 = (maxX1 + (maxX + scroll->get_layout()->get_horizontalSpacing()));
            		}
...
HXLINE(  58)		ucx = (ucx - thumb->get_width());
