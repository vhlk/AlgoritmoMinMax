...
void Events_obj::__construct( ::haxe::ui::components::TextArea textarea){
            	HX_STACKFRAME(&_hx_pos_0c9c2549ed15ec5e_238_new)
HXLINE( 239)		super::__construct(textarea);
HXLINE( 240)		this->_textarea = textarea;
            	}
...
void Events_obj::_hx_register(){
            	HX_STACKFRAME(&_hx_pos_0c9c2549ed15ec5e_243_register)
...
HXLINE( 246)			this->_textarea->getTextInput()->get_data()->onChangedCallback =  ::Dynamic(new _hx_Closure_0(_gthis));
            		}
HXLINE( 254)		if (::hx::IsNull( this->_textarea->getTextInput()->get_data()->onScrollCallback )) {
            			...
            			void _hx_run(){
            				HX_STACKFRAME(&_hx_pos_0c9c2549ed15ec5e_255_register)
...
HXLINE( 255)			this->_textarea->getTextInput()->get_data()->onScrollCallback =  ::Dynamic(new _hx_Closure_1(_gthis));
            		}
HXLINE( 267)		 ::haxe::ui::components::HorizontalScroll hscroll = this->_textarea->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::HorizontalScroll >(),false,null()).StaticCast<  ::haxe::ui::components::HorizontalScroll >();
HXLINE( 268)		bool _hx_tmp;
HXDLIN( 268)		if (::hx::IsNotNull( hscroll )) {
HXLINE( 268)			_hx_tmp = (hscroll->hasEvent(HX_("change",70,91,72,b7),this->onScrollChange_dyn()) == false);
            		}
            		else {
HXLINE( 268)			_hx_tmp = false;
            		}
HXDLIN( 268)		if (_hx_tmp) {
HXLINE( 269)			hscroll->registerEvent(HX_("change",70,91,72,b7),this->onScrollChange_dyn(),null());
            		}
HXLINE( 272)		 ::haxe::ui::components::VerticalScroll vscroll = this->_textarea->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::VerticalScroll >(),false,null()).StaticCast<  ::haxe::ui::components::VerticalScroll >();
HXLINE( 273)		bool _hx_tmp1;
HXDLIN( 273)		if (::hx::IsNotNull( vscroll )) {
HXLINE( 273)			_hx_tmp1 = (vscroll->hasEvent(HX_("change",70,91,72,b7),this->onScrollChange_dyn()) == false);
            		}
            		else {
HXLINE( 273)			_hx_tmp1 = false;
            		}
HXDLIN( 273)		if (_hx_tmp1) {
HXLINE( 274)			vscroll->registerEvent(HX_("change",70,91,72,b7),this->onScrollChange_dyn(),null());
            		}
...
void Events_obj::unregister(){
            	HX_STACKFRAME(&_hx_pos_0c9c2549ed15ec5e_291_unregister)
HXLINE( 292)		this->_textarea->getTextInput()->get_data()->onChangedCallback = null();
HXLINE( 293)		this->_textarea->getTextInput()->get_data()->onScrollCallback = null();
...
HXLINE( 324)				vscroll->set_pos((vscroll->get_pos() - step));
            			}
            			else {
HXLINE( 325)				if ((event->delta < 0)) {
HXLINE( 326)					vscroll->set_pos((vscroll->get_pos() + step));
            				}
            			}
            		}
            	}
...
HXLINE( 339)			 ::haxe::ui::core::TextInput _hx_tmp = this->_textarea->getTextInput();
HXDLIN( 339)			_hx_tmp->set_vscrollPos(vscroll->get_pos());
            		}
            	}
