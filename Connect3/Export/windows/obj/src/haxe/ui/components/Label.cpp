...
HX_LOCAL_STACK_FRAME(_hx_pos_abef53e53bf6fa76_71_registerComposite,"haxe.ui.components.Label","registerComposite",0x22cb8444,"haxe.ui.components.Label.registerComposite","haxe/ui/macros/Macros.hx",71,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_abef53e53bf6fa76_369_registerBehaviours,"haxe.ui.components.Label","registerBehaviours",0xd24744b9,"haxe.ui.components.Label.registerBehaviours","haxe/ui/macros/Macros.hx",369,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_abef53e53bf6fa76_388_get_htmlText,"haxe.ui.components.Label","get_htmlText",0xa6ea88a1,"haxe.ui.components.Label.get_htmlText","haxe/ui/macros/Macros.hx",388,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_abef53e53bf6fa76_417_set_htmlText,"haxe.ui.components.Label","set_htmlText",0xbbe3ac15,"haxe.ui.components.Label.set_htmlText","haxe/ui/macros/Macros.hx",417,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_abef53e53bf6fa76_495_get_value,"haxe.ui.components.Label","get_value",0x99695ae8,"haxe.ui.components.Label.get_value","haxe/ui/macros/Macros.hx",495,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_abef53e53bf6fa76_498_set_value,"haxe.ui.components.Label","set_value",0x7cba46f4,"haxe.ui.components.Label.set_value","haxe/ui/macros/Macros.hx",498,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_abef53e53bf6fa76_126_get_textAlign,"haxe.ui.components.Label","get_textAlign",0xffe849cf,"haxe.ui.components.Label.get_textAlign","haxe/ui/macros/Macros.hx",126,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_abef53e53bf6fa76_139_set_textAlign,"haxe.ui.components.Label","set_textAlign",0x44ee2bdb,"haxe.ui.components.Label.set_textAlign","haxe/ui/macros/Macros.hx",139,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_4cad304492000fff_525_cloneComponent,"haxe.ui.components.Label","cloneComponent",0x272e9680,"haxe.ui.components.Label.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",525,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_abef53e53bf6fa76_351_self,"haxe.ui.components.Label","self",0x07b9606c,"haxe.ui.components.Label.self","haxe/ui/macros/Macros.hx",351,0x27866361)
namespace haxe{
namespace ui{
...
void Label_obj::registerComposite(){
            	HX_STACKFRAME(&_hx_pos_abef53e53bf6fa76_71_registerComposite)
HXLINE(  72)		this->super::registerComposite();
HXLINE(  84)		this->_compositeBuilderClass = ::hx::ClassOf< ::haxe::ui::components::_Label::Builder >();
HXLINE(  88)		this->_defaultLayoutClass = ::hx::ClassOf< ::haxe::ui::components::_Label::LabelLayout >();
            	}


void Label_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_abef53e53bf6fa76_369_registerBehaviours)
HXLINE( 370)		this->super::registerBehaviours();
HXLINE( 447)		this->behaviours->_hx_register(HX_("text",ad,cc,f9,4c),::hx::ClassOf< ::haxe::ui::components::_Label::TextBehaviour >(),null());
HXDLIN( 447)		this->behaviours->_hx_register(HX_("htmlText",b8,1f,38,10),::hx::ClassOf< ::haxe::ui::components::_Label::HtmlTextBehaviour >(),null());
            	}


::String Label_obj::get_htmlText(){
            	HX_STACKFRAME(&_hx_pos_abef53e53bf6fa76_388_get_htmlText)
HXDLIN( 388)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->behaviours->get(HX_("htmlText",b8,1f,38,10)));
            	}
...
::String Label_obj::set_htmlText(::String value){
            	HX_GC_STACKFRAME(&_hx_pos_abef53e53bf6fa76_417_set_htmlText)
HXLINE( 418)		{
...
HXLINE( 421)						::haxe::ui::binding::BindingManager_obj::get_instance()->addLanguageBinding(( ( ::haxe::ui::core::Component)(::hx::ObjectPtr<OBJ_>(this)) ),HX_("htmlText",b8,1f,38,10),value,null());
...
HXDLIN( 426)		_hx_tmp->set(HX_("htmlText",b8,1f,38,10),::haxe::ui::util::_Variant::Variant_Impl__obj::fromString(value));
HXLINE( 427)		this->dispatch( ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,HX_("propertyChange",a5,bb,45,6a),null(),HX_("htmlText",b8,1f,38,10)));
HXLINE( 244)		::haxe::ui::binding::BindingManager_obj::get_instance()->componentPropChanged(( ( ::haxe::ui::core::Component)(::hx::ObjectPtr<OBJ_>(this)) ),HX_("htmlText",b8,1f,38,10));
...
HX_DEFINE_DYNAMIC_FUNC1(Label_obj,set_htmlText,return )
 ...
 ::Dynamic Label_obj::get_value(){
            	HX_STACKFRAME(&_hx_pos_abef53e53bf6fa76_495_get_value)
HXDLIN( 495)		return this->get_text();
            	}


 ::Dynamic Label_obj::set_value( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_abef53e53bf6fa76_498_set_value)
...
::String Label_obj::get_textAlign(){
            	HX_STACKFRAME(&_hx_pos_abef53e53bf6fa76_126_get_textAlign)
...
::String Label_obj::set_textAlign(::String value){
            	HX_GC_STACKFRAME(&_hx_pos_abef53e53bf6fa76_139_set_textAlign)
...
HX_DEFINE_DYNAMIC_FUNC1(Label_obj,set_textAlign,return )
 ...
 ::haxe::ui::core::ComponentContainer Label_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_4cad304492000fff_525_cloneComponent)
HXLINE( 300)		 ::haxe::ui::components::Label c = ( ( ::haxe::ui::components::Label)(this->super::cloneComponent()) );
HXLINE( 309)		if (::hx::IsNotNull( this->get_htmlText() )) {
HXLINE( 309)			c->set_htmlText(this->get_htmlText());
            		}
...
HXLINE( 323)		return c;
 ...
 ::haxe::ui::core::ComponentContainer Label_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_abef53e53bf6fa76_351_self)
HXDLIN( 351)		return  ::haxe::ui::components::Label_obj::__alloc( HX_CTX );
            	}
