...
HX_DEFINE_STACK_FRAME(_hx_pos_3a1374baa336e965_113_new,"haxe.ui.components._Label.Builder","new",0x81ab3a9a,"haxe.ui.components._Label.Builder.new","haxe/ui/components/Label.hx",113,0xeb990e51)
HX_LOCAL_STACK_FRAME(_hx_pos_3a1374baa336e965_119_applyStyle,"haxe.ui.components._Label.Builder","applyStyle",0x6fa6d1e9,"haxe.ui.components._Label.Builder.applyStyle","haxe/ui/components/Label.hx",119,0xeb990e51)
HX_LOCAL_STACK_FRAME(_hx_pos_3a1374baa336e965_130_isHtml,"haxe.ui.components._Label.Builder","isHtml",0x487a907b,"haxe.ui.components._Label.Builder.isHtml","haxe/ui/components/Label.hx",130,0xeb990e51)
namespace haxe{
namespace ui{
...
void Builder_obj::__construct( ::haxe::ui::components::Label label){
            	HX_STACKFRAME(&_hx_pos_3a1374baa336e965_113_new)
HXLINE( 114)		super::__construct(label);
HXLINE( 115)		this->_label = label;
            	}
...
void Builder_obj::applyStyle( ::haxe::ui::styles::Style style){
            	HX_STACKFRAME(&_hx_pos_3a1374baa336e965_119_applyStyle)
HXDLIN( 119)		if ((this->_label->hasTextDisplay() == true)) {
HXLINE( 120)			this->_label->getTextDisplay()->set_textStyle(style);
HXLINE( 122)			bool _hx_tmp;
HXDLIN( 122)			bool _hx_tmp1;
HXDLIN( 122)			bool _hx_tmp2;
HXDLIN( 122)			if ((style->contentType != HX_("auto",6f,df,76,40))) {
HXLINE( 122)				_hx_tmp2 = (style->contentType == HX_("html",6b,95,16,45));
            			}
            			else {
HXLINE( 122)				_hx_tmp2 = true;
            			}
HXDLIN( 122)			if (_hx_tmp2) {
HXLINE( 122)				_hx_tmp1 = this->_label->getTextDisplay()->get_supportsHtml();
            			}
            			else {
HXLINE( 122)				_hx_tmp1 = false;
            			}
HXDLIN( 122)			if (_hx_tmp1) {
HXLINE( 122)				::String v = ::Std_obj::string(this->_component->get_text());
HXDLIN( 122)				if (::hx::IsNull( v )) {
HXLINE( 122)					_hx_tmp = false;
            				}
            				else {
HXLINE( 122)					_hx_tmp = (v.indexOf(HX_("<font ",b5,5d,fb,01),null()) != -1);
            				}
            			}
            			else {
HXLINE( 122)				_hx_tmp = false;
...
HXLINE( 123)				 ::haxe::ui::components::Label _hx_tmp = this->_label;
HXDLIN( 123)				_hx_tmp->set_htmlText(this->_label->get_text());
            			}
            		}
            	}
...
bool Builder_obj::isHtml(::String v){
            	HX_STACKFRAME(&_hx_pos_3a1374baa336e965_130_isHtml)
HXDLIN( 130)		if (::hx::IsNull( v )) {
HXDLIN( 130)			return false;
            		}
            		else {
HXDLIN( 130)			return (v.indexOf(HX_("<font ",b5,5d,fb,01),null()) != -1);
            		}
HXDLIN( 130)		return false;
            	}
