...
HXLINE(  50)			Float maxY = deinc->get_height();
HXDLIN(  50)			maxY1 = (maxY1 + (maxY + scroll->get_layout()->get_verticalSpacing()));
            		}
...
HXLINE(  60)		ucy = (ucy - thumb->get_height());
