...
HX_LOCAL_STACK_FRAME(_hx_pos_511dd42a43f8daa6_71_registerComposite,"haxe.ui.components.OptionBox","registerComposite",0xd7049566,"haxe.ui.components.OptionBox.registerComposite","haxe/ui/macros/Macros.hx",71,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_511dd42a43f8daa6_369_registerBehaviours,"haxe.ui.components.OptionBox","registerBehaviours",0xcffd3157,"haxe.ui.components.OptionBox.registerBehaviours","haxe/ui/macros/Macros.hx",369,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_511dd42a43f8daa6_388_get_componentGroup,"haxe.ui.components.OptionBox","get_componentGroup",0x202acf89,"haxe.ui.components.OptionBox.get_componentGroup","haxe/ui/macros/Macros.hx",388,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_511dd42a43f8daa6_417_set_componentGroup,"haxe.ui.components.OptionBox","set_componentGroup",0xfcda01fd,"haxe.ui.components.OptionBox.set_componentGroup","haxe/ui/macros/Macros.hx",417,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_511dd42a43f8daa6_388_get_selectedOption,"haxe.ui.components.OptionBox","get_selectedOption",0xe6089277,"haxe.ui.components.OptionBox.get_selectedOption","haxe/ui/macros/Macros.hx",388,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_511dd42a43f8daa6_431_set_selectedOption,"haxe.ui.components.OptionBox","set_selectedOption",0xc2b7c4eb,"haxe.ui.components.OptionBox.set_selectedOption","haxe/ui/macros/Macros.hx",431,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_511dd42a43f8daa6_495_get_value,"haxe.ui.components.OptionBox","get_value",0x4bdb7a0a,"haxe.ui.components.OptionBox.get_value","haxe/ui/macros/Macros.hx",495,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_511dd42a43f8daa6_498_set_value,"haxe.ui.components.OptionBox","set_value",0x2f2c6616,"haxe.ui.components.OptionBox.set_value","haxe/ui/macros/Macros.hx",498,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_b797316470783867_525_cloneComponent,"haxe.ui.components.OptionBox","cloneComponent",0xffce5c1e,"haxe.ui.components.OptionBox.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",525,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_511dd42a43f8daa6_351_self,"haxe.ui.components.OptionBox","self",0x04ff948a,"haxe.ui.components.OptionBox.self","haxe/ui/macros/Macros.hx",351,0x27866361)
namespace haxe{
namespace ui{
...
void OptionBox_obj::registerComposite(){
            	HX_STACKFRAME(&_hx_pos_511dd42a43f8daa6_71_registerComposite)
HXLINE(  72)		this->super::registerComposite();
HXLINE(  84)		this->_compositeBuilderClass = ::hx::ClassOf< ::haxe::ui::components::OptionBoxBuilder >();
            	}


void OptionBox_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_511dd42a43f8daa6_369_registerBehaviours)
HXLINE( 370)		this->super::registerBehaviours();
HXLINE( 451)		 ::haxe::ui::behaviours::Behaviours _hx_tmp = this->behaviours;
HXDLIN( 451)		_hx_tmp->_hx_register(HX_("componentGroup",42,65,fb,e8),::hx::ClassOf< ::haxe::ui::components::_OptionBox::GroupBehaviour >(),::haxe::ui::util::_Variant::Variant_Impl__obj::fromString(HX_("defaultGroup",be,ee,4f,4f)));
HXLINE( 447)		this->behaviours->_hx_register(HX_("selected",5b,2a,6d,b1),::hx::ClassOf< ::haxe::ui::components::_OptionBox::SelectedBehaviour >(),null());
HXDLIN( 447)		this->behaviours->_hx_register(HX_("selectedOption",30,28,d9,ae),::hx::ClassOf< ::haxe::ui::components::_OptionBox::SelectedOptionBehaviour >(),null());
            	}


::String OptionBox_obj::get_componentGroup(){
            	HX_STACKFRAME(&_hx_pos_511dd42a43f8daa6_388_get_componentGroup)
...
::String OptionBox_obj::set_componentGroup(::String value){
            	HX_GC_STACKFRAME(&_hx_pos_511dd42a43f8daa6_417_set_componentGroup)
HXLINE( 418)		{
...
HX_DEFINE_DYNAMIC_FUNC1(OptionBox_obj,set_componentGroup,return )
 ...
 ::haxe::ui::core::Component OptionBox_obj::get_selectedOption(){
            	HX_STACKFRAME(&_hx_pos_511dd42a43f8daa6_388_get_selectedOption)
HXDLIN( 388)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::toComponent(this->behaviours->get(HX_("selectedOption",30,28,d9,ae)));
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(OptionBox_obj,get_selectedOption,return )
 ...
 ::haxe::ui::core::Component OptionBox_obj::set_selectedOption( ::haxe::ui::core::Component value){
            	HX_GC_STACKFRAME(&_hx_pos_511dd42a43f8daa6_431_set_selectedOption)
HXLINE( 432)		 ::haxe::ui::behaviours::Behaviours _hx_tmp = this->behaviours;
HXDLIN( 432)		_hx_tmp->set(HX_("selectedOption",30,28,d9,ae),::haxe::ui::util::_Variant::Variant_Impl__obj::fromComponent(value));
HXLINE( 433)		this->dispatch( ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,HX_("propertyChange",a5,bb,45,6a),null(),HX_("selectedOption",30,28,d9,ae)));
HXLINE( 244)		::haxe::ui::binding::BindingManager_obj::get_instance()->componentPropChanged(( ( ::haxe::ui::core::Component)(::hx::ObjectPtr<OBJ_>(this)) ),HX_("selectedOption",30,28,d9,ae));
...
HX_DEFINE_DYNAMIC_FUNC1(OptionBox_obj,set_selectedOption,return )
 ...
 ::Dynamic OptionBox_obj::get_value(){
            	HX_STACKFRAME(&_hx_pos_511dd42a43f8daa6_495_get_value)
HXDLIN( 495)		return this->get_selected();
            	}


 ::Dynamic OptionBox_obj::set_value( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_511dd42a43f8daa6_498_set_value)
...
HXLINE( 501)		return value;
 ...
 ::haxe::ui::core::ComponentContainer OptionBox_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_b797316470783867_525_cloneComponent)
HXLINE( 300)		 ::haxe::ui::components::OptionBox c = ( ( ::haxe::ui::components::OptionBox)(this->super::cloneComponent()) );
HXLINE( 309)		if (::hx::IsNotNull( this->get_componentGroup() )) {
HXLINE( 309)			c->set_componentGroup(this->get_componentGroup());
            		}
HXDLIN( 309)		if (::hx::IsNotNull( this->get_selectedOption() )) {
HXLINE( 309)			c->set_selectedOption(this->get_selectedOption());
            		}
...
HXLINE( 323)		return c;
 ...
 ::haxe::ui::core::ComponentContainer OptionBox_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_511dd42a43f8daa6_351_self)
HXDLIN( 351)		return  ::haxe::ui::components::OptionBox_obj::__alloc( HX_CTX );
            	}
