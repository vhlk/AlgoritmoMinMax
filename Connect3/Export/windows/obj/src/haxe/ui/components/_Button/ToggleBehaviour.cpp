...
HX_DEFINE_STACK_FRAME(_hx_pos_a7c69801980b3472_306_new,"haxe.ui.components._Button.ToggleBehaviour","new",0x04a58158,"haxe.ui.components._Button.ToggleBehaviour.new","haxe/ui/components/Button.hx",306,0x45086125)
HX_LOCAL_STACK_FRAME(_hx_pos_a7c69801980b3472_310_get,"haxe.ui.components._Button.ToggleBehaviour","get",0x04a0318e,"haxe.ui.components._Button.ToggleBehaviour.get","haxe/ui/components/Button.hx",310,0x45086125)
HX_LOCAL_STACK_FRAME(_hx_pos_a7c69801980b3472_313_set,"haxe.ui.components._Button.ToggleBehaviour","set",0x04a94c9a,"haxe.ui.components._Button.ToggleBehaviour.set","haxe/ui/components/Button.hx",313,0x45086125)
namespace haxe{
namespace ui{
...
void ToggleBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_a7c69801980b3472_306_new)
...
bool ToggleBehaviour_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType ToggleBehaviour_obj::get(){
            	HX_STACKFRAME(&_hx_pos_a7c69801980b3472_310_get)
HXDLIN( 310)		return this->_value;
            	}


void ToggleBehaviour_obj::set( ::haxe::ui::util::VariantType value){
            	HX_STACKFRAME(&_hx_pos_a7c69801980b3472_313_set)
HXLINE( 314)		if (::haxe::ui::util::_Variant::Variant_Impl__obj::eq(this->_value,value)) {
HXLINE( 315)			return;
            		}
HXLINE( 318)		this->_value = value;
HXLINE( 319)		 ::haxe::ui::components::Button button = ::hx::TCast<  ::haxe::ui::components::Button >::cast(this->_component);
HXLINE( 320)		if (::haxe::ui::util::_Variant::Variant_Impl__obj::eq(value,::haxe::ui::util::_Variant::Variant_Impl__obj::fromBool(false))) {
HXLINE( 321)			button->set_selected(false);
            		}
HXLINE( 323)		button->registerInternalEvents(button->_internalEventsClass,true);
            	}
