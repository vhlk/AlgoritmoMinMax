...
HX_DEFINE_STACK_FRAME(_hx_pos_f76e1717003544b4_161_new,"haxe.ui.components._TextArea.TextBehaviour","new",0xe884ee87,"haxe.ui.components._TextArea.TextBehaviour.new","haxe/ui/components/TextArea.hx",161,0xfe441d7d)
HX_LOCAL_STACK_FRAME(_hx_pos_f76e1717003544b4_162_validateData,"haxe.ui.components._TextArea.TextBehaviour","validateData",0xa576bad9,"haxe.ui.components._TextArea.TextBehaviour.validateData","haxe/ui/components/TextArea.hx",162,0xfe441d7d)
namespace haxe{
namespace ui{
...
void TextBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_f76e1717003544b4_161_new)
...
void TextBehaviour_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_f76e1717003544b4_162_validateData)
HXLINE( 163)		 ::haxe::ui::components::TextArea textarea = ::hx::TCast<  ::haxe::ui::components::TextArea >::cast(this->_component);
HXLINE( 164)		::String text;
HXDLIN( 164)		if (::hx::IsNotNull( this->_value )) {
HXLINE( 164)			text = ::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->_value);
            		}
            		else {
HXLINE( 164)			text = HX_("",00,00,00,00);
            		}
HXLINE( 165)		::haxe::ui::components::_TextArea::TextAreaHelper_obj::validateText(textarea,text);
HXLINE( 166)		if ((textarea->get_autoScrollToBottom() == true)) {
HXLINE( 167)			textarea->scrollToBottom();
            		}
            	}
