...
HX_DEFINE_STACK_FRAME(_hx_pos_26545bda63a80f75_288_new,"haxe.ui.components._Button.IconBehaviour","new",0xe530ed13,"haxe.ui.components._Button.IconBehaviour.new","haxe/ui/components/Button.hx",288,0x45086125)
HX_LOCAL_STACK_FRAME(_hx_pos_26545bda63a80f75_289_validateData,"haxe.ui.components._Button.IconBehaviour","validateData",0x47148acd,"haxe.ui.components._Button.IconBehaviour.validateData","haxe/ui/components/Button.hx",289,0x45086125)
namespace haxe{
namespace ui{
...
void IconBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_26545bda63a80f75_288_new)
...
void IconBehaviour_obj::validateData(){
            	HX_GC_STACKFRAME(&_hx_pos_26545bda63a80f75_289_validateData)
HXLINE( 290)		 ::haxe::ui::components::Image icon = this->_component->findComponent(HX_("button-icon",f4,52,38,e9),null(),false,null()).StaticCast<  ::haxe::ui::components::Image >();
HXLINE( 291)		if (::hx::IsNull( icon )) {
HXLINE( 292)			icon =  ::haxe::ui::components::Image_obj::__alloc( HX_CTX );
HXLINE( 293)			icon->addClass(HX_("icon",79,e7,b2,45),null(),null());
HXLINE( 294)			icon->set_id(HX_("button-icon",f4,52,38,e9));
HXLINE( 295)			icon->scriptAccess = false;
HXLINE( 296)			this->_component->addComponentAt(icon,0);
HXLINE( 297)			{
HXLINE( 297)				 ::haxe::ui::core::Component _this = this->_component;
HXDLIN( 297)				_this->invalidateComponent(HX_("style",31,a5,1d,84));
HXDLIN( 297)				_this->_style = null();
            			}
            		}
HXLINE( 300)		icon->set_resource(this->_value);
            	}
