...
HX_DEFINE_STACK_FRAME(_hx_pos_84685bf4a71a8287_82_new,"haxe.ui.components._OptionBox.SelectedOptionBehaviour","new",0x2a15188e,"haxe.ui.components._OptionBox.SelectedOptionBehaviour.new","haxe/ui/components/OptionBox.hx",82,0x8f34a36f)
HX_LOCAL_STACK_FRAME(_hx_pos_84685bf4a71a8287_83_get,"haxe.ui.components._OptionBox.SelectedOptionBehaviour","get",0x2a0fc8c4,"haxe.ui.components._OptionBox.SelectedOptionBehaviour.get","haxe/ui/components/OptionBox.hx",83,0x8f34a36f)
namespace haxe{
namespace ui{
...
void SelectedOptionBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_84685bf4a71a8287_82_new)
...
bool SelectedOptionBehaviour_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType SelectedOptionBehaviour_obj::get(){
            	HX_STACKFRAME(&_hx_pos_84685bf4a71a8287_83_get)
HXLINE(  84)		 ::haxe::ui::components::OptionBox optionbox = ::hx::TCast<  ::haxe::ui::components::OptionBox >::cast(this->_component);
HXLINE(  85)		 ::haxe::ui::components::OptionBoxGroups arr = ::haxe::ui::components::OptionBoxGroups_obj::get_instance();
HXDLIN(  85)		::Array< ::Dynamic> arr1 = arr->get(optionbox->get_componentGroup());
HXLINE(  86)		 ::haxe::ui::components::OptionBox selectionOption = null();
HXLINE(  87)		if (::hx::IsNotNull( arr1 )) {
HXLINE(  88)			int _g = 0;
HXDLIN(  88)			while((_g < arr1->length)){
HXLINE(  88)				 ::haxe::ui::components::OptionBox test = arr1->__get(_g).StaticCast<  ::haxe::ui::components::OptionBox >();
HXDLIN(  88)				_g = (_g + 1);
HXLINE(  89)				if ((test->get_selected() == true)) {
HXLINE(  90)					selectionOption = test;
HXLINE(  91)					goto _hx_goto_1;
            				}
            			}
            			_hx_goto_1:;
            		}
HXLINE(  95)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromComponent(selectionOption);
            	}
