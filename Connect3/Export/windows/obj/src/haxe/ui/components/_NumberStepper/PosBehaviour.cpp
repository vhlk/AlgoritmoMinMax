...
HXLINE(  40)			bool preciseValue1;
HXDLIN(  40)			if (::hx::IsNotNull( min )) {
HXLINE(  40)				preciseValue1 = ::hx::IsLess( v,min );
            			}
            			else {
HXLINE(  40)				preciseValue1 = false;
            			}
HXDLIN(  40)			if (preciseValue1) {
HXLINE(  40)				v = min;
            			}
            			else {
HXLINE(  40)				bool preciseValue;
HXDLIN(  40)				if (::hx::IsNotNull( max )) {
HXLINE(  40)					preciseValue = ::hx::IsGreater( v,max );
            				}
            				else {
HXLINE(  40)					preciseValue = false;
            				}
HXDLIN(  40)				if (preciseValue) {
HXLINE(  40)					v = max;
            				}
            			}
