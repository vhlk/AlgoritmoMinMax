...
HX_DEFINE_STACK_FRAME(_hx_pos_fd90e646f9611825_208_new,"haxe.ui.components._Image.Builder","new",0x572d4a81,"haxe.ui.components._Image.Builder.new","haxe/ui/components/Image.hx",208,0xeed4974a)
HX_LOCAL_STACK_FRAME(_hx_pos_fd90e646f9611825_214_applyStyle,"haxe.ui.components._Image.Builder","applyStyle",0xbf999ce2,"haxe.ui.components._Image.Builder.applyStyle","haxe/ui/components/Image.hx",214,0xeed4974a)
namespace haxe{
namespace ui{
...
void Builder_obj::__construct( ::haxe::ui::components::Image image){
            	HX_STACKFRAME(&_hx_pos_fd90e646f9611825_208_new)
HXLINE( 209)		super::__construct(image);
HXLINE( 210)		this->_image = image;
            	}
...
void Builder_obj::applyStyle( ::haxe::ui::styles::Style style){
            	HX_STACKFRAME(&_hx_pos_fd90e646f9611825_214_applyStyle)
HXDLIN( 214)		if (::hx::IsNotNull( style->resource )) {
HXLINE( 215)			 ::haxe::ui::components::Image _hx_tmp = this->_image;
HXDLIN( 215)			_hx_tmp->set_resource(::haxe::ui::util::_Variant::Variant_Impl__obj::fromString(style->resource));
            		}
            	}
