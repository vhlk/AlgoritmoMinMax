...
HXLINE( 114)			Float _hx_tmp = this->get_component()->get_width();
HXDLIN( 114)			Float _hx_tmp1 = (_hx_tmp - inc->get_width());
HXDLIN( 114)			inc->set_left((_hx_tmp1 - this->get_paddingRight()));
            		}
...
HXLINE( 125)				_hx_tmp = (this->hidden(deinc) == false);
            			}
            			else {
HXLINE( 125)				_hx_tmp = false;
            			}
HXDLIN( 125)			if (_hx_tmp) {
HXLINE( 126)				Float x = deinc->get_width();
HXDLIN( 126)				x1 = (x1 + (x + this->get_horizontalSpacing()));
            			}
...
HXLINE( 139)			Float ucx1 = deinc->get_width();
...
HXLINE( 142)			Float ucx1 = inc->get_width();
HXDLIN( 142)			ucx = (ucx - (ucx1 + this->get_horizontalSpacing()));
            		}
