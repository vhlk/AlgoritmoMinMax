...
HX_LOCAL_STACK_FRAME(_hx_pos_783f83cb03bee32a_98_validateData,"haxe.ui.components._Label.HtmlTextBehaviour","validateData",0xd2fdd39c,"haxe.ui.components._Label.HtmlTextBehaviour.validateData","haxe/ui/components/Label.hx",98,0xeb990e51)
namespace haxe{
namespace ui{
...
void HtmlTextBehaviour_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_783f83cb03bee32a_98_validateData)
HXLINE(  99)		 ::haxe::ui::styles::Style _hx_tmp = this->_component->getTextDisplay()->get_textStyle();
HXDLIN(  99)		if (::hx::IsInstanceNotEq( _hx_tmp,this->_component->get_style() )) {
HXLINE( 100)			 ::haxe::ui::core::Component _this = this->_component;
HXDLIN( 100)			_this->invalidateComponent(HX_("style",31,a5,1d,84));
HXDLIN( 100)			_this->_style = null();
            		}
HXLINE( 102)		 ::haxe::ui::core::TextDisplay _hx_tmp1 = this->_component->getTextDisplay();
HXDLIN( 102)		::String _hx_tmp2;
HXDLIN( 102)		if (::hx::IsNull( this->_value )) {
HXLINE( 102)			_hx_tmp2 = HX_("null",87,9e,0e,49);
            		}
            		else {
HXLINE( 102)			_hx_tmp2 = ::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->_value);
            		}
HXDLIN( 102)		_hx_tmp1->set_htmlText((HX_("",00,00,00,00) + _hx_tmp2));
            	}
