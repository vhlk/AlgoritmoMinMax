...
void TextBehaviour_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_8d3364b1bfc8293e_88_validateData)
HXLINE(  89)		 ::haxe::ui::styles::Style _hx_tmp = this->_component->getTextDisplay()->get_textStyle();
HXDLIN(  89)		if (::hx::IsInstanceNotEq( _hx_tmp,this->_component->get_style() )) {
HXLINE(  90)			 ::haxe::ui::core::Component _this = this->_component;
HXDLIN(  90)			_this->invalidateComponent(HX_("style",31,a5,1d,84));
HXDLIN(  90)			_this->_style = null();
            		}
HXLINE(  92)		 ::haxe::ui::core::TextDisplay _hx_tmp1 = this->_component->getTextDisplay();
HXDLIN(  92)		::String _hx_tmp2;
HXDLIN(  92)		if (::hx::IsNull( this->_value )) {
HXLINE(  92)			_hx_tmp2 = HX_("null",87,9e,0e,49);
            		}
            		else {
HXLINE(  92)			_hx_tmp2 = ::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->_value);
            		}
HXDLIN(  92)		_hx_tmp1->set_text((HX_("",00,00,00,00) + _hx_tmp2));
            	}
