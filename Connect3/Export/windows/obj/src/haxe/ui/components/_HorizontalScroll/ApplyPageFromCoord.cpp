...
HXLINE(  75)			Float _hx_tmp = scroll->get_pos();
HXDLIN(  75)			scroll->set_pos((_hx_tmp - scroll->get_pageSize()));
            		}
            		else {
HXLINE(  76)			Float p1 = p->x;
HXDLIN(  76)			Float _hx_tmp = thumb->get_screenLeft();
HXDLIN(  76)			if ((p1 > (_hx_tmp + thumb->get_width()))) {
