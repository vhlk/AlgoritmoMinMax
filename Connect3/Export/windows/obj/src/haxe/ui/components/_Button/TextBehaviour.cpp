...
HX_DEFINE_STACK_FRAME(_hx_pos_4d84ef4d644c4db5_272_new,"haxe.ui.components._Button.TextBehaviour","new",0xe0f3d75f,"haxe.ui.components._Button.TextBehaviour.new","haxe/ui/components/Button.hx",272,0x45086125)
HX_LOCAL_STACK_FRAME(_hx_pos_4d84ef4d644c4db5_273_validateData,"haxe.ui.components._Button.TextBehaviour","validateData",0xeabff701,"haxe.ui.components._Button.TextBehaviour.validateData","haxe/ui/components/Button.hx",273,0x45086125)
namespace haxe{
namespace ui{
...
void TextBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_4d84ef4d644c4db5_272_new)
...
void TextBehaviour_obj::validateData(){
            	HX_GC_STACKFRAME(&_hx_pos_4d84ef4d644c4db5_273_validateData)
HXLINE( 274)		 ::haxe::ui::components::Label label = this->_component->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::Label >(),false,null()).StaticCast<  ::haxe::ui::components::Label >();
HXLINE( 275)		if (::hx::IsNull( label )) {
HXLINE( 276)			label =  ::haxe::ui::components::Label_obj::__alloc( HX_CTX );
HXLINE( 277)			label->set_id(HX_("button-label",19,ae,e7,e0));
HXLINE( 278)			label->scriptAccess = false;
HXLINE( 279)			this->_component->addComponent(label);
HXLINE( 280)			{
HXLINE( 280)				 ::haxe::ui::core::Component _this = this->_component;
HXDLIN( 280)				_this->invalidateComponent(HX_("style",31,a5,1d,84));
HXDLIN( 280)				_this->_style = null();
            			}
            		}
HXLINE( 283)		label->set_text(::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->_value));
            	}
