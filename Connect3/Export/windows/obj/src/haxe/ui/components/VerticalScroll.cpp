...
HX_LOCAL_STACK_FRAME(_hx_pos_13078ab53731a40d_525_cloneComponent,"haxe.ui.components.VerticalScroll","cloneComponent",0xcf594025,"haxe.ui.components.VerticalScroll.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",525,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_bbaa27035b3a9a62_351_self,"haxe.ui.components.VerticalScroll","self",0xf86a79d1,"haxe.ui.components.VerticalScroll.self","haxe/ui/macros/Macros.hx",351,0x27866361)
namespace haxe{
namespace ui{
...
void VerticalScroll_obj::createDefaults(){
            	HX_STACKFRAME(&_hx_pos_46c031fb0bf2ef34_25_createDefaults)
HXLINE(  26)		this->super::createDefaults();
HXLINE(  27)		this->_defaultLayoutClass = ::hx::ClassOf< ::haxe::ui::components::_VerticalScroll::VerticalScrollLayout >();
            	}


 ::haxe::ui::core::ComponentContainer VerticalScroll_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_13078ab53731a40d_525_cloneComponent)
HXLINE( 300)		 ::haxe::ui::components::VerticalScroll c = ( ( ::haxe::ui::components::VerticalScroll)(this->super::cloneComponent()) );
...
HXLINE( 323)		return c;
 ...
 ::haxe::ui::core::ComponentContainer VerticalScroll_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_bbaa27035b3a9a62_351_self)
HXDLIN( 351)		return  ::haxe::ui::components::VerticalScroll_obj::__alloc( HX_CTX );
            	}
