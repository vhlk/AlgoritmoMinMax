...
HX_DEFINE_STACK_FRAME(_hx_pos_701ee7c2cd4a57d1_29_new,"haxe.ui.components._Switch.SelectedBehaviour","new",0x31c990f3,"haxe.ui.components._Switch.SelectedBehaviour.new","haxe/ui/components/Switch.hx",29,0x0342e663)
HX_LOCAL_STACK_FRAME(_hx_pos_701ee7c2cd4a57d1_31_validateData,"haxe.ui.components._Switch.SelectedBehaviour","validateData",0x52f86aed,"haxe.ui.components._Switch.SelectedBehaviour.validateData","haxe/ui/components/Switch.hx",31,0x0342e663)
namespace haxe{
namespace ui{
...
void SelectedBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_701ee7c2cd4a57d1_29_new)
HXDLIN(  29)		super::__construct(component);
            	}
...
void SelectedBehaviour_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_701ee7c2cd4a57d1_31_validateData)
HXDLIN(  31)		 ::haxe::ui::components::_Switch::SwitchButtonSub _hx_tmp = this->_component->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::_Switch::SwitchButtonSub >(),null(),null()).StaticCast<  ::haxe::ui::components::_Switch::SwitchButtonSub >();
HXDLIN(  31)		_hx_tmp->set_selected(::haxe::ui::util::_Variant::Variant_Impl__obj::toBool(this->_value));
            	}
