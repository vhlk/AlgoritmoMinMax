...
HX_DEFINE_STACK_FRAME(_hx_pos_532b9f5f4ea619a7_330_new,"haxe.ui.components._Button.SelectedBehaviour","new",0xcddd1771,"haxe.ui.components._Button.SelectedBehaviour.new","haxe/ui/components/Button.hx",330,0x45086125)
HX_LOCAL_STACK_FRAME(_hx_pos_532b9f5f4ea619a7_331_validateData,"haxe.ui.components._Button.SelectedBehaviour","validateData",0xbbeb24af,"haxe.ui.components._Button.SelectedBehaviour.validateData","haxe/ui/components/Button.hx",331,0x45086125)
namespace haxe{
namespace ui{
...
void SelectedBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_532b9f5f4ea619a7_330_new)
...
void SelectedBehaviour_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_532b9f5f4ea619a7_331_validateData)
HXLINE( 332)		 ::haxe::ui::components::Button button = ::hx::TCast<  ::haxe::ui::components::Button >::cast(this->_component);
HXLINE( 333)		if ((button->get_toggle() == false)) {
HXLINE( 334)			return;
            		}
HXLINE( 337)		 ::haxe::ui::util::VariantType _hx_tmp = this->_value;
HXDLIN( 337)		if (::haxe::ui::util::_Variant::Variant_Impl__obj::eq(_hx_tmp,::haxe::ui::util::_Variant::Variant_Impl__obj::fromBool(false))) {
HXLINE( 338)			button->removeClass(HX_(":down",9c,9d,ab,a7),true,true);
            		}
            		else {
HXLINE( 340)			button->addClass(HX_(":down",9c,9d,ab,a7),true,true);
            		}
HXLINE( 342)		 ::haxe::ui::components::ButtonEvents events = ::hx::TCast<  ::haxe::ui::components::ButtonEvents >::cast(button->_internalEvents);
HXLINE( 343)		bool _hx_tmp1;
HXDLIN( 343)		if (::hx::IsNotNull( events->lastMouseEvent )) {
HXLINE( 343)			_hx_tmp1 = button->hitTest(events->lastMouseEvent->screenX,events->lastMouseEvent->screenY);
            		}
            		else {
HXLINE( 343)			_hx_tmp1 = false;
            		}
HXDLIN( 343)		if (_hx_tmp1) {
HXLINE( 344)			button->addClass(HX_(":hover",42,d3,17,5c),true,true);
HXLINE( 345)			events->lastMouseEvent = null();
            		}
            		else {
HXLINE( 347)			button->removeClass(HX_(":hover",42,d3,17,5c),true,true);
            		}
HXLINE( 349)		events->dispatchChanged();
            	}
