...
HX_DEFINE_STACK_FRAME(_hx_pos_49cf34a896d63da1_11_new,"haxe.ui.components.VerticalRange","new",0x1617f673,"haxe.ui.components.VerticalRange.new","haxe/ui/components/VerticalRange.hx",11,0x5f5177be)
HX_LOCAL_STACK_FRAME(_hx_pos_0715d8055e53e293_464_posFromCoord,"haxe.ui.components.VerticalRange","posFromCoord",0x0b6cd444,"haxe.ui.components.VerticalRange.posFromCoord","haxe/ui/macros/Macros.hx",464,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_0715d8055e53e293_71_registerComposite,"haxe.ui.components.VerticalRange","registerComposite",0x8ba76677,"haxe.ui.components.VerticalRange.registerComposite","haxe/ui/macros/Macros.hx",71,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_0715d8055e53e293_369_registerBehaviours,"haxe.ui.components.VerticalRange","registerBehaviours",0x29d14f26,"haxe.ui.components.VerticalRange.registerBehaviours","haxe/ui/macros/Macros.hx",369,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_1d8d084006476d81_525_cloneComponent,"haxe.ui.components.VerticalRange","cloneComponent",0x6a8da66d,"haxe.ui.components.VerticalRange.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",525,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_0715d8055e53e293_351_self,"haxe.ui.components.VerticalRange","self",0x422db619,"haxe.ui.components.VerticalRange.self","haxe/ui/macros/Macros.hx",351,0x27866361)
namespace haxe{
namespace ui{
namespace components{

void VerticalRange_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_49cf34a896d63da1_11_new)
	...
	if (inClassId<=(int)0x1fd6ffd3) {
		if (inClassId<=(int)0x0f2dd418) {
			...
			if (inClassId<=(int)0x1f4df417) {
				...
				return inClassId==(int)0x1fd6ffd3;
			}
		}
	} else {
...
Float VerticalRange_obj::posFromCoord( ::haxe::ui::geom::Point coord){
            	HX_STACKFRAME(&_hx_pos_0715d8055e53e293_464_posFromCoord)
...
void VerticalRange_obj::registerComposite(){
            	HX_STACKFRAME(&_hx_pos_0715d8055e53e293_71_registerComposite)
...
void VerticalRange_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_0715d8055e53e293_369_registerBehaviours)
...
HXLINE( 470)		this->behaviours->_hx_register(HX_("posFromCoord",b7,d4,5e,a6),::hx::ClassOf< ::haxe::ui::components::VerticalRangePosFromCoord >(),null());
 ...
 ::haxe::ui::core::ComponentContainer VerticalRange_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_1d8d084006476d81_525_cloneComponent)
HXLINE( 300)		 ::haxe::ui::components::VerticalRange c = ( ( ::haxe::ui::components::VerticalRange)(this->super::cloneComponent()) );
...
HXLINE( 323)		return c;
 ...
 ::haxe::ui::core::ComponentContainer VerticalRange_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_0715d8055e53e293_351_self)
HXDLIN( 351)		return  ::haxe::ui::components::VerticalRange_obj::__alloc( HX_CTX );
            	}
