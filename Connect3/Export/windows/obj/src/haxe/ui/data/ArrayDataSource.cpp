...
HX_LOCAL_STACK_FRAME(_hx_pos_d9449cccdc2aada1_42_handleClear,"haxe.ui.data.ArrayDataSource","handleClear",0x34f7f0a3,"haxe.ui.data.ArrayDataSource.handleClear","haxe/ui/data/ArrayDataSource.hx",42,0xc8e62c93)
HX_LOCAL_STACK_FRAME(_hx_pos_d9449cccdc2aada1_48_handleGetData,"haxe.ui.data.ArrayDataSource","handleGetData",0xc0f0f676,"haxe.ui.data.ArrayDataSource.handleGetData","haxe/ui/data/ArrayDataSource.hx",48,0xc8e62c93)
HX_LOCAL_STACK_FRAME(_hx_pos_d9449cccdc2aada1_52_handleSetData,"haxe.ui.data.ArrayDataSource","handleSetData",0xb3f28782,"haxe.ui.data.ArrayDataSource.handleSetData","haxe/ui/data/ArrayDataSource.hx",52,0xc8e62c93)
HX_LOCAL_STACK_FRAME(_hx_pos_d9449cccdc2aada1_56_handleUpdateItem,"haxe.ui.data.ArrayDataSource","handleUpdateItem",0xfb05c0e6,"haxe.ui.data.ArrayDataSource.handleUpdateItem","haxe/ui/data/ArrayDataSource.hx",56,0xc8e62c93)
HX_LOCAL_STACK_FRAME(_hx_pos_d9449cccdc2aada1_59_clone,"haxe.ui.data.ArrayDataSource","clone",0x7cb38cbb,"haxe.ui.data.ArrayDataSource.clone","haxe/ui/data/ArrayDataSource.hx",59,0xc8e62c93)
HX_LOCAL_STACK_FRAME(_hx_pos_d9449cccdc2aada1_65_fromArray,"haxe.ui.data.ArrayDataSource","fromArray",0x1243d82d,"haxe.ui.data.ArrayDataSource.fromArray","haxe/ui/data/ArrayDataSource.hx",65,0xc8e62c93)
namespace haxe{
namespace ui{
namespace data{
...
void ArrayDataSource_obj::handleClear(){
            	HX_STACKFRAME(&_hx_pos_d9449cccdc2aada1_42_handleClear)
HXDLIN(  42)		while((this->_array->get_length() > 0)){
HXLINE(  43)			this->_array->pop();
            		}
            	}


 ::Dynamic ArrayDataSource_obj::handleGetData(){
            	HX_STACKFRAME(&_hx_pos_d9449cccdc2aada1_48_handleGetData)
HXDLIN(  48)		return this->_array;
            	}


void ArrayDataSource_obj::handleSetData( ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_d9449cccdc2aada1_52_handleSetData)
HXDLIN(  52)		this->_array = ( (::cpp::VirtualArray)(v) );
            	}


 ::Dynamic ArrayDataSource_obj::handleUpdateItem(int index, ::Dynamic item){
            	HX_STACKFRAME(&_hx_pos_d9449cccdc2aada1_56_handleUpdateItem)
HXDLIN(  56)		return (this->_array->set(index,item));
            	}


 ::haxe::ui::data::DataSource ArrayDataSource_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_d9449cccdc2aada1_59_clone)
HXLINE(  60)		 ::haxe::ui::data::ArrayDataSource c =  ::haxe::ui::data::ArrayDataSource_obj::__alloc( HX_CTX ,null());
HXLINE(  61)		c->_array = this->_array->copy();
HXLINE(  62)		return c;
            	}


 ::haxe::ui::data::ArrayDataSource ArrayDataSource_obj::fromArray(::cpp::VirtualArray source,::Dynamic transformer){
            	HX_GC_STACKFRAME(&_hx_pos_d9449cccdc2aada1_65_fromArray)
HXLINE(  66)		 ::haxe::ui::data::ArrayDataSource ds =  ::haxe::ui::data::ArrayDataSource_obj::__alloc( HX_CTX ,transformer);
HXLINE(  67)		ds->_array = source;
HXLINE(  68)		return ds;
            	}
