...
HXDLIN(  73)		::Array< ::String > resourceId1 = ::Array_obj< ::String >::__new(1)->init(0,resourceId);
HXDLIN(  73)		 ::haxe::ui::ToolkitAssets _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE(  74)		::String orginalResourceId = resourceId1->__get(0);
HXLINE(  75)		resourceId1[0] = ( (::String)(this->runPlugins(resourceId1->__get(0))) );
HXLINE(  76)		bool _hx_tmp;
HXDLIN(  76)		bool _hx_tmp1;
HXDLIN(  76)		if (::hx::IsNotNull( this->_imageCache )) {
HXLINE(  76)			_hx_tmp1 = ::hx::IsNotNull( this->_imageCache->get(resourceId1->__get(0)) );
            		}
            		else {
...
HXLINE(  77)			 ::Dynamic callback1 = callback;
HXDLIN(  77)			callback1(this->_imageCache->get(resourceId1->__get(0)));
            		}
            		else {
HXLINE(  79)			if (::hx::IsNull( this->_imageCallbacks )) {
HXLINE(  80)				this->_imageCallbacks =  ::haxe::ui::util::CallbackMap_obj::__alloc( HX_CTX );
            			}
HXLINE(  83)			this->_imageCallbacks->add(resourceId1->__get(0),callback,null());
HXLINE(  85)			if ((this->_imageCallbacks->count(resourceId1->__get(0)) == 1)) {
...
HXLINE(  88)						_gthis->_onImageLoaded(resourceId1->__get(0),imageInfo);
            					}
            					else {
HXLINE(  89)						if ((::haxe::Resource_obj::listNames()->indexOf(orginalResourceId,null()) != -1)) {
HXLINE(  90)							_gthis->_imageCallbacks->remove(resourceId1->__get(0),callback);
...
HXLINE(  93)							::Array< ::String > _hx_tmp = ::haxe::Resource_obj::listNames();
HXDLIN(  93)							if ((_hx_tmp->indexOf(resourceId1->__get(0),null()) != -1)) {
HXLINE(  94)								_gthis->getImageFromHaxeResource(resourceId1->__get(0),_gthis->_onImageLoaded_dyn());
            							}
            							else {
HXLINE(  96)								_gthis->_imageCallbacks->remove(resourceId1->__get(0),callback);
...
HXLINE(  86)				this->getImageInternal(resourceId1->__get(0), ::Dynamic(new _hx_Closure_0(_gthis,orginalResourceId,resourceId1,callback)));
            			}
            		}
            	}
...
HXLINE( 110)			this->_imageCache =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            		}
...
void ToolkitAssets_obj::addPlugin( ::haxe::ui::assets::AssetPlugin plugin){
            	HX_STACKFRAME(&_hx_pos_0397d73654d5d7af_132_addPlugin)
HXLINE( 133)		if (::hx::IsNull( this->_plugins )) {
HXLINE( 134)			this->_plugins = ::Array_obj< ::Dynamic>::__new(0);
            		}
