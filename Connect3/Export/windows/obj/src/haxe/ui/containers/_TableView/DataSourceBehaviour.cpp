...
HX_DEFINE_STACK_FRAME(_hx_pos_39fbe7471cd72fbf_572_new,"haxe.ui.containers._TableView.DataSourceBehaviour","new",0x0f08d2fa,"haxe.ui.containers._TableView.DataSourceBehaviour.new","haxe/ui/containers/TableView.hx",572,0x8a42a716)
HX_LOCAL_STACK_FRAME(_hx_pos_39fbe7471cd72fbf_574_set,"haxe.ui.containers._TableView.DataSourceBehaviour","set",0x0f0c9e3c,"haxe.ui.containers._TableView.DataSourceBehaviour.set","haxe/ui/containers/TableView.hx",574,0x8a42a716)
HX_LOCAL_STACK_FRAME(_hx_pos_39fbe7471cd72fbf_579_set,"haxe.ui.containers._TableView.DataSourceBehaviour","set",0x0f0c9e3c,"haxe.ui.containers._TableView.DataSourceBehaviour.set","haxe/ui/containers/TableView.hx",579,0x8a42a716)
HX_LOCAL_STACK_FRAME(_hx_pos_39fbe7471cd72fbf_594_get,"haxe.ui.containers._TableView.DataSourceBehaviour","get",0x0f038330,"haxe.ui.containers._TableView.DataSourceBehaviour.get","haxe/ui/containers/TableView.hx",594,0x8a42a716)
namespace haxe{
namespace ui{
...
void DataSourceBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_39fbe7471cd72fbf_572_new)
HXLINE( 573)		this->_firstPass = true;
HXLINE( 572)		super::__construct(component);
            	}
...
void DataSourceBehaviour_obj::set( ::haxe::ui::util::VariantType value){
            	HX_GC_STACKFRAME(&_hx_pos_39fbe7471cd72fbf_574_set)
HXDLIN( 574)		 ::haxe::ui::containers::_TableView::DataSourceBehaviour _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 575)		this->super::set(value);
HXLINE( 576)		 ::haxe::ui::data::DataSource dataSource = ::haxe::ui::util::_Variant::Variant_Impl__obj::toDataSource(this->_value);
HXLINE( 577)		if (::hx::IsNotNull( dataSource )) {
            			HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::haxe::ui::containers::_TableView::DataSourceBehaviour,_gthis) HXARGC(0)
            			void _hx_run(){
            				HX_GC_STACKFRAME(&_hx_pos_39fbe7471cd72fbf_579_set)
HXLINE( 580)				{
HXLINE( 580)					 ::haxe::ui::core::Component _this = _gthis->_component;
HXDLIN( 580)					bool _hx_tmp;
HXDLIN( 580)					if (::hx::IsNotNull( _this->_layout )) {
HXLINE( 580)						_hx_tmp = (_this->_layoutLocked == true);
            					}
            					else {
HXLINE( 580)						_hx_tmp = true;
            					}
HXDLIN( 580)					if (!(_hx_tmp)) {
HXLINE( 580)						_this->invalidateComponent(HX_("layout",aa,ae,b8,58));
            					}
            				}
HXLINE( 581)				if ((_gthis->_firstPass == true)) {
HXLINE( 582)					_gthis->_component->syncComponentValidation(null());
HXLINE( 583)					_gthis->_firstPass = false;
HXLINE( 584)					{
HXLINE( 584)						 ::haxe::ui::core::Component _this = _gthis->_component;
HXDLIN( 584)						bool _hx_tmp;
HXDLIN( 584)						if (::hx::IsNotNull( _this->_layout )) {
HXLINE( 584)							_hx_tmp = (_this->_layoutLocked == true);
            						}
            						else {
HXLINE( 584)							_hx_tmp = true;
            						}
HXDLIN( 584)						if (!(_hx_tmp)) {
HXLINE( 584)							_this->invalidateComponent(HX_("layout",aa,ae,b8,58));
            						}
            					}
            				}
HXLINE( 586)				::haxe::ui::binding::BindingManager_obj::get_instance()->componentPropChanged(_gthis->_component,HX_("dataSource",a5,76,d3,1d));
            			}
            			HX_END_LOCAL_FUNC0((void))

HXLINE( 578)			dataSource->transformer =  ::haxe::ui::data::transformation::NativeTypeTransformer_obj::__alloc( HX_CTX );
HXLINE( 579)			dataSource->onChange =  ::Dynamic(new _hx_Closure_0(_gthis));
HXLINE( 588)			{
HXLINE( 588)				 ::haxe::ui::core::Component _this = this->_component;
HXDLIN( 588)				bool _hx_tmp;
HXDLIN( 588)				if (::hx::IsNotNull( _this->_layout )) {
HXLINE( 588)					_hx_tmp = (_this->_layoutLocked == true);
            				}
            				else {
HXLINE( 588)					_hx_tmp = true;
            				}
HXDLIN( 588)				if (!(_hx_tmp)) {
HXLINE( 588)					_this->invalidateComponent(HX_("layout",aa,ae,b8,58));
            				}
            			}
            		}
            		else {
HXLINE( 590)			 ::haxe::ui::core::Component _this = this->_component;
HXDLIN( 590)			bool _hx_tmp;
HXDLIN( 590)			if (::hx::IsNotNull( _this->_layout )) {
HXLINE( 590)				_hx_tmp = (_this->_layoutLocked == true);
            			}
            			else {
HXLINE( 590)				_hx_tmp = true;
            			}
HXDLIN( 590)			if (!(_hx_tmp)) {
HXLINE( 590)				_this->invalidateComponent(HX_("layout",aa,ae,b8,58));
            			}
            		}
            	}
 ...
 ::haxe::ui::util::VariantType DataSourceBehaviour_obj::get(){
            	HX_GC_STACKFRAME(&_hx_pos_39fbe7471cd72fbf_594_get)
HXLINE( 595)		bool _hx_tmp;
HXDLIN( 595)		if (::hx::IsNotNull( this->_value )) {
HXLINE( 595)			_hx_tmp = ::haxe::ui::util::_Variant::Variant_Impl__obj::get_isNull(this->_value);
            		}
            		else {
HXLINE( 595)			_hx_tmp = true;
            		}
HXDLIN( 595)		if (_hx_tmp) {
HXLINE( 596)			this->_value = ::haxe::ui::util::_Variant::Variant_Impl__obj::fromDataSource( ::haxe::ui::data::ArrayDataSource_obj::__alloc( HX_CTX ,null()));
HXLINE( 597)			this->set(this->_value);
            		}
HXLINE( 599)		return this->_value;
            	}
