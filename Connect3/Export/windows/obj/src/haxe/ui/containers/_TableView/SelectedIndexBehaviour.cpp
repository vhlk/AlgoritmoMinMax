...
HX_DEFINE_STACK_FRAME(_hx_pos_69fd336de6798f19_604_new,"haxe.ui.containers._TableView.SelectedIndexBehaviour","new",0xc3543f48,"haxe.ui.containers._TableView.SelectedIndexBehaviour.new","haxe/ui/containers/TableView.hx",604,0x8a42a716)
HX_LOCAL_STACK_FRAME(_hx_pos_69fd336de6798f19_605_get,"haxe.ui.containers._TableView.SelectedIndexBehaviour","get",0xc34eef7e,"haxe.ui.containers._TableView.SelectedIndexBehaviour.get","haxe/ui/containers/TableView.hx",605,0x8a42a716)
HX_LOCAL_STACK_FRAME(_hx_pos_69fd336de6798f19_611_set,"haxe.ui.containers._TableView.SelectedIndexBehaviour","set",0xc3580a8a,"haxe.ui.containers._TableView.SelectedIndexBehaviour.set","haxe/ui/containers/TableView.hx",611,0x8a42a716)
namespace haxe{
namespace ui{
...
void SelectedIndexBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_69fd336de6798f19_604_new)
HXDLIN( 604)		super::__construct(component);
            	}
...
bool SelectedIndexBehaviour_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType SelectedIndexBehaviour_obj::get(){
            	HX_STACKFRAME(&_hx_pos_69fd336de6798f19_605_get)
HXLINE( 606)		 ::haxe::ui::containers::TableView tableView = ::hx::TCast<  ::haxe::ui::containers::TableView >::cast(this->_component);
HXLINE( 607)		::Array< int > selectedIndices = tableView->get_selectedIndices();
HXLINE( 608)		bool _hx_tmp;
HXDLIN( 608)		if (::hx::IsNotNull( selectedIndices )) {
HXLINE( 608)			_hx_tmp = (selectedIndices->length > 0);
            		}
            		else {
HXLINE( 608)			_hx_tmp = false;
            		}
HXDLIN( 608)		if (_hx_tmp) {
HXLINE( 608)			return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromInt(selectedIndices->__get((selectedIndices->length - 1)));
            		}
            		else {
HXLINE( 608)			return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromInt(-1);
            		}
HXDLIN( 608)		return null();
            	}


void SelectedIndexBehaviour_obj::set( ::haxe::ui::util::VariantType value){
            	HX_STACKFRAME(&_hx_pos_69fd336de6798f19_611_set)
HXLINE( 612)		 ::haxe::ui::containers::TableView tableView = ::hx::TCast<  ::haxe::ui::containers::TableView >::cast(this->_component);
HXLINE( 613)		::Array< int > _hx_tmp;
HXDLIN( 613)		if (::haxe::ui::util::_Variant::Variant_Impl__obj::neq(value,::haxe::ui::util::_Variant::Variant_Impl__obj::fromInt(-1))) {
HXLINE( 613)			_hx_tmp = ::Array_obj< int >::__new(1)->init(0,::haxe::ui::util::_Variant::Variant_Impl__obj::toInt(value));
            		}
            		else {
HXLINE( 613)			_hx_tmp = null();
            		}
HXDLIN( 613)		tableView->set_selectedIndices(_hx_tmp);
            	}
