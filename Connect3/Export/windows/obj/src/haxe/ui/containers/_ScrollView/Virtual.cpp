...
HX_DEFINE_STACK_FRAME(_hx_pos_b29c0e57337870ab_107_new,"haxe.ui.containers._ScrollView.Virtual","new",0x64e7e5f6,"haxe.ui.containers._ScrollView.Virtual.new","haxe/ui/containers/ScrollView.hx",107,0x01b76681)
HX_LOCAL_STACK_FRAME(_hx_pos_b29c0e57337870ab_108_set,"haxe.ui.containers._ScrollView.Virtual","set",0x64ebb138,"haxe.ui.containers._ScrollView.Virtual.set","haxe/ui/containers/ScrollView.hx",108,0x01b76681)
namespace haxe{
namespace ui{
...
void Virtual_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_b29c0e57337870ab_107_new)
...
void Virtual_obj::set( ::haxe::ui::util::VariantType value){
            	HX_STACKFRAME(&_hx_pos_b29c0e57337870ab_108_set)
HXLINE( 109)		this->super::set(value);
HXLINE( 110)		if (::hx::IsNotNull( this->_component->_compositeBuilder )) {
HXLINE( 111)			::hx::TCast<  ::haxe::ui::containers::ScrollViewBuilder >::cast(this->_component->_compositeBuilder)->onVirtualChanged();
            		}
            	}
