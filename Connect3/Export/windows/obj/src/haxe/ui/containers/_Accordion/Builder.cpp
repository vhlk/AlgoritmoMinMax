...
void Builder_obj::__construct( ::haxe::ui::containers::Accordion accordion){
            	HX_STACKFRAME(&_hx_pos_8ed8573efe4b0a42_109_new)
HXLINE( 110)		super::__construct(accordion);
HXLINE( 111)		this->_accordion = accordion;
            	}
...
bool Builder_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x0472fd8d) {
		...
		return inClassId==(int)0x62f24de6;
	}
}
...
HXLINE( 152)					 ::haxe::ui::core::Component child = _g1->__get(_g).StaticCast<  ::haxe::ui::core::Component >();
HXDLIN( 152)					_g = (_g + 1);
HXLINE( 153)					if (child->hasClass(HX_("accordion-button",57,b8,37,4e))) {
HXLINE( 154)						if ((buttonCount == 0)) {
HXLINE( 155)							child->swapClass(HX_("first",30,78,9d,00),HX_("last",56,0a,ad,47),false,null());
            						}
            						else {
HXLINE( 156)							bool _hx_tmp;
HXDLIN( 156)							 ::haxe::ui::core::Component _this = this->_component;
HXDLIN( 156)							::Array< ::Dynamic> _hx_tmp1;
HXDLIN( 156)							if (::hx::IsNull( _this->_children )) {
HXLINE( 156)								_hx_tmp1 = ::Array_obj< ::Dynamic>::__new(0);
            							}
            							else {
HXLINE( 156)								_hx_tmp1 = _this->_children;
            							}
HXDLIN( 156)							if (((( (Float)(_hx_tmp1->length) ) / ( (Float)(2) )) > 1)) {
...
HXDLIN( 156)								_hx_tmp = (buttonCount == ((( (Float)(_hx_tmp1->length) ) / ( (Float)(2) )) - ( (Float)(1) )));
            							}
            							else {
HXLINE( 156)								_hx_tmp = false;
            							}
HXDLIN( 156)							if (_hx_tmp) {
HXLINE( 157)								child->swapClass(HX_("last",56,0a,ad,47),HX_("first",30,78,9d,00),false,null());
            							}
            							else {
HXLINE( 159)								child->removeClasses(::Array_obj< ::String >::fromData( _hx_array_data_75e83440_6,2),false,null());
            							}
            						}
HXLINE( 162)						buttonCount = (buttonCount + 1);
            					}
            					else {
HXLINE( 163)						if (child->hasClass(HX_("accordion-page",74,5d,26,be))) {
HXLINE( 164)							if ((pageCount == 0)) {
HXLINE( 165)								child->swapClass(HX_("first",30,78,9d,00),HX_("last",56,0a,ad,47),false,null());
            							}
            							else {
HXLINE( 166)								bool _hx_tmp;
HXDLIN( 166)								 ::haxe::ui::core::Component _this = this->_component;
HXDLIN( 166)								::Array< ::Dynamic> _hx_tmp1;
HXDLIN( 166)								if (::hx::IsNull( _this->_children )) {
HXLINE( 166)									_hx_tmp1 = ::Array_obj< ::Dynamic>::__new(0);
            								}
            								else {
HXLINE( 166)									_hx_tmp1 = _this->_children;
            								}
HXDLIN( 166)								if (((( (Float)(_hx_tmp1->length) ) / ( (Float)(2) )) > 1)) {
HXLINE( 166)									 ::haxe::ui::core::Component _this = this->_component;
HXDLIN( 166)									::Array< ::Dynamic> _hx_tmp1;
HXDLIN( 166)									if (::hx::IsNull( _this->_children )) {
HXLINE( 166)										_hx_tmp1 = ::Array_obj< ::Dynamic>::__new(0);
            									}
...
HXDLIN( 166)									_hx_tmp = (pageCount == ((( (Float)(_hx_tmp1->length) ) / ( (Float)(2) )) - ( (Float)(1) )));
            								}
            								else {
HXLINE( 166)									_hx_tmp = false;
            								}
HXDLIN( 166)								if (_hx_tmp) {
HXLINE( 167)									child->swapClass(HX_("last",56,0a,ad,47),HX_("first",30,78,9d,00),false,null());
            								}
            								else {
HXLINE( 169)									child->removeClasses(::Array_obj< ::String >::fromData( _hx_array_data_75e83440_7,2),false,null());
            								}
            							}
...
::hx::Val Builder_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 10:
		if (HX_FIELD_EQ(inName,"_accordion") ) { _accordion=inValue.Cast<  ::haxe::ui::containers::Accordion >(); return inValue; }
	}
