...
HX_DEFINE_STACK_FRAME(_hx_pos_3a917a346c225272_418_new,"haxe.ui.containers._ListView.SelectedItemBehaviour","new",0x2e96d1cb,"haxe.ui.containers._ListView.SelectedItemBehaviour.new","haxe/ui/containers/ListView.hx",418,0xe137bf10)
HX_LOCAL_STACK_FRAME(_hx_pos_3a917a346c225272_419_getDynamic,"haxe.ui.containers._ListView.SelectedItemBehaviour","getDynamic",0x101bf77e,"haxe.ui.containers._ListView.SelectedItemBehaviour.getDynamic","haxe/ui/containers/ListView.hx",419,0xe137bf10)
HX_LOCAL_STACK_FRAME(_hx_pos_3a917a346c225272_425_set,"haxe.ui.containers._ListView.SelectedItemBehaviour","set",0x2e9a9d0d,"haxe.ui.containers._ListView.SelectedItemBehaviour.set","haxe/ui/containers/ListView.hx",425,0xe137bf10)
namespace haxe{
namespace ui{
...
void SelectedItemBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_3a917a346c225272_418_new)
...
bool SelectedItemBehaviour_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic SelectedItemBehaviour_obj::getDynamic(){
            	HX_STACKFRAME(&_hx_pos_3a917a346c225272_419_getDynamic)
HXLINE( 420)		 ::haxe::ui::containers::ListView listView = ::hx::TCast<  ::haxe::ui::containers::ListView >::cast(this->_component);
HXLINE( 421)		::Array< int > selectedIndices = listView->get_selectedIndices();
HXLINE( 422)		if ((selectedIndices->length > 0)) {
HXLINE( 422)			 ::haxe::ui::data::DataSource _hx_tmp = listView->get_dataSource();
HXDLIN( 422)			return _hx_tmp->get(selectedIndices->__get((selectedIndices->length - 1)));
            		}
            		else {
...
void SelectedItemBehaviour_obj::set( ::haxe::ui::util::VariantType value){
            	HX_STACKFRAME(&_hx_pos_3a917a346c225272_425_set)
HXLINE( 426)		 ::haxe::ui::containers::ListView listView = ::hx::TCast<  ::haxe::ui::containers::ListView >::cast(this->_component);
HXLINE( 427)		int index = listView->get_dataSource()->indexOf(value);
HXLINE( 428)		bool _hx_tmp;
HXDLIN( 428)		if ((index != -1)) {
HXLINE( 428)			_hx_tmp = (listView->get_selectedIndices()->indexOf(index,null()) == -1);
            		}
            		else {
HXLINE( 428)			_hx_tmp = false;
            		}
HXDLIN( 428)		if (_hx_tmp) {
HXLINE( 429)			listView->set_selectedIndices(::Array_obj< int >::__new(1)->init(0,index));
            		}
            	}
