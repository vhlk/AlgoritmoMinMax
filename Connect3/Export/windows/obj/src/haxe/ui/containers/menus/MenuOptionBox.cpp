...
HX_LOCAL_STACK_FRAME(_hx_pos_047663693d5aacfc_369_registerBehaviours,"haxe.ui.containers.menus.MenuOptionBox","registerBehaviours",0xc352c754,"haxe.ui.containers.menus.MenuOptionBox.registerBehaviours","haxe/ui/macros/Macros.hx",369,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_047663693d5aacfc_388_get_componentGroup,"haxe.ui.containers.menus.MenuOptionBox","get_componentGroup",0x13806586,"haxe.ui.containers.menus.MenuOptionBox.get_componentGroup","haxe/ui/macros/Macros.hx",388,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_047663693d5aacfc_417_set_componentGroup,"haxe.ui.containers.menus.MenuOptionBox","set_componentGroup",0xf02f97fa,"haxe.ui.containers.menus.MenuOptionBox.set_componentGroup","haxe/ui/macros/Macros.hx",417,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_047663693d5aacfc_388_get_selected,"haxe.ui.containers.menus.MenuOptionBox","get_selected",0xfd08df9f,"haxe.ui.containers.menus.MenuOptionBox.get_selected","haxe/ui/macros/Macros.hx",388,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_047663693d5aacfc_431_set_selected,"haxe.ui.containers.menus.MenuOptionBox","set_selected",0x12020313,"haxe.ui.containers.menus.MenuOptionBox.set_selected","haxe/ui/macros/Macros.hx",431,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_8772e191e8c448dd_525_cloneComponent,"haxe.ui.containers.menus.MenuOptionBox","cloneComponent",0xe247ef9b,"haxe.ui.containers.menus.MenuOptionBox.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",525,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_047663693d5aacfc_351_self,"haxe.ui.containers.menus.MenuOptionBox","self",0xa2b159c7,"haxe.ui.containers.menus.MenuOptionBox.self","haxe/ui/macros/Macros.hx",351,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_047663693d5aacfc_71_registerComposite,"haxe.ui.containers.menus.MenuOptionBox","registerComposite",0x83288e09,"haxe.ui.containers.menus.MenuOptionBox.registerComposite","haxe/ui/macros/Macros.hx",71,0x27866361)
namespace haxe{
namespace ui{
	...
	if (inClassId<=(int)0x241b0321) {
		...
		if (inClassId<=(int)0x5fbf562f) {
			if (inClassId<=(int)0x48332f1a) {
				...
				return inClassId==(int)0x4af7dd8e || inClassId==(int)0x5fbf562f;
			}
		} else {
...
void MenuOptionBox_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_047663693d5aacfc_369_registerBehaviours)
HXLINE( 370)		this->super::registerBehaviours();
HXLINE( 447)		this->behaviours->_hx_register(HX_("componentGroup",42,65,fb,e8),::hx::ClassOf< ::haxe::ui::containers::menus::_MenuOptionBox::GroupBehaviour >(),null());
HXDLIN( 447)		this->behaviours->_hx_register(HX_("text",ad,cc,f9,4c),::hx::ClassOf< ::haxe::ui::containers::menus::_MenuOptionBox::TextBehaviour >(),null());
HXDLIN( 447)		this->behaviours->_hx_register(HX_("shortcutText",53,aa,dc,fc),::hx::ClassOf< ::haxe::ui::containers::menus::_MenuOptionBox::ShortcutTextBehaviour >(),null());
HXDLIN( 447)		this->behaviours->_hx_register(HX_("selected",5b,2a,6d,b1),::hx::ClassOf< ::haxe::ui::containers::menus::_MenuOptionBox::SelectedBehaviour >(),null());
            	}


::String MenuOptionBox_obj::get_componentGroup(){
            	HX_STACKFRAME(&_hx_pos_047663693d5aacfc_388_get_componentGroup)
...
::String MenuOptionBox_obj::set_componentGroup(::String value){
            	HX_GC_STACKFRAME(&_hx_pos_047663693d5aacfc_417_set_componentGroup)
HXLINE( 418)		{
...
bool MenuOptionBox_obj::get_selected(){
            	HX_STACKFRAME(&_hx_pos_047663693d5aacfc_388_get_selected)
...
bool MenuOptionBox_obj::set_selected(bool value){
            	HX_GC_STACKFRAME(&_hx_pos_047663693d5aacfc_431_set_selected)
...
HX_DEFINE_DYNAMIC_FUNC1(MenuOptionBox_obj,set_selected,return )
 ...
 ::haxe::ui::core::ComponentContainer MenuOptionBox_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_8772e191e8c448dd_525_cloneComponent)
HXLINE( 300)		 ::haxe::ui::containers::menus::MenuOptionBox c = ( ( ::haxe::ui::containers::menus::MenuOptionBox)(this->super::cloneComponent()) );
...
HXLINE( 323)		return c;
 ...
 ::haxe::ui::core::ComponentContainer MenuOptionBox_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_047663693d5aacfc_351_self)
HXDLIN( 351)		return  ::haxe::ui::containers::menus::MenuOptionBox_obj::__alloc( HX_CTX );
            	}


void MenuOptionBox_obj::registerComposite(){
            	HX_STACKFRAME(&_hx_pos_047663693d5aacfc_71_registerComposite)
HXLINE(  72)		this->super::registerComposite();
HXLINE(  84)		this->_compositeBuilderClass = ::hx::ClassOf< ::haxe::ui::containers::menus::_MenuOptionBox::Builder >();
            	}
