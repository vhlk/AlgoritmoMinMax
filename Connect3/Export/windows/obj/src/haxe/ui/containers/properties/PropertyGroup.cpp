...
HX_LOCAL_STACK_FRAME(_hx_pos_c729f952cb4a8f3f_71_registerComposite,"haxe.ui.containers.properties.PropertyGroup","registerComposite",0x17b4c84f,"haxe.ui.containers.properties.PropertyGroup.registerComposite","haxe/ui/macros/Macros.hx",71,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_c729f952cb4a8f3f_369_registerBehaviours,"haxe.ui.containers.properties.PropertyGroup","registerBehaviours",0x29798a4e,"haxe.ui.containers.properties.PropertyGroup.registerBehaviours","haxe/ui/macros/Macros.hx",369,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_397938b558432c5e_525_cloneComponent,"haxe.ui.containers.properties.PropertyGroup","cloneComponent",0x0d5f2d95,"haxe.ui.containers.properties.PropertyGroup.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",525,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_c729f952cb4a8f3f_351_self,"haxe.ui.containers.properties.PropertyGroup","self",0x56863b41,"haxe.ui.containers.properties.PropertyGroup.self","haxe/ui/macros/Macros.hx",351,0x27866361)
namespace haxe{
namespace ui{
	...
	if (inClassId<=(int)0x241b0321) {
		...
		if (inClassId<=(int)0x6b353933) {
			if (inClassId<=(int)0x4af7dd8e) {
				...
				return inClassId==(int)0x551f812b || inClassId==(int)0x6b353933;
			}
		} else {
...
void PropertyGroup_obj::registerComposite(){
            	HX_STACKFRAME(&_hx_pos_c729f952cb4a8f3f_71_registerComposite)
HXLINE(  72)		this->super::registerComposite();
HXLINE(  80)		this->_internalEventsClass = ::hx::ClassOf< ::haxe::ui::containers::properties::_PropertyGroup::Events >();
HXLINE(  84)		this->_compositeBuilderClass = ::hx::ClassOf< ::haxe::ui::containers::properties::_PropertyGroup::Builder >();
            	}


void PropertyGroup_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_c729f952cb4a8f3f_369_registerBehaviours)
HXLINE( 370)		this->super::registerBehaviours();
HXLINE( 447)		this->behaviours->_hx_register(HX_("text",ad,cc,f9,4c),::hx::ClassOf< ::haxe::ui::containers::properties::_PropertyGroup::TextBehaviour >(),null());
            	}


 ::haxe::ui::core::ComponentContainer PropertyGroup_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_397938b558432c5e_525_cloneComponent)
HXLINE( 300)		 ::haxe::ui::containers::properties::PropertyGroup c = ( ( ::haxe::ui::containers::properties::PropertyGroup)(this->super::cloneComponent()) );
...
HXLINE( 323)		return c;
 ...
 ::haxe::ui::core::ComponentContainer PropertyGroup_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_c729f952cb4a8f3f_351_self)
HXDLIN( 351)		return  ::haxe::ui::containers::properties::PropertyGroup_obj::__alloc( HX_CTX );
            	}
