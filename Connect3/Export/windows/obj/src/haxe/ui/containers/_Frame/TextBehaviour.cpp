...
HX_DEFINE_STACK_FRAME(_hx_pos_fa3db2c10b380caf_22_new,"haxe.ui.containers._Frame.TextBehaviour","new",0x3297338c,"haxe.ui.containers._Frame.TextBehaviour.new","haxe/ui/containers/Frame.hx",22,0x566bdf3c)
HX_LOCAL_STACK_FRAME(_hx_pos_fa3db2c10b380caf_23_validateData,"haxe.ui.containers._Frame.TextBehaviour","validateData",0x5ce82d34,"haxe.ui.containers._Frame.TextBehaviour.validateData","haxe/ui/containers/Frame.hx",23,0x566bdf3c)
namespace haxe{
namespace ui{
...
void TextBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_fa3db2c10b380caf_22_new)
HXDLIN(  22)		super::__construct(component);
            	}
...
bool TextBehaviour_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x3c5dd90d) {
		...
		return inClassId==(int)0x4c50c472 || inClassId==(int)0x7e17fa9f;
	}
}

void TextBehaviour_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_fa3db2c10b380caf_23_validateData)
HXLINE(  24)		 ::haxe::ui::components::Label label = this->_component->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::Label >(),false,null()).StaticCast<  ::haxe::ui::components::Label >();
HXLINE(  25)		label->set_text(::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->_value));
            	}
