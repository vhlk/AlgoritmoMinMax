...
bool PageIndex_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x3c5dd90d) {
		if (inClassId<=(int)0x2a3d6dce) {
			return inClassId==(int)0x00000001 || inClassId==(int)0x2a3d6dce;
		} else {
...
void PageIndex_obj::set( ::haxe::ui::util::VariantType value){
            	HX_STACKFRAME(&_hx_pos_d2118e31d677372b_27_set)
HXLINE(  28)		if (::haxe::ui::util::_Variant::Variant_Impl__obj::eq(value,this->_value)) {
HXLINE(  29)			return;
            		}
HXLINE(  32)		this->_value = value;
HXLINE(  34)		 ::haxe::ui::util::VariantType _hx_tmp = this->_value;
HXDLIN(  34)		if (::haxe::ui::util::_Variant::Variant_Impl__obj::eq(_hx_tmp,::haxe::ui::util::_Variant::Variant_Impl__obj::fromInt(-1))) {
HXLINE(  35)			return;
            		}
...
HXDLIN(  45)				_g = (_g + 1);
HXLINE(  46)				if (::hx::IsInstanceNotEq( b,button )) {
