...
HX_DEFINE_STACK_FRAME(_hx_pos_d0c3bbccbc13d3d6_275_new,"haxe.ui.containers._ScrollView.HScrollMax","new",0x0bbcc3a8,"haxe.ui.containers._ScrollView.HScrollMax.new","haxe/ui/containers/ScrollView.hx",275,0x01b76681)
HX_LOCAL_STACK_FRAME(_hx_pos_d0c3bbccbc13d3d6_280_get,"haxe.ui.containers._ScrollView.HScrollMax","get",0x0bb773de,"haxe.ui.containers._ScrollView.HScrollMax.get","haxe/ui/containers/ScrollView.hx",280,0x01b76681)
HX_LOCAL_STACK_FRAME(_hx_pos_d0c3bbccbc13d3d6_289_validateData,"haxe.ui.containers._ScrollView.HScrollMax","validateData",0xa2b5b998,"haxe.ui.containers._ScrollView.HScrollMax.validateData","haxe/ui/containers/ScrollView.hx",289,0x01b76681)
namespace haxe{
namespace ui{
...
void HScrollMax_obj::__construct( ::haxe::ui::containers::ScrollView scrollview){
            	HX_STACKFRAME(&_hx_pos_d0c3bbccbc13d3d6_275_new)
HXLINE( 276)		super::__construct(scrollview);
HXLINE( 277)		this->_scrollview = scrollview;
            	}
...
bool HScrollMax_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType HScrollMax_obj::get(){
            	HX_STACKFRAME(&_hx_pos_d0c3bbccbc13d3d6_280_get)
HXLINE( 281)		 ::haxe::ui::components::HorizontalScroll hscroll = this->_scrollview->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::HorizontalScroll >(),false,null()).StaticCast<  ::haxe::ui::components::HorizontalScroll >();
HXLINE( 282)		if (::hx::IsNull( hscroll )) {
HXLINE( 283)			return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromInt(0);
            		}
HXLINE( 285)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromFloat(hscroll->get_max());
            	}


void HScrollMax_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_d0c3bbccbc13d3d6_289_validateData)
HXDLIN( 289)		if ((this->_scrollview->get_virtual() == true)) {
HXLINE( 290)			 ::haxe::ui::components::HorizontalScroll hscroll = this->_scrollview->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::HorizontalScroll >(),false,null()).StaticCast<  ::haxe::ui::components::HorizontalScroll >();
HXLINE( 291)			 ::haxe::ui::util::VariantType _hx_tmp = this->_value;
HXDLIN( 291)			if (::haxe::ui::util::_Variant::Variant_Impl__obj::gt(_hx_tmp,::haxe::ui::util::_Variant::Variant_Impl__obj::fromInt(0))) {
HXLINE( 292)				if (::hx::IsNull( hscroll )) {
HXLINE( 293)					hscroll = ::hx::TCast<  ::haxe::ui::containers::ScrollViewBuilder >::cast(this->_scrollview->_compositeBuilder)->createHScroll();
            				}
            			}
            			else {
HXLINE( 296)				if (::hx::IsNotNull( hscroll )) {
HXLINE( 297)					::hx::TCast<  ::haxe::ui::containers::ScrollViewBuilder >::cast(this->_scrollview->_compositeBuilder)->destroyHScroll();
            				}
            			}
HXLINE( 300)			if (::hx::IsNotNull( hscroll )) {
HXLINE( 301)				hscroll->set_max(( (Float)(::haxe::ui::util::_Variant::Variant_Impl__obj::toFloat(this->_value)) ));
            			}
            		}
            	}
