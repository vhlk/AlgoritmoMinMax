...
HX_DEFINE_STACK_FRAME(_hx_pos_9396c9900217aa41_30_new,"haxe.ui.containers._Frame.IconBehaviour","new",0x36d44940,"haxe.ui.containers._Frame.IconBehaviour.new","haxe/ui/containers/Frame.hx",30,0x566bdf3c)
HX_LOCAL_STACK_FRAME(_hx_pos_9396c9900217aa41_31_validateData,"haxe.ui.containers._Frame.IconBehaviour","validateData",0xb93cc100,"haxe.ui.containers._Frame.IconBehaviour.validateData","haxe/ui/containers/Frame.hx",31,0x566bdf3c)
namespace haxe{
namespace ui{
...
void IconBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_9396c9900217aa41_30_new)
...
bool IconBehaviour_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x3c5dd90d) {
		...
		return inClassId==(int)0x5f9d6f0a || inClassId==(int)0x7e17fa9f;
	}
}

void IconBehaviour_obj::validateData(){
            	HX_GC_STACKFRAME(&_hx_pos_9396c9900217aa41_31_validateData)
HXLINE(  32)		 ::haxe::ui::components::Image icon = this->_component->findComponent(HX_("frame-icon",d9,c6,b3,7e),null(),false,null()).StaticCast<  ::haxe::ui::components::Image >();
HXLINE(  33)		if (::hx::IsNull( icon )) {
HXLINE(  34)			icon =  ::haxe::ui::components::Image_obj::__alloc( HX_CTX );
HXLINE(  35)			icon->addClass(HX_("frame-icon",d9,c6,b3,7e),null(),null());
HXLINE(  36)			icon->set_id(HX_("frame-icon",d9,c6,b3,7e));
HXLINE(  37)			icon->scriptAccess = false;
HXLINE(  38)			icon->set_includeInLayout(false);
HXLINE(  39)			this->_component->addComponent(icon);
            		}
HXLINE(  42)		icon->set_resource(this->_value);
            	}
...
::hx::ObjectPtr< IconBehaviour_obj > IconBehaviour_obj::__alloc(::hx::Ctx *_hx_ctx, ::haxe::ui::core::Component component) {
	IconBehaviour_obj *__this = (IconBehaviour_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(IconBehaviour_obj), true, "haxe.ui.containers._Frame.IconBehaviour"));
...
void IconBehaviour_obj::__register()
{
	...
	__mClass->mName = HX_("haxe.ui.containers._Frame.IconBehaviour",4e,e9,ae,e2);
