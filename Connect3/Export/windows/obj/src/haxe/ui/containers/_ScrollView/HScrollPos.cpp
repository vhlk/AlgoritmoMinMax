...
HX_DEFINE_STACK_FRAME(_hx_pos_73e3f42abe9d2281_207_new,"haxe.ui.containers._ScrollView.HScrollPos","new",0x407b4e98,"haxe.ui.containers._ScrollView.HScrollPos.new","haxe/ui/containers/ScrollView.hx",207,0x01b76681)
HX_LOCAL_STACK_FRAME(_hx_pos_73e3f42abe9d2281_212_get,"haxe.ui.containers._ScrollView.HScrollPos","get",0x4075fece,"haxe.ui.containers._ScrollView.HScrollPos.get","haxe/ui/containers/ScrollView.hx",212,0x01b76681)
HX_LOCAL_STACK_FRAME(_hx_pos_73e3f42abe9d2281_220_validateData,"haxe.ui.containers._ScrollView.HScrollPos","validateData",0x50a650a8,"haxe.ui.containers._ScrollView.HScrollPos.validateData","haxe/ui/containers/ScrollView.hx",220,0x01b76681)
namespace haxe{
namespace ui{
...
void HScrollPos_obj::__construct( ::haxe::ui::containers::ScrollView scrollview){
            	HX_STACKFRAME(&_hx_pos_73e3f42abe9d2281_207_new)
HXLINE( 208)		super::__construct(scrollview);
HXLINE( 209)		this->_scrollview = scrollview;
            	}
...
bool HScrollPos_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType HScrollPos_obj::get(){
            	HX_STACKFRAME(&_hx_pos_73e3f42abe9d2281_212_get)
HXLINE( 213)		 ::haxe::ui::components::HorizontalScroll hscroll = this->_scrollview->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::HorizontalScroll >(),false,null()).StaticCast<  ::haxe::ui::components::HorizontalScroll >();
HXLINE( 214)		if (::hx::IsNull( hscroll )) {
HXLINE( 215)			return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromInt(0);
            		}
HXLINE( 217)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromFloat(hscroll->get_pos());
            	}


void HScrollPos_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_73e3f42abe9d2281_220_validateData)
HXLINE( 221)		 ::haxe::ui::components::HorizontalScroll hscroll = this->_scrollview->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::HorizontalScroll >(),false,null()).StaticCast<  ::haxe::ui::components::HorizontalScroll >();
HXLINE( 222)		if ((this->_scrollview->get_virtual() == true)) {
HXLINE( 223)			if (::hx::IsNull( hscroll )) {
HXLINE( 224)				hscroll = ::hx::TCast<  ::haxe::ui::containers::ScrollViewBuilder >::cast(this->_scrollview->_compositeBuilder)->createHScroll();
            			}
HXLINE( 226)			if (::hx::IsNotNull( hscroll )) {
HXLINE( 227)				hscroll->set_pos(( (Float)(::haxe::ui::util::_Variant::Variant_Impl__obj::toFloat(this->_value)) ));
            			}
            		}
            		else {
HXLINE( 230)			if (::hx::IsNotNull( hscroll )) {
HXLINE( 231)				hscroll->set_pos(( (Float)(::haxe::ui::util::_Variant::Variant_Impl__obj::toFloat(this->_value)) ));
            			}
            		}
            	}
