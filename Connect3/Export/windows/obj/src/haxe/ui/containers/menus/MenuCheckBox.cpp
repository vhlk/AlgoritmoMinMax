...
HX_LOCAL_STACK_FRAME(_hx_pos_a6e932314636ed38_369_registerBehaviours,"haxe.ui.containers.menus.MenuCheckBox","registerBehaviours",0xcde8a901,"haxe.ui.containers.menus.MenuCheckBox.registerBehaviours","haxe/ui/macros/Macros.hx",369,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_a6e932314636ed38_388_get_selected,"haxe.ui.containers.menus.MenuCheckBox","get_selected",0xe785118c,"haxe.ui.containers.menus.MenuCheckBox.get_selected","haxe/ui/macros/Macros.hx",388,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_a6e932314636ed38_431_set_selected,"haxe.ui.containers.menus.MenuCheckBox","set_selected",0xfc7e3500,"haxe.ui.containers.menus.MenuCheckBox.set_selected","haxe/ui/macros/Macros.hx",431,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_1d8ec6e8aaee03f7_525_cloneComponent,"haxe.ui.containers.menus.MenuCheckBox","cloneComponent",0x89a636c8,"haxe.ui.containers.menus.MenuCheckBox.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",525,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_a6e932314636ed38_351_self,"haxe.ui.containers.menus.MenuCheckBox","self",0x975356b4,"haxe.ui.containers.menus.MenuCheckBox.self","haxe/ui/macros/Macros.hx",351,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_a6e932314636ed38_71_registerComposite,"haxe.ui.containers.menus.MenuCheckBox","registerComposite",0x566f40fc,"haxe.ui.containers.menus.MenuCheckBox.registerComposite","haxe/ui/macros/Macros.hx",71,0x27866361)
namespace haxe{
namespace ui{
		...
		if (inClassId<=(int)0x4af7dd8e) {
			if (inClassId<=(int)0x2ccba775) {
				if (inClassId<=(int)0x264587e2) {
					return inClassId==(int)0x2570d72f || inClassId==(int)0x264587e2;
				} else {
					return inClassId==(int)0x2ccba775;
				}
			} else {
				return inClassId==(int)0x48332f1a || inClassId==(int)0x4af7dd8e;
			}
		} else {
...
void MenuCheckBox_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_a6e932314636ed38_369_registerBehaviours)
HXLINE( 370)		this->super::registerBehaviours();
HXLINE( 447)		this->behaviours->_hx_register(HX_("text",ad,cc,f9,4c),::hx::ClassOf< ::haxe::ui::containers::menus::_MenuCheckBox::TextBehaviour >(),null());
HXDLIN( 447)		this->behaviours->_hx_register(HX_("shortcutText",53,aa,dc,fc),::hx::ClassOf< ::haxe::ui::containers::menus::_MenuCheckBox::ShortcutTextBehaviour >(),null());
HXDLIN( 447)		this->behaviours->_hx_register(HX_("selected",5b,2a,6d,b1),::hx::ClassOf< ::haxe::ui::containers::menus::_MenuCheckBox::SelectedBehaviour >(),null());
            	}


bool MenuCheckBox_obj::get_selected(){
            	HX_STACKFRAME(&_hx_pos_a6e932314636ed38_388_get_selected)
...
bool MenuCheckBox_obj::set_selected(bool value){
            	HX_GC_STACKFRAME(&_hx_pos_a6e932314636ed38_431_set_selected)
...
HX_DEFINE_DYNAMIC_FUNC1(MenuCheckBox_obj,set_selected,return )
 ...
 ::haxe::ui::core::ComponentContainer MenuCheckBox_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_1d8ec6e8aaee03f7_525_cloneComponent)
HXLINE( 300)		 ::haxe::ui::containers::menus::MenuCheckBox c = ( ( ::haxe::ui::containers::menus::MenuCheckBox)(this->super::cloneComponent()) );
...
HXLINE( 323)		return c;
 ...
 ::haxe::ui::core::ComponentContainer MenuCheckBox_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_a6e932314636ed38_351_self)
HXDLIN( 351)		return  ::haxe::ui::containers::menus::MenuCheckBox_obj::__alloc( HX_CTX );
            	}


void MenuCheckBox_obj::registerComposite(){
            	HX_STACKFRAME(&_hx_pos_a6e932314636ed38_71_registerComposite)
HXLINE(  72)		this->super::registerComposite();
HXLINE(  84)		this->_compositeBuilderClass = ::hx::ClassOf< ::haxe::ui::containers::menus::_MenuCheckBox::Builder >();
            	}
