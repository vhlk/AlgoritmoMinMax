...
HX_LOCAL_STACK_FRAME(_hx_pos_727c6a269ad012d7_370_registerBehaviours,"haxe.ui.containers.menus.MenuSeparator","registerBehaviours",0x524fbde5,"haxe.ui.containers.menus.MenuSeparator.registerBehaviours","haxe/ui/macros/Macros.hx",370,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_cb6c1c7beafba6f2_525_cloneComponent,"haxe.ui.containers.menus.MenuSeparator","cloneComponent",0x506009ac,"haxe.ui.containers.menus.MenuSeparator.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",525,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_727c6a269ad012d7_351_self,"haxe.ui.containers.menus.MenuSeparator","self",0xf0836498,"haxe.ui.containers.menus.MenuSeparator.self","haxe/ui/macros/Macros.hx",351,0x27866361)
namespace haxe{
namespace ui{
	...
	if (inClassId<=(int)0x1f4df417) {
		if (inClassId<=(int)0x0eeb3cfe) {
			if (inClassId<=(int)0x0330636f) {
				...
				return inClassId==(int)0x0c89e854 || inClassId==(int)0x0eeb3cfe;
			}
		} else {
...
void MenuSeparator_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_727c6a269ad012d7_370_registerBehaviours)
HXDLIN( 370)		this->super::registerBehaviours();
            	}


 ::haxe::ui::core::ComponentContainer MenuSeparator_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_cb6c1c7beafba6f2_525_cloneComponent)
HXLINE( 300)		 ::haxe::ui::containers::menus::MenuSeparator c = ( ( ::haxe::ui::containers::menus::MenuSeparator)(this->super::cloneComponent()) );
...
HXLINE( 323)		return c;
 ...
 ::haxe::ui::core::ComponentContainer MenuSeparator_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_727c6a269ad012d7_351_self)
HXDLIN( 351)		return  ::haxe::ui::containers::menus::MenuSeparator_obj::__alloc( HX_CTX );
            	}
