...
HX_DEFINE_STACK_FRAME(_hx_pos_de5d2e087c099afc_33_new,"haxe.ui.containers.properties._Property.LabelBehaviour","new",0x6ded0a26,"haxe.ui.containers.properties._Property.LabelBehaviour.new","haxe/ui/containers/properties/Property.hx",33,0xa93e75b8)
HX_LOCAL_STACK_FRAME(_hx_pos_de5d2e087c099afc_38_set,"haxe.ui.containers.properties._Property.LabelBehaviour","set",0x6df0d568,"haxe.ui.containers.properties._Property.LabelBehaviour.set","haxe/ui/containers/properties/Property.hx",38,0xa93e75b8)
namespace haxe{
namespace ui{
...
void LabelBehaviour_obj::__construct( ::haxe::ui::containers::properties::Property property){
            	HX_STACKFRAME(&_hx_pos_de5d2e087c099afc_33_new)
HXLINE(  34)		super::__construct(property);
HXLINE(  35)		this->_property = property;
            	}
...
void LabelBehaviour_obj::set( ::haxe::ui::util::VariantType value){
            	HX_STACKFRAME(&_hx_pos_de5d2e087c099afc_38_set)
HXLINE(  39)		this->super::set(value);
HXLINE(  40)		 ::haxe::ui::containers::properties::PropertyBuilder builder = ::hx::TCast<  ::haxe::ui::containers::properties::PropertyBuilder >::cast(this->_property->_compositeBuilder);
HXLINE(  41)		if (::hx::IsNotNull( builder->label )) {
HXLINE(  42)			 ::haxe::ui::components::Label builder1 = builder->label;
HXDLIN(  42)			builder1->set_text(::haxe::ui::util::_Variant::Variant_Impl__obj::toString(value));
            		}
            	}
