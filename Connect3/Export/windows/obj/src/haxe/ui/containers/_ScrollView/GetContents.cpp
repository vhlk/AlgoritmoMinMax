...
HX_DEFINE_STACK_FRAME(_hx_pos_75f5886cb5c6eb01_399_new,"haxe.ui.containers._ScrollView.GetContents","new",0x6ca986bb,"haxe.ui.containers._ScrollView.GetContents.new","haxe/ui/containers/ScrollView.hx",399,0x01b76681)
HX_LOCAL_STACK_FRAME(_hx_pos_75f5886cb5c6eb01_400_get,"haxe.ui.containers._ScrollView.GetContents","get",0x6ca436f1,"haxe.ui.containers._ScrollView.GetContents.get","haxe/ui/containers/ScrollView.hx",400,0x01b76681)
namespace haxe{
namespace ui{
...
void GetContents_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_75f5886cb5c6eb01_399_new)
HXDLIN( 399)		super::__construct(component);
            	}
...
bool GetContents_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType GetContents_obj::get(){
            	HX_STACKFRAME(&_hx_pos_75f5886cb5c6eb01_400_get)
HXLINE( 401)		 ::haxe::ui::core::Component contents = this->_component->findComponent(HX_("scrollview-contents",15,b7,70,a7),null(),false,HX_("css",c3,83,4b,00)).StaticCast<  ::haxe::ui::core::Component >();
HXLINE( 402)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromComponent(contents);
            	}
