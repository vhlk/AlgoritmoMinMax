...
HXDLIN(   7)		SAVE = HX_("{{dialog.save}}",23,cd,9b,5e);
            	}
{
            	HX_STACKFRAME(&_hx_pos_aeb53a084dcdf837_8_boot)
HXDLIN(   8)		_hx_YES = HX_("{{dialog.yes}}",c1,2d,d7,4b);
            	}
{
            	HX_STACKFRAME(&_hx_pos_aeb53a084dcdf837_9_boot)
HXDLIN(   9)		_hx_NO = HX_("{{dialog.no}}",a7,6d,ad,5a);
            	}
{
            	HX_STACKFRAME(&_hx_pos_aeb53a084dcdf837_10_boot)
HXDLIN(  10)		CLOSE = HX_("{{dialog.close}}",12,f5,ad,37);
            	}
{
            	HX_STACKFRAME(&_hx_pos_aeb53a084dcdf837_11_boot)
HXDLIN(  11)		OK = HX_("{{dialog.ok}}",42,9b,53,5b);
            	}
{
            	HX_STACKFRAME(&_hx_pos_aeb53a084dcdf837_12_boot)
HXDLIN(  12)		CANCEL = HX_("{{dialog.cancel}}",20,d6,4a,1a);
            	}
{
            	HX_STACKFRAME(&_hx_pos_aeb53a084dcdf837_13_boot)
HXDLIN(  13)		APPLY = HX_("{{dialog.apply}}",48,bc,c5,0c);
            	}
}
