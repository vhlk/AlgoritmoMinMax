...
HX_LOCAL_STACK_FRAME(_hx_pos_cb2c8d9afeed5cd2_370_registerBehaviours,"haxe.ui.containers.VBox","registerBehaviours",0xd32d3888,"haxe.ui.containers.VBox.registerBehaviours","haxe/ui/macros/Macros.hx",370,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_a736ef818f07bee5_525_cloneComponent,"haxe.ui.containers.VBox","cloneComponent",0xe9dcb6cf,"haxe.ui.containers.VBox.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",525,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_cb2c8d9afeed5cd2_351_self,"haxe.ui.containers.VBox","self",0x4e0ed7fb,"haxe.ui.containers.VBox.self","haxe/ui/macros/Macros.hx",351,0x27866361)
namespace haxe{
namespace ui{
...
void VBox_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_cb2c8d9afeed5cd2_370_registerBehaviours)
HXDLIN( 370)		this->super::registerBehaviours();
            	}


 ::haxe::ui::core::ComponentContainer VBox_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_a736ef818f07bee5_525_cloneComponent)
HXLINE( 300)		 ::haxe::ui::containers::VBox c = ( ( ::haxe::ui::containers::VBox)(this->super::cloneComponent()) );
...
HXLINE( 323)		return c;
 ...
 ::haxe::ui::core::ComponentContainer VBox_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_cb2c8d9afeed5cd2_351_self)
HXDLIN( 351)		return  ::haxe::ui::containers::VBox_obj::__alloc( HX_CTX );
            	}
