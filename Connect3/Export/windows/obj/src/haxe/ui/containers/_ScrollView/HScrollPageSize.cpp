...
HX_DEFINE_STACK_FRAME(_hx_pos_b4b8756cce4b494c_349_new,"haxe.ui.containers._ScrollView.HScrollPageSize","new",0x1788fc50,"haxe.ui.containers._ScrollView.HScrollPageSize.new","haxe/ui/containers/ScrollView.hx",349,0x01b76681)
HX_LOCAL_STACK_FRAME(_hx_pos_b4b8756cce4b494c_355_validateData,"haxe.ui.containers._ScrollView.HScrollPageSize","validateData",0x38812bf0,"haxe.ui.containers._ScrollView.HScrollPageSize.validateData","haxe/ui/containers/ScrollView.hx",355,0x01b76681)
namespace haxe{
namespace ui{
...
void HScrollPageSize_obj::__construct( ::haxe::ui::containers::ScrollView scrollview){
            	HX_STACKFRAME(&_hx_pos_b4b8756cce4b494c_349_new)
HXLINE( 350)		super::__construct(scrollview);
HXLINE( 351)		this->_scrollview = scrollview;
            	}
...
void HScrollPageSize_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_b4b8756cce4b494c_355_validateData)
HXDLIN( 355)		if ((this->_scrollview->get_virtual() == true)) {
HXLINE( 356)			 ::haxe::ui::components::HorizontalScroll hscroll = this->_scrollview->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::HorizontalScroll >(),false,null()).StaticCast<  ::haxe::ui::components::HorizontalScroll >();
HXLINE( 357)			if (::hx::IsNull( hscroll )) {
HXLINE( 358)				hscroll = ::hx::TCast<  ::haxe::ui::containers::ScrollViewBuilder >::cast(this->_scrollview->_compositeBuilder)->createHScroll();
            			}
HXLINE( 360)			if (::hx::IsNotNull( hscroll )) {
HXLINE( 361)				hscroll->set_pageSize(( (Float)(::haxe::ui::util::_Variant::Variant_Impl__obj::toFloat(this->_value)) ));
            			}
            		}
            	}
