...
HX_DEFINE_STACK_FRAME(_hx_pos_8bf9af5c2eb65ae0_185_new,"haxe.ui.containers._ScrollView.PercentContentHeight","new",0x2e148554,"haxe.ui.containers._ScrollView.PercentContentHeight.new","haxe/ui/containers/ScrollView.hx",185,0x01b76681)
HX_LOCAL_STACK_FRAME(_hx_pos_8bf9af5c2eb65ae0_186_get,"haxe.ui.containers._ScrollView.PercentContentHeight","get",0x2e0f358a,"haxe.ui.containers._ScrollView.PercentContentHeight.get","haxe/ui/containers/ScrollView.hx",186,0x01b76681)
HX_LOCAL_STACK_FRAME(_hx_pos_8bf9af5c2eb65ae0_194_set,"haxe.ui.containers._ScrollView.PercentContentHeight","set",0x2e185096,"haxe.ui.containers._ScrollView.PercentContentHeight.set","haxe/ui/containers/ScrollView.hx",194,0x01b76681)
namespace haxe{
namespace ui{
...
void PercentContentHeight_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_8bf9af5c2eb65ae0_185_new)
...
bool PercentContentHeight_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType PercentContentHeight_obj::get(){
            	HX_STACKFRAME(&_hx_pos_8bf9af5c2eb65ae0_186_get)
HXLINE( 187)		 ::haxe::ui::core::Component contents = this->_component->findComponent(HX_("scrollview-contents",15,b7,70,a7),null(),false,HX_("css",c3,83,4b,00)).StaticCast<  ::haxe::ui::core::Component >();
HXLINE( 188)		if (::hx::IsNull( contents )) {
HXLINE( 189)			return null();
            		}
HXLINE( 191)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromFloat(( (Float)(contents->get_percentHeight()) ));
            	}


void PercentContentHeight_obj::set( ::haxe::ui::util::VariantType value){
            	HX_STACKFRAME(&_hx_pos_8bf9af5c2eb65ae0_194_set)
HXLINE( 195)		 ::haxe::ui::core::Component contents = this->_component->findComponent(HX_("scrollview-contents",15,b7,70,a7),null(),false,HX_("css",c3,83,4b,00)).StaticCast<  ::haxe::ui::core::Component >();
HXLINE( 196)		if (::hx::IsNotNull( contents )) {
HXLINE( 197)			contents->set_percentHeight(::haxe::ui::util::_Variant::Variant_Impl__obj::toFloat(value));
            		}
            	}
