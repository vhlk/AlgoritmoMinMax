...
HX_DEFINE_STACK_FRAME(_hx_pos_b6c79a0940e4ed1a_23_new,"haxe.ui.containers.menus._MenuItem.TextBehaviour","new",0xaa55e001,"haxe.ui.containers.menus._MenuItem.TextBehaviour.new","haxe/ui/containers/menus/MenuItem.hx",23,0x19b927e6)
HX_LOCAL_STACK_FRAME(_hx_pos_b6c79a0940e4ed1a_24_validateData,"haxe.ui.containers.menus._MenuItem.TextBehaviour","validateData",0xe7fcca1f,"haxe.ui.containers.menus._MenuItem.TextBehaviour.validateData","haxe/ui/containers/menus/MenuItem.hx",24,0x19b927e6)
namespace haxe{
namespace ui{
...
void TextBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_b6c79a0940e4ed1a_23_new)
...
void TextBehaviour_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_b6c79a0940e4ed1a_24_validateData)
HXLINE(  25)		 ::haxe::ui::components::Label label = this->_component->findComponent(HX_("menuitem-label",59,c2,dd,b5),null(),true,null()).StaticCast<  ::haxe::ui::components::Label >();
HXLINE(  26)		label->set_text(::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->_value));
            	}
