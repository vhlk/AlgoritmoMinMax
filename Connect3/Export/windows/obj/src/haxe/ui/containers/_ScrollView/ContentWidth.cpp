...
HX_DEFINE_STACK_FRAME(_hx_pos_82f5e257b580f199_131_new,"haxe.ui.containers._ScrollView.ContentWidth","new",0xf5d87966,"haxe.ui.containers._ScrollView.ContentWidth.new","haxe/ui/containers/ScrollView.hx",131,0x01b76681)
HX_LOCAL_STACK_FRAME(_hx_pos_82f5e257b580f199_132_get,"haxe.ui.containers._ScrollView.ContentWidth","get",0xf5d3299c,"haxe.ui.containers._ScrollView.ContentWidth.get","haxe/ui/containers/ScrollView.hx",132,0x01b76681)
HX_LOCAL_STACK_FRAME(_hx_pos_82f5e257b580f199_140_set,"haxe.ui.containers._ScrollView.ContentWidth","set",0xf5dc44a8,"haxe.ui.containers._ScrollView.ContentWidth.set","haxe/ui/containers/ScrollView.hx",140,0x01b76681)
namespace haxe{
namespace ui{
...
void ContentWidth_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_82f5e257b580f199_131_new)
HXDLIN( 131)		super::__construct(component);
            	}
...
bool ContentWidth_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType ContentWidth_obj::get(){
            	HX_STACKFRAME(&_hx_pos_82f5e257b580f199_132_get)
HXLINE( 133)		 ::haxe::ui::core::Component contents = this->_component->findComponent(HX_("scrollview-contents",15,b7,70,a7),null(),false,HX_("css",c3,83,4b,00)).StaticCast<  ::haxe::ui::core::Component >();
HXLINE( 134)		if (::hx::IsNull( contents )) {
HXLINE( 135)			return null();
            		}
HXLINE( 137)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromFloat(contents->get_width());
            	}


void ContentWidth_obj::set( ::haxe::ui::util::VariantType value){
            	HX_STACKFRAME(&_hx_pos_82f5e257b580f199_140_set)
HXLINE( 141)		 ::haxe::ui::core::Component contents = this->_component->findComponent(HX_("scrollview-contents",15,b7,70,a7),null(),false,HX_("css",c3,83,4b,00)).StaticCast<  ::haxe::ui::core::Component >();
HXLINE( 142)		if (::hx::IsNotNull( contents )) {
HXLINE( 143)			contents->set_width(( (Float)(::haxe::ui::util::_Variant::Variant_Impl__obj::toFloat(value)) ));
            		}
            	}
