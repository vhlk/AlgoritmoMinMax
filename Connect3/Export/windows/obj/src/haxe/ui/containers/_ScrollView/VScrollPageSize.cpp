...
HX_DEFINE_STACK_FRAME(_hx_pos_fbfc4bbecb5d9ddc_372_new,"haxe.ui.containers._ScrollView.VScrollPageSize","new",0x5e4017de,"haxe.ui.containers._ScrollView.VScrollPageSize.new","haxe/ui/containers/ScrollView.hx",372,0x01b76681)
HX_LOCAL_STACK_FRAME(_hx_pos_fbfc4bbecb5d9ddc_378_validateData,"haxe.ui.containers._ScrollView.VScrollPageSize","validateData",0x66dd2ea2,"haxe.ui.containers._ScrollView.VScrollPageSize.validateData","haxe/ui/containers/ScrollView.hx",378,0x01b76681)
namespace haxe{
namespace ui{
...
void VScrollPageSize_obj::__construct( ::haxe::ui::containers::ScrollView scrollview){
            	HX_STACKFRAME(&_hx_pos_fbfc4bbecb5d9ddc_372_new)
...
void VScrollPageSize_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_fbfc4bbecb5d9ddc_378_validateData)
HXDLIN( 378)		if ((this->_scrollview->get_virtual() == true)) {
HXLINE( 379)			 ::haxe::ui::components::VerticalScroll vscroll = this->_scrollview->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::VerticalScroll >(),false,null()).StaticCast<  ::haxe::ui::components::VerticalScroll >();
HXLINE( 380)			if (::hx::IsNull( vscroll )) {
HXLINE( 381)				vscroll = ::hx::TCast<  ::haxe::ui::containers::ScrollViewBuilder >::cast(this->_scrollview->_compositeBuilder)->createVScroll();
            			}
HXLINE( 383)			if (::hx::IsNotNull( vscroll )) {
HXLINE( 384)				vscroll->set_pageSize(( (Float)(::haxe::ui::util::_Variant::Variant_Impl__obj::toFloat(this->_value)) ));
            			}
            		}
            	}
