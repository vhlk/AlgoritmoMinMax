...
HX_DEFINE_STACK_FRAME(_hx_pos_f301618448c2b1d3_167_new,"haxe.ui.containers._ScrollView.ContentHeight","new",0xbc9a012b,"haxe.ui.containers._ScrollView.ContentHeight.new","haxe/ui/containers/ScrollView.hx",167,0x01b76681)
HX_LOCAL_STACK_FRAME(_hx_pos_f301618448c2b1d3_168_get,"haxe.ui.containers._ScrollView.ContentHeight","get",0xbc94b161,"haxe.ui.containers._ScrollView.ContentHeight.get","haxe/ui/containers/ScrollView.hx",168,0x01b76681)
HX_LOCAL_STACK_FRAME(_hx_pos_f301618448c2b1d3_176_set,"haxe.ui.containers._ScrollView.ContentHeight","set",0xbc9dcc6d,"haxe.ui.containers._ScrollView.ContentHeight.set","haxe/ui/containers/ScrollView.hx",176,0x01b76681)
namespace haxe{
namespace ui{
...
void ContentHeight_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_f301618448c2b1d3_167_new)
...
bool ContentHeight_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType ContentHeight_obj::get(){
            	HX_STACKFRAME(&_hx_pos_f301618448c2b1d3_168_get)
HXLINE( 169)		 ::haxe::ui::core::Component contents = this->_component->findComponent(HX_("scrollview-contents",15,b7,70,a7),null(),false,HX_("css",c3,83,4b,00)).StaticCast<  ::haxe::ui::core::Component >();
HXLINE( 170)		if (::hx::IsNull( contents )) {
HXLINE( 171)			return null();
            		}
HXLINE( 173)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromFloat(contents->get_height());
            	}


void ContentHeight_obj::set( ::haxe::ui::util::VariantType value){
            	HX_STACKFRAME(&_hx_pos_f301618448c2b1d3_176_set)
HXLINE( 177)		 ::haxe::ui::core::Component contents = this->_component->findComponent(HX_("scrollview-contents",15,b7,70,a7),null(),false,HX_("css",c3,83,4b,00)).StaticCast<  ::haxe::ui::core::Component >();
HXLINE( 178)		if (::hx::IsNotNull( contents )) {
HXLINE( 179)			contents->set_height(( (Float)(::haxe::ui::util::_Variant::Variant_Impl__obj::toFloat(value)) ));
            		}
            	}
