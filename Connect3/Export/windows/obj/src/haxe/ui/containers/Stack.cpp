...
HX_LOCAL_STACK_FRAME(_hx_pos_66298a074e155217_370_registerBehaviours,"haxe.ui.containers.Stack","registerBehaviours",0x06b2a969,"haxe.ui.containers.Stack.registerBehaviours","haxe/ui/macros/Macros.hx",370,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_98007478d8f70c6e_525_cloneComponent,"haxe.ui.containers.Stack","cloneComponent",0xbd7de330,"haxe.ui.containers.Stack.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",525,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_66298a074e155217_351_self,"haxe.ui.containers.Stack","self",0x198af11c,"haxe.ui.containers.Stack.self","haxe/ui/macros/Macros.hx",351,0x27866361)
namespace haxe{
namespace ui{
	...
	if (inClassId<=(int)0x1f4df417) {
		if (inClassId<=(int)0x0f2dd418) {
			...
			if (inClassId<=(int)0x13d76ae7) {
				if (inClassId<=(int)0x13b5cd1c) {
					return inClassId==(int)0x1395e371 || inClassId==(int)0x13b5cd1c;
				} else {
...
void Stack_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_66298a074e155217_370_registerBehaviours)
HXDLIN( 370)		this->super::registerBehaviours();
            	}


 ::haxe::ui::core::ComponentContainer Stack_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_98007478d8f70c6e_525_cloneComponent)
HXLINE( 300)		 ::haxe::ui::containers::Stack c = ( ( ::haxe::ui::containers::Stack)(this->super::cloneComponent()) );
...
HXLINE( 323)		return c;
 ...
 ::haxe::ui::core::ComponentContainer Stack_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_66298a074e155217_351_self)
HXDLIN( 351)		return  ::haxe::ui::containers::Stack_obj::__alloc( HX_CTX );
            	}
