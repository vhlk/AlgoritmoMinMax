...
HX_DEFINE_STACK_FRAME(_hx_pos_795983c9646d67c0_119_new,"haxe.ui.containers._ScrollView.ContentLayoutName","new",0x12e66359,"haxe.ui.containers._ScrollView.ContentLayoutName.new","haxe/ui/containers/ScrollView.hx",119,0x01b76681)
HX_LOCAL_STACK_FRAME(_hx_pos_795983c9646d67c0_120_set,"haxe.ui.containers._ScrollView.ContentLayoutName","set",0x12ea2e9b,"haxe.ui.containers._ScrollView.ContentLayoutName.set","haxe/ui/containers/ScrollView.hx",120,0x01b76681)
namespace haxe{
namespace ui{
...
void ContentLayoutName_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_795983c9646d67c0_119_new)
...
void ContentLayoutName_obj::set( ::haxe::ui::util::VariantType value){
            	HX_STACKFRAME(&_hx_pos_795983c9646d67c0_120_set)
HXLINE( 121)		this->super::set(value);
HXLINE( 122)		 ::haxe::ui::containers::ScrollViewBuilder builder = ::hx::TCast<  ::haxe::ui::containers::ScrollViewBuilder >::cast(this->_component->_compositeBuilder);
HXLINE( 123)		bool _hx_tmp;
HXDLIN( 123)		if (::hx::IsNotNull( builder )) {
HXLINE( 123)			_hx_tmp = ::hx::IsPointerNotEq( ::haxe::ui::util::_Variant::Variant_Impl__obj::fromString(builder->_contentsLayoutName),value );
            		}
            		else {
HXLINE( 123)			_hx_tmp = false;
            		}
HXDLIN( 123)		if (_hx_tmp) {
HXLINE( 124)			builder->_contentsLayoutName = ::haxe::ui::util::_Variant::Variant_Impl__obj::toString(value);
HXLINE( 125)			 ::haxe::ui::containers::Box builder1 = builder->_contents;
HXDLIN( 125)			builder1->set_layout(::haxe::ui::layouts::LayoutFactory_obj::createFromName(::haxe::ui::util::_Variant::Variant_Impl__obj::toString(value)));
            		}
            	}
