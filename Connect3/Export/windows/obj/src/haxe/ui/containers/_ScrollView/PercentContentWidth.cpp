...
HX_DEFINE_STACK_FRAME(_hx_pos_3da7db3a1a1ff50f_149_new,"haxe.ui.containers._ScrollView.PercentContentWidth","new",0xdbf36d5d,"haxe.ui.containers._ScrollView.PercentContentWidth.new","haxe/ui/containers/ScrollView.hx",149,0x01b76681)
HX_LOCAL_STACK_FRAME(_hx_pos_3da7db3a1a1ff50f_150_get,"haxe.ui.containers._ScrollView.PercentContentWidth","get",0xdbee1d93,"haxe.ui.containers._ScrollView.PercentContentWidth.get","haxe/ui/containers/ScrollView.hx",150,0x01b76681)
HX_LOCAL_STACK_FRAME(_hx_pos_3da7db3a1a1ff50f_158_set,"haxe.ui.containers._ScrollView.PercentContentWidth","set",0xdbf7389f,"haxe.ui.containers._ScrollView.PercentContentWidth.set","haxe/ui/containers/ScrollView.hx",158,0x01b76681)
namespace haxe{
namespace ui{
...
void PercentContentWidth_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_3da7db3a1a1ff50f_149_new)
...
bool PercentContentWidth_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType PercentContentWidth_obj::get(){
            	HX_STACKFRAME(&_hx_pos_3da7db3a1a1ff50f_150_get)
HXLINE( 151)		 ::haxe::ui::core::Component contents = this->_component->findComponent(HX_("scrollview-contents",15,b7,70,a7),null(),false,HX_("css",c3,83,4b,00)).StaticCast<  ::haxe::ui::core::Component >();
HXLINE( 152)		if (::hx::IsNull( contents )) {
HXLINE( 153)			return null();
            		}
HXLINE( 155)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromFloat(( (Float)(contents->get_percentWidth()) ));
            	}


void PercentContentWidth_obj::set( ::haxe::ui::util::VariantType value){
            	HX_STACKFRAME(&_hx_pos_3da7db3a1a1ff50f_158_set)
HXLINE( 159)		 ::haxe::ui::core::Component contents = this->_component->findComponent(HX_("scrollview-contents",15,b7,70,a7),null(),false,HX_("css",c3,83,4b,00)).StaticCast<  ::haxe::ui::core::Component >();
HXLINE( 160)		if (::hx::IsNotNull( contents )) {
HXLINE( 161)			contents->set_percentWidth(::haxe::ui::util::_Variant::Variant_Impl__obj::toFloat(value));
            		}
            	}
