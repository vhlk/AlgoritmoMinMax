...
HX_DEFINE_STACK_FRAME(_hx_pos_03487bd33ecd915b_312_new,"haxe.ui.containers._ScrollView.VScrollMax","new",0xb13752da,"haxe.ui.containers._ScrollView.VScrollMax.new","haxe/ui/containers/ScrollView.hx",312,0x01b76681)
HX_LOCAL_STACK_FRAME(_hx_pos_03487bd33ecd915b_317_get,"haxe.ui.containers._ScrollView.VScrollMax","get",0xb1320310,"haxe.ui.containers._ScrollView.VScrollMax.get","haxe/ui/containers/ScrollView.hx",317,0x01b76681)
HX_LOCAL_STACK_FRAME(_hx_pos_03487bd33ecd915b_326_validateData,"haxe.ui.containers._ScrollView.VScrollMax","validateData",0xa57cb426,"haxe.ui.containers._ScrollView.VScrollMax.validateData","haxe/ui/containers/ScrollView.hx",326,0x01b76681)
namespace haxe{
namespace ui{
...
void VScrollMax_obj::__construct( ::haxe::ui::containers::ScrollView scrollview){
            	HX_STACKFRAME(&_hx_pos_03487bd33ecd915b_312_new)
HXLINE( 313)		super::__construct(scrollview);
HXLINE( 314)		this->_scrollview = scrollview;
            	}
...
bool VScrollMax_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType VScrollMax_obj::get(){
            	HX_STACKFRAME(&_hx_pos_03487bd33ecd915b_317_get)
HXLINE( 318)		 ::haxe::ui::components::VerticalScroll vscroll = this->_scrollview->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::VerticalScroll >(),false,null()).StaticCast<  ::haxe::ui::components::VerticalScroll >();
HXLINE( 319)		if (::hx::IsNull( vscroll )) {
HXLINE( 320)			return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromInt(0);
            		}
HXLINE( 322)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromFloat(vscroll->get_max());
            	}


void VScrollMax_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_03487bd33ecd915b_326_validateData)
HXDLIN( 326)		if ((this->_scrollview->get_virtual() == true)) {
HXLINE( 327)			 ::haxe::ui::components::VerticalScroll vscroll = this->_scrollview->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::VerticalScroll >(),false,null()).StaticCast<  ::haxe::ui::components::VerticalScroll >();
HXLINE( 328)			 ::haxe::ui::util::VariantType _hx_tmp = this->_value;
HXDLIN( 328)			if (::haxe::ui::util::_Variant::Variant_Impl__obj::gt(_hx_tmp,::haxe::ui::util::_Variant::Variant_Impl__obj::fromInt(0))) {
HXLINE( 329)				if (::hx::IsNull( vscroll )) {
HXLINE( 330)					vscroll = ::hx::TCast<  ::haxe::ui::containers::ScrollViewBuilder >::cast(this->_scrollview->_compositeBuilder)->createVScroll();
            				}
            			}
            			else {
HXLINE( 333)				if (::hx::IsNotNull( vscroll )) {
HXLINE( 334)					::hx::TCast<  ::haxe::ui::containers::ScrollViewBuilder >::cast(this->_scrollview->_compositeBuilder)->destroyVScroll();
            				}
            			}
HXLINE( 337)			if (::hx::IsNotNull( vscroll )) {
HXLINE( 338)				vscroll->set_max(( (Float)(::haxe::ui::util::_Variant::Variant_Impl__obj::toFloat(this->_value)) ));
            			}
            		}
            	}
