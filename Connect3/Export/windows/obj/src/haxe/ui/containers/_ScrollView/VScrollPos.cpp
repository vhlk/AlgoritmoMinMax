...
HX_DEFINE_STACK_FRAME(_hx_pos_2dd7f304f28a6472_241_new,"haxe.ui.containers._ScrollView.VScrollPos","new",0xe5f5ddca,"haxe.ui.containers._ScrollView.VScrollPos.new","haxe/ui/containers/ScrollView.hx",241,0x01b76681)
HX_LOCAL_STACK_FRAME(_hx_pos_2dd7f304f28a6472_246_get,"haxe.ui.containers._ScrollView.VScrollPos","get",0xe5f08e00,"haxe.ui.containers._ScrollView.VScrollPos.get","haxe/ui/containers/ScrollView.hx",246,0x01b76681)
HX_LOCAL_STACK_FRAME(_hx_pos_2dd7f304f28a6472_254_validateData,"haxe.ui.containers._ScrollView.VScrollPos","validateData",0x536d4b36,"haxe.ui.containers._ScrollView.VScrollPos.validateData","haxe/ui/containers/ScrollView.hx",254,0x01b76681)
namespace haxe{
namespace ui{
...
void VScrollPos_obj::__construct( ::haxe::ui::containers::ScrollView scrollview){
            	HX_STACKFRAME(&_hx_pos_2dd7f304f28a6472_241_new)
HXLINE( 242)		super::__construct(scrollview);
HXLINE( 243)		this->_scrollview = scrollview;
            	}
...
bool VScrollPos_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType VScrollPos_obj::get(){
            	HX_STACKFRAME(&_hx_pos_2dd7f304f28a6472_246_get)
HXLINE( 247)		 ::haxe::ui::components::VerticalScroll vscroll = this->_scrollview->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::VerticalScroll >(),false,null()).StaticCast<  ::haxe::ui::components::VerticalScroll >();
HXLINE( 248)		if (::hx::IsNull( vscroll )) {
HXLINE( 249)			return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromInt(0);
            		}
HXLINE( 251)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromFloat(vscroll->get_pos());
            	}


void VScrollPos_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_2dd7f304f28a6472_254_validateData)
HXLINE( 255)		 ::haxe::ui::components::VerticalScroll vscroll = this->_scrollview->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::VerticalScroll >(),false,null()).StaticCast<  ::haxe::ui::components::VerticalScroll >();
HXLINE( 256)		if ((this->_scrollview->get_virtual() == true)) {
HXLINE( 257)			if (::hx::IsNull( vscroll )) {
HXLINE( 258)				vscroll = ::hx::TCast<  ::haxe::ui::containers::ScrollViewBuilder >::cast(this->_scrollview->_compositeBuilder)->createVScroll();
            			}
HXLINE( 260)			if (::hx::IsNotNull( vscroll )) {
HXLINE( 261)				vscroll->set_pos(( (Float)(::haxe::ui::util::_Variant::Variant_Impl__obj::toFloat(this->_value)) ));
            			}
            		}
            		else {
HXLINE( 264)			if (::hx::IsNotNull( vscroll )) {
HXLINE( 265)				vscroll->set_pos(( (Float)(::haxe::ui::util::_Variant::Variant_Impl__obj::toFloat(this->_value)) ));
            			}
            		}
            	}
