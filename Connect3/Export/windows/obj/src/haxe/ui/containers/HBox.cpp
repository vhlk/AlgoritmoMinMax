...
HX_LOCAL_STACK_FRAME(_hx_pos_6e8a90724db2b87d_370_registerBehaviours,"haxe.ui.containers.HBox","registerBehaviours",0xd0663dfa,"haxe.ui.containers.HBox.registerBehaviours","haxe/ui/macros/Macros.hx",370,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_bafc773041fcaab4_525_cloneComponent,"haxe.ui.containers.HBox","cloneComponent",0xa3259b41,"haxe.ui.containers.HBox.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",525,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_6e8a90724db2b87d_351_self,"haxe.ui.containers.HBox","self",0xc4db19ed,"haxe.ui.containers.HBox.self","haxe/ui/macros/Macros.hx",351,0x27866361)
namespace haxe{
namespace ui{
...
void HBox_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_6e8a90724db2b87d_370_registerBehaviours)
HXDLIN( 370)		this->super::registerBehaviours();
            	}


 ::haxe::ui::core::ComponentContainer HBox_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_bafc773041fcaab4_525_cloneComponent)
HXLINE( 300)		 ::haxe::ui::containers::HBox c = ( ( ::haxe::ui::containers::HBox)(this->super::cloneComponent()) );
HXLINE( 311)		c->set_continuous(this->get_continuous());
...
HXLINE( 323)		return c;
 ...
 ::haxe::ui::core::ComponentContainer HBox_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_6e8a90724db2b87d_351_self)
HXDLIN( 351)		return  ::haxe::ui::containers::HBox_obj::__alloc( HX_CTX );
            	}
