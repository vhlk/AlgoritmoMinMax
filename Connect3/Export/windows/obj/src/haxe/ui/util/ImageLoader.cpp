...
void ImageLoader_obj::__construct( ::haxe::ui::util::VariantType resource){
            	HX_STACKFRAME(&_hx_pos_d91662fd4fb13014_11_new)
HXDLIN(  11)		this->_resource = resource;
            	}
...
HXLINE(  26)				 ::openfl::display::BitmapData imageData = ::haxe::ui::util::_Variant::Variant_Impl__obj::toImageData(this->_resource);
...
HXLINE( 103)		http->onData =  ::Dynamic(new _hx_Closure_0(callback));
HXLINE( 106)		http->onError =  ::Dynamic(new _hx_Closure_1(callback));
...
HXLINE( 118)		if ((::sys::FileSystem_obj::exists(filename) == false)) {
HXLINE( 119)			callback(null());
            		}
HXLINE( 122)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 123)			 ::haxe::ui::ToolkitAssets _hx_tmp = ::haxe::ui::Toolkit_obj::get_assets();
HXDLIN( 123)			_hx_tmp->imageFromBytes(::sys::io::File_obj::getBytes(filename),callback);
            		} catch( ::Dynamic _hx_e) {
...
HXDLIN( 125)					::String _hx_tmp1 = (HX_("Problem loading image file: ",ec,2c,08,c9) + ::Std_obj::string(e));
HXDLIN( 125)					_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("haxe/ui/util/ImageLoader.hx",0b,16,cd,67),125,HX_("haxe.ui.util.ImageLoader",54,e6,c2,17),HX_("loadFromFile",4c,89,f0,5a)));
HXLINE( 126)					callback(null());
            				}
            			}
            			else {
