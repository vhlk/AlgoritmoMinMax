...
HX_LOCAL_STACK_FRAME(_hx_pos_6af1edf198e87d95_472_get_isNull,"haxe.ui.util._Variant.Variant_Impl_","get_isNull",0xfe241f11,"haxe.ui.util._Variant.Variant_Impl_.get_isNull","haxe/ui/util/Variant.hx",472,0x091cea34)
HX_LOCAL_STACK_FRAME(_hx_pos_6af1edf198e87d95_475_fromDynamic,"haxe.ui.util._Variant.Variant_Impl_","fromDynamic",0x6990f79e,"haxe.ui.util._Variant.Variant_Impl_.fromDynamic","haxe/ui/util/Variant.hx",475,0x091cea34)
HX_LOCAL_STACK_FRAME(_hx_pos_6af1edf198e87d95_505_containsOnlyDigits,"haxe.ui.util._Variant.Variant_Impl_","containsOnlyDigits",0x58bb1268,"haxe.ui.util._Variant.Variant_Impl_.containsOnlyDigits","haxe/ui/util/Variant.hx",505,0x091cea34)
HX_LOCAL_STACK_FRAME(_hx_pos_6af1edf198e87d95_520_toDynamic,"haxe.ui.util._Variant.Variant_Impl_","toDynamic",0xb59faf6d,"haxe.ui.util._Variant.Variant_Impl_.toDynamic","haxe/ui/util/Variant.hx",520,0x091cea34)
namespace haxe{
namespace ui{
namespace util{
namespace _Variant{
...
HXDLIN(  37)				return ::Std_obj::string(s);
            			...
            			break;
            			case (int)5: {
HXLINE(  39)				 ::haxe::ui::data::DataSource _g = this1->_hx_getObject(0).StaticCast<  ::haxe::ui::data::DataSource >();
HXDLIN(  39)				return HX_("",00,00,00,00);
            			}
            			break;
            			case (int)6: {
HXLINE(  38)				 ::haxe::ui::core::Component s = this1->_hx_getObject(0).StaticCast<  ::haxe::ui::core::Component >();
HXDLIN(  38)				return ::Std_obj::string(s);
            			}
            			break;
            			case (int)7: {
...
HXDLIN(  64)				return s;
            			...
            			break;
            			default:{
HXLINE(  65)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Variant Type Error",bd,c5,df,49)));
            			}
            		}
...
HXDLIN(  87)				return ::Std_obj::_hx_int(s);
            			...
            			break;
            			default:{
HXLINE(  88)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Variant Type Error",bd,c5,df,49)));
            			}
            		}
HXLINE(  85)		return 0;
            	}
...
HXDLIN( 108)				return s;
            			...
            			break;
            			default:{
HXLINE( 109)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Variant Type Error",bd,c5,df,49)));
            			}
            		}
...
HXDLIN( 125)				return s;
            			...
            			break;
            			default:{
HXLINE( 127)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Variant Type Error",bd,c5,df,49)));
            			}
            		}
...
HXLINE( 153)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Variant Type Error",bd,c5,df,49)));
            		}
...
HXLINE( 179)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Variant Type Error",bd,c5,df,49)));
            		}
...
HXLINE( 205)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Variant Type Error",bd,c5,df,49)));
            		}
...
HXLINE( 231)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Variant Type Error",bd,c5,df,49)));
            		}
...
HXLINE( 258)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Variant Type Error",bd,c5,df,49)));
            		}
...
bool Variant_Impl__obj::get_isNull( ::haxe::ui::util::VariantType this1){
            	HX_STACKFRAME(&_hx_pos_6af1edf198e87d95_472_get_isNull)
HXDLIN( 472)		if (::hx::IsNotNull( this1 )) {
HXDLIN( 472)			return ::hx::IsNull( ::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this1) );
            		}
            		else {
HXDLIN( 472)			return true;
            		}
HXDLIN( 472)		return false;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Variant_Impl__obj,get_isNull,return )
 ...
 ::haxe::ui::util::VariantType Variant_Impl__obj::fromDynamic( ::Dynamic r){
            	HX_STACKFRAME(&_hx_pos_6af1edf198e87d95_475_fromDynamic)
HXLINE( 476)		 ::haxe::ui::util::VariantType v = null();
HXLINE( 477)		if (::hx::IsNotNull( r )) {
HXLINE( 478)			bool _hx_tmp;
HXDLIN( 478)			if (::haxe::ui::util::_Variant::Variant_Impl__obj::containsOnlyDigits(r)) {
HXLINE( 478)				_hx_tmp = (::Math_obj::isNaN(::Std_obj::parseFloat((HX_("",00,00,00,00) + ::Std_obj::string(r)))) == false);
            			}
            			else {
HXLINE( 478)				_hx_tmp = false;
            			}
HXDLIN( 478)			if (_hx_tmp) {
HXLINE( 479)				if ((::Std_obj::string(r).indexOf(HX_(".",2e,00,00,00),null()) != -1)) {
HXLINE( 480)					v = ::haxe::ui::util::_Variant::Variant_Impl__obj::fromFloat(::Std_obj::parseFloat((HX_("",00,00,00,00) + ::Std_obj::string(r))));
            				}
            				else {
HXLINE( 482)					v = ::haxe::ui::util::_Variant::Variant_Impl__obj::fromInt(( (int)(::Std_obj::parseInt((HX_("",00,00,00,00) + ::Std_obj::string(r)))) ));
            				}
            			}
            			else {
HXLINE( 484)				bool _hx_tmp;
HXDLIN( 484)				if (((HX_("",00,00,00,00) + ::Std_obj::string(r)) != HX_("true",4e,a7,03,4d))) {
HXLINE( 484)					_hx_tmp = ((::Std_obj::string(r) + HX_("",00,00,00,00)) == HX_("false",a3,35,4f,fb));
            				}
            				else {
HXLINE( 484)					_hx_tmp = true;
            				}
HXDLIN( 484)				if (_hx_tmp) {
HXLINE( 485)					v = ::haxe::ui::util::_Variant::Variant_Impl__obj::fromBool(((HX_("",00,00,00,00) + ::Std_obj::string(r)) == HX_("true",4e,a7,03,4d)));
            				}
            				else {
HXLINE( 486)					if (::Std_obj::isOfType(r,::hx::ClassOf< ::String >())) {
HXLINE( 487)						v = ::haxe::ui::util::_Variant::Variant_Impl__obj::fromString(::hx::TCast< ::String >::cast(r));
            					}
            					else {
HXLINE( 488)						if (::Std_obj::isOfType(r,::hx::ClassOf< ::haxe::ui::core::Component >())) {
HXLINE( 489)							v = ::haxe::ui::util::_Variant::Variant_Impl__obj::fromComponent(::hx::TCast<  ::haxe::ui::core::Component >::cast(r));
            						}
            						else {
HXLINE( 490)							if (::Std_obj::isOfType(r,::hx::ClassOf< ::haxe::ui::data::DataSource >())) {
HXLINE( 491)								v = r;
            							}
            							else {
HXLINE( 492)								if (::Std_obj::isOfType(r,::hx::ArrayBase::__mClass)) {
HXLINE( 493)									v = r;
            								}
            								else {
HXLINE( 494)									if (::Std_obj::isOfType(r,::hx::ClassOf< ::Date >())) {
HXLINE( 495)										v = ::haxe::ui::util::_Variant::Variant_Impl__obj::fromDate(::hx::TCast<  ::Date >::cast(r));
            									}
            									else {
HXLINE( 496)										if (::Std_obj::isOfType(r,::hx::ClassOf< ::openfl::display::BitmapData >())) {
HXLINE( 497)											v = ::haxe::ui::util::_Variant::Variant_Impl__obj::fromImageData(::hx::TCast<  ::openfl::display::BitmapData >::cast(r));
            										}
            										else {
HXLINE( 499)											v = r;
            										}
...
bool Variant_Impl__obj::containsOnlyDigits( ::Dynamic s){
            	HX_STACKFRAME(&_hx_pos_6af1edf198e87d95_505_containsOnlyDigits)
HXLINE( 506)		bool _hx_tmp;
HXDLIN( 506)		if (!(::Std_obj::isOfType(s,::hx::ClassOf< int >()))) {
HXLINE( 506)			_hx_tmp = ::Std_obj::isOfType(s,::hx::ClassOf< ::Float >());
            		}
            		else {
...
HXLINE( 510)		::String t = ::Std_obj::string(s);
HXLINE( 511)		{
HXLINE( 511)			int _g = 0;
HXDLIN( 511)			int _g1 = t.length;
HXDLIN( 511)			while((_g < _g1)){
HXLINE( 511)				_g = (_g + 1);
HXDLIN( 511)				int i = (_g - 1);
HXLINE( 512)				::String c = t.charAt(i);
...
HXDLIN( 513)				bool _hx_tmp6;
HXDLIN( 513)				bool _hx_tmp7;
HXDLIN( 513)				bool _hx_tmp8;
HXDLIN( 513)				bool _hx_tmp9;
HXDLIN( 513)				if ((c != HX_("0",30,00,00,00))) {
HXLINE( 513)					_hx_tmp9 = (c != HX_("1",31,00,00,00));
            				}
            				else {
HXLINE( 513)					_hx_tmp9 = false;
            				}
HXDLIN( 513)				if (_hx_tmp9) {
HXLINE( 513)					_hx_tmp8 = (c != HX_("2",32,00,00,00));
            				}
            				else {
HXLINE( 513)					_hx_tmp8 = false;
            				}
HXDLIN( 513)				if (_hx_tmp8) {
HXLINE( 513)					_hx_tmp7 = (c != HX_("3",33,00,00,00));
            				}
            				else {
HXLINE( 513)					_hx_tmp7 = false;
            				}
HXDLIN( 513)				if (_hx_tmp7) {
HXLINE( 513)					_hx_tmp6 = (c != HX_("4",34,00,00,00));
            				}
            				else {
HXLINE( 513)					_hx_tmp6 = false;
            				}
HXDLIN( 513)				if (_hx_tmp6) {
HXLINE( 513)					_hx_tmp5 = (c != HX_("5",35,00,00,00));
            				}
            				else {
HXLINE( 513)					_hx_tmp5 = false;
            				}
HXDLIN( 513)				if (_hx_tmp5) {
HXLINE( 513)					_hx_tmp4 = (c != HX_("6",36,00,00,00));
            				}
            				else {
HXLINE( 513)					_hx_tmp4 = false;
            				}
HXDLIN( 513)				if (_hx_tmp4) {
HXLINE( 513)					_hx_tmp3 = (c != HX_("7",37,00,00,00));
            				}
            				else {
HXLINE( 513)					_hx_tmp3 = false;
            				}
HXDLIN( 513)				if (_hx_tmp3) {
HXLINE( 513)					_hx_tmp2 = (c != HX_("8",38,00,00,00));
            				}
            				else {
HXLINE( 513)					_hx_tmp2 = false;
            				}
HXDLIN( 513)				if (_hx_tmp2) {
HXLINE( 513)					_hx_tmp1 = (c != HX_("9",39,00,00,00));
            				}
            				else {
HXLINE( 513)					_hx_tmp1 = false;
            				}
HXDLIN( 513)				if (_hx_tmp1) {
HXLINE( 513)					_hx_tmp = (c != HX_(".",2e,00,00,00));
            				}
            				else {
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Variant_Impl__obj,containsOnlyDigits,return )
 ...
 ::Dynamic Variant_Impl__obj::toDynamic( ::haxe::ui::util::VariantType v){
            	HX_STACKFRAME(&_hx_pos_6af1edf198e87d95_520_toDynamic)
HXLINE( 521)		 ::Dynamic d = null();
HXLINE( 522)		if (::hx::IsNotNull( v )) {
HXLINE( 523)			switch((int)(v->_hx_getIndex())){
            				case (int)0: {
HXLINE( 524)					int y = v->_hx_getInt(0);
HXDLIN( 524)					d = y;
            				}
            				break;
            				case (int)1: {
HXLINE( 525)					Float y = v->_hx_getFloat(0);
HXDLIN( 525)					d = y;
            				}
            				break;
            				case (int)2: {
HXLINE( 526)					::String y = v->_hx_getString(0);
HXDLIN( 526)					d = y;
            				}
            				break;
            				case (int)3: {
HXLINE( 527)					bool y = v->_hx_getBool(0);
HXDLIN( 527)					d = y;
            				}
            				break;
            				case (int)4: {
HXLINE( 528)					::cpp::VirtualArray y = v->_hx_getObject(0).StaticCast< ::cpp::VirtualArray >();
HXDLIN( 528)					d = y;
            				}
            				break;
            				case (int)5: {
HXLINE( 530)					 ::haxe::ui::data::DataSource y = v->_hx_getObject(0).StaticCast<  ::haxe::ui::data::DataSource >();
HXDLIN( 530)					d = y;
            				}
            				break;
            				case (int)6: {
HXLINE( 529)					 ::haxe::ui::core::Component y = v->_hx_getObject(0).StaticCast<  ::haxe::ui::core::Component >();
HXDLIN( 529)					d = y;
            				}
            				break;
            				case (int)7: {
HXLINE( 531)					 ::Date y = v->_hx_getObject(0).StaticCast<  ::Date >();
HXDLIN( 531)					d = y;
            				}
            				break;
            				case (int)8: {
HXLINE( 532)					 ::openfl::display::BitmapData y = v->_hx_getObject(0).StaticCast<  ::openfl::display::BitmapData >();
HXDLIN( 532)					d = y;
            				}
            				break;
            			}
