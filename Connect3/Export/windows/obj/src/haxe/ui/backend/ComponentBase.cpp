...
HX_LOCAL_STACK_FRAME(_hx_pos_9f66ddde5f9eb820_370_registerBehaviours,"haxe.ui.backend.ComponentBase","registerBehaviours",0x97c877a5,"haxe.ui.backend.ComponentBase.registerBehaviours","haxe/ui/macros/Macros.hx",370,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_e3dc0ef695412051_525_cloneComponent,"haxe.ui.backend.ComponentBase","cloneComponent",0xa108e36c,"haxe.ui.backend.ComponentBase.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",525,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_9f66ddde5f9eb820_351_self,"haxe.ui.backend.ComponentBase","self",0x076e8e58,"haxe.ui.backend.ComponentBase.self","haxe/ui/macros/Macros.hx",351,0x27866361)
namespace haxe{
namespace ui{
namespace backend{
...
HXLINE( 249)		this->_nativeClassName = null();
HXLINE( 239)		this->_className = null();
...
HXLINE(  99)			this->_textDisplay =  ::haxe::ui::core::TextDisplay_obj::__alloc( HX_CTX );
HXLINE( 100)			this->_textDisplay->parentComponent = ::hx::TCast<  ::haxe::ui::core::Component >::cast(::hx::ObjectPtr<OBJ_>(this));
            		}
...
HXLINE( 122)			this->_textInput =  ::haxe::ui::core::TextInput_obj::__alloc( HX_CTX );
HXLINE( 123)			this->_textInput->parentComponent = ::hx::TCast<  ::haxe::ui::core::Component >::cast(::hx::ObjectPtr<OBJ_>(this));
            		}
...
HXLINE( 148)			this->_imageDisplay =  ::haxe::ui::core::ImageDisplay_obj::__alloc( HX_CTX );
HXLINE( 149)			this->_imageDisplay->parentComponent = ::hx::TCast<  ::haxe::ui::core::Component >::cast(::hx::ObjectPtr<OBJ_>(this));
            		}
...
void ComponentBase_obj::removeImageDisplay(){
            	HX_STACKFRAME(&_hx_pos_99836deeea93cd49_166_removeImageDisplay)
HXDLIN( 166)		if (::hx::IsNotNull( this->_imageDisplay )) {
HXLINE( 167)			this->_imageDisplay->dispose();
HXLINE( 168)			this->_imageDisplay = null();
            		}
            	}
...
HXLINE( 210)			this->_classProperties =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            		}
...
bool ComponentBase_obj::get_hasNativeEntry(){
            	HX_STACKFRAME(&_hx_pos_99836deeea93cd49_217_get_hasNativeEntry)
HXLINE( 218)		if (::hx::IsNull( this->_hasNativeEntry )) {
HXLINE( 219)			this->_hasNativeEntry = ::hx::IsNotNull( this->getNativeConfigProperty(HX_(".@id",ad,bc,98,1e),null()) );
            		}
...
::String ComponentBase_obj::get_className(){
            	HX_STACKFRAME(&_hx_pos_99836deeea93cd49_241_get_className)
HXLINE( 242)		if (::hx::IsNotNull( this->_className )) {
HXLINE( 243)			return this->_className;
            		}
HXLINE( 245)		this->_className = ::Type_obj::getClassName(::Type_obj::getClass(::hx::ObjectPtr<OBJ_>(this)));
...
::String ComponentBase_obj::get_nativeClassName(){
            	HX_STACKFRAME(&_hx_pos_99836deeea93cd49_251_get_nativeClassName)
...
HXLINE( 261)				this->_nativeClassName = c;
HXLINE( 262)				goto _hx_goto_37;
            			}
HXLINE( 264)			r = ::Type_obj::getSuperClass(r);
HXLINE( 265)			if (::hx::IsPointerEq( r,::hx::ClassOf< ::haxe::ui::core::Component >() )) {
HXLINE( 266)				goto _hx_goto_37;
            			}
            		}
            		_hx_goto_37:;
HXLINE( 270)		if (::hx::IsNull( this->_nativeClassName )) {
HXLINE( 271)			this->_nativeClassName = this->get_className();
            		}
...
void ComponentBase_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_9f66ddde5f9eb820_370_registerBehaviours)
HXDLIN( 370)		this->super::registerBehaviours();
            	}


 ::haxe::ui::core::ComponentContainer ComponentBase_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_e3dc0ef695412051_525_cloneComponent)
HXLINE( 300)		 ::haxe::ui::backend::ComponentBase c = ( ( ::haxe::ui::backend::ComponentBase)(this->super::cloneComponent()) );
...
HXLINE( 323)		return c;
 ...
 ::haxe::ui::core::ComponentContainer ComponentBase_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_9f66ddde5f9eb820_351_self)
HXDLIN( 351)		return  ::haxe::ui::backend::ComponentBase_obj::__alloc( HX_CTX );
            	}
