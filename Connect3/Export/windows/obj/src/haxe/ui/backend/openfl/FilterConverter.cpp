...
HX_LOCAL_STACK_FRAME(_hx_pos_b4a03d766f8dffa5_10_convertFilter,"haxe.ui.backend.openfl.FilterConverter","convertFilter",0x51c54493,"haxe.ui.backend.openfl.FilterConverter.convertFilter","haxe/ui/backend/openfl/FilterConverter.hx",10,0xbbf81308)
namespace haxe{
namespace ui{
namespace backend{
namespace openfl{
...
bool FilterConverter_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::filters::BitmapFilter FilterConverter_obj::convertFilter( ::haxe::ui::filters::Filter input){
            	HX_GC_STACKFRAME(&_hx_pos_b4a03d766f8dffa5_10_convertFilter)
HXLINE(  11)		if (::hx::IsNull( input )) {
HXLINE(  12)			return null();
            		}
HXLINE(  14)		 ::openfl::filters::BitmapFilter output = null();
HXLINE(  18)		if (::Std_obj::isOfType(input,::hx::ClassOf< ::haxe::ui::filters::DropShadow >())) {
HXLINE(  19)			 ::haxe::ui::filters::DropShadow inputDropShadow = ::hx::TCast<  ::haxe::ui::filters::DropShadow >::cast(input);
HXLINE(  20)			output =  ::openfl::filters::DropShadowFilter_obj::__alloc( HX_CTX ,(inputDropShadow->distance + 1),inputDropShadow->angle,inputDropShadow->color,(inputDropShadow->alpha * ( (Float)(2) )),inputDropShadow->blurX,inputDropShadow->blurY,inputDropShadow->strength,inputDropShadow->quality,inputDropShadow->inner,null(),null());
HXLINE(  30)			::hx::TCast<  ::openfl::filters::DropShadowFilter >::cast(output)->set_alpha(( (Float)(1) ));
            		}
            		else {
HXLINE(  31)			if (::Std_obj::isOfType(input,::hx::ClassOf< ::haxe::ui::filters::Blur >())) {
HXLINE(  32)				 ::haxe::ui::filters::Blur inputBlur = ::hx::TCast<  ::haxe::ui::filters::Blur >::cast(input);
HXLINE(  33)				output =  ::openfl::filters::BlurFilter_obj::__alloc( HX_CTX ,inputBlur->amount,inputBlur->amount,null());
            			}
            			else {
HXLINE(  34)				if (::Std_obj::isOfType(input,::hx::ClassOf< ::haxe::ui::filters::Grayscale >())) {
HXLINE(  35)					 ::haxe::ui::filters::Grayscale inputGrayscale = ::hx::TCast<  ::haxe::ui::filters::Grayscale >::cast(input);
HXLINE(  36)					output =  ::haxe::ui::backend::openfl::filters::GrayscaleFilter_obj::__alloc( HX_CTX ,(inputGrayscale->amount / ( (Float)(100) )))->filter;
            				}
            			}
            		}
HXLINE(  41)		return output;
            	}
