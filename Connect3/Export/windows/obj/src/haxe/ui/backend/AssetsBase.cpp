...
HX_LOCAL_STACK_FRAME(_hx_pos_4e621796a8d98261_29_getFontInternal,"haxe.ui.backend.AssetsBase","getFontInternal",0x510a7974,"haxe.ui.backend.AssetsBase.getFontInternal","haxe/ui/backend/AssetsBase.hx",29,0x0e45c37d)
HX_LOCAL_STACK_FRAME(_hx_pos_4e621796a8d98261_33_getFontFromHaxeResource,"haxe.ui.backend.AssetsBase","getFontFromHaxeResource",0x93c3ecd5,"haxe.ui.backend.AssetsBase.getFontFromHaxeResource","haxe/ui/backend/AssetsBase.hx",33,0x0e45c37d)
HX_LOCAL_STACK_FRAME(_hx_pos_4e621796a8d98261_37_imageInfoFromImageData,"haxe.ui.backend.AssetsBase","imageInfoFromImageData",0xc00077e0,"haxe.ui.backend.AssetsBase.imageInfoFromImageData","haxe/ui/backend/AssetsBase.hx",37,0x0e45c37d)
namespace haxe{
namespace ui{
namespace backend{
...
void AssetsBase_obj::getFontInternal(::String resourceId, ::Dynamic callback){
            	HX_STACKFRAME(&_hx_pos_4e621796a8d98261_29_getFontInternal)
HXDLIN(  29)		callback(null());
            	}
...
void AssetsBase_obj::getFontFromHaxeResource(::String resourceId, ::Dynamic callback){
            	HX_STACKFRAME(&_hx_pos_4e621796a8d98261_33_getFontFromHaxeResource)
HXDLIN(  33)		callback(resourceId,null());
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(AssetsBase_obj,getFontFromHaxeResource,(void))
 ...
 ::Dynamic AssetsBase_obj::imageInfoFromImageData( ::openfl::display::BitmapData imageData){
            	HX_STACKFRAME(&_hx_pos_4e621796a8d98261_37_imageInfoFromImageData)
HXDLIN(  37)		return  ::Dynamic(::hx::Anon_obj::Create(3)
