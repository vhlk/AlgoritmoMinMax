...
HX_LOCAL_STACK_FRAME(_hx_pos_1fa44b53d7776068_49_get_supportsHtml,"haxe.ui.backend.TextBase","get_supportsHtml",0xb4df805c,"haxe.ui.backend.TextBase.get_supportsHtml","haxe/ui/backend/TextBase.hx",49,0xb04ce5d3)
HX_LOCAL_STACK_FRAME(_hx_pos_1fa44b53d7776068_56_validateData,"haxe.ui.backend.TextBase","validateData",0x3833e2a4,"haxe.ui.backend.TextBase.validateData","haxe/ui/backend/TextBase.hx",56,0xb04ce5d3)
HX_LOCAL_STACK_FRAME(_hx_pos_1fa44b53d7776068_60_validateStyle,"haxe.ui.backend.TextBase","validateStyle",0xa4c80377,"haxe.ui.backend.TextBase.validateStyle","haxe/ui/backend/TextBase.hx",60,0xb04ce5d3)
HX_LOCAL_STACK_FRAME(_hx_pos_1fa44b53d7776068_63_validatePosition,"haxe.ui.backend.TextBase","validatePosition",0x40e3f223,"haxe.ui.backend.TextBase.validatePosition","haxe/ui/backend/TextBase.hx",63,0xb04ce5d3)
HX_LOCAL_STACK_FRAME(_hx_pos_1fa44b53d7776068_66_validateDisplay,"haxe.ui.backend.TextBase","validateDisplay",0x21fd2608,"haxe.ui.backend.TextBase.validateDisplay","haxe/ui/backend/TextBase.hx",66,0xb04ce5d3)
HX_LOCAL_STACK_FRAME(_hx_pos_1fa44b53d7776068_69_measureText,"haxe.ui.backend.TextBase","measureText",0xc2e132e7,"haxe.ui.backend.TextBase.measureText","haxe/ui/backend/TextBase.hx",69,0xb04ce5d3)
namespace haxe{
namespace ui{
namespace backend{
...
HXLINE(  18)		this->_htmlText = null();
HXLINE(  15)		this->_inputData =  ::haxe::ui::core::TextInputData_obj::__alloc( HX_CTX );
HXLINE(  14)		this->_displayData =  ::haxe::ui::core::TextDisplayData_obj::__alloc( HX_CTX );
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(TextBase_obj,get_dataSource,return )
 ...
 ::haxe::ui::data::DataSource TextBase_obj::set_dataSource( ::haxe::ui::data::DataSource value){
            	HX_STACKFRAME(&_hx_pos_1fa44b53d7776068_42_set_dataSource)
HXLINE(  43)		this->_dataSource = value;
...
bool TextBase_obj::get_supportsHtml(){
            	HX_STACKFRAME(&_hx_pos_1fa44b53d7776068_49_get_supportsHtml)
...
void TextBase_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_1fa44b53d7776068_56_validateData)
            	}
...
bool TextBase_obj::validateStyle(){
            	HX_STACKFRAME(&_hx_pos_1fa44b53d7776068_60_validateStyle)
...
void TextBase_obj::validatePosition(){
            	HX_STACKFRAME(&_hx_pos_1fa44b53d7776068_63_validatePosition)
            	}
...
void TextBase_obj::validateDisplay(){
            	HX_STACKFRAME(&_hx_pos_1fa44b53d7776068_66_validateDisplay)
            	}
...
void TextBase_obj::measureText(){
            	HX_STACKFRAME(&_hx_pos_1fa44b53d7776068_69_measureText)
            	}
