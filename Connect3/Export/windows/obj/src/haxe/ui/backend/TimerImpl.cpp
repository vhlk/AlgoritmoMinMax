...
HX_DEFINE_STACK_FRAME(_hx_pos_886b5ec6758f91cf_36_new,"haxe.ui.backend.TimerImpl","new",0x5c2f026b,"haxe.ui.backend.TimerImpl.new","haxe/ui/backend/TimerImpl.hx",36,0xe2a33786)
HX_LOCAL_STACK_FRAME(_hx_pos_886b5ec6758f91cf_46_stop,"haxe.ui.backend.TimerImpl","stop",0x504c8797,"haxe.ui.backend.TimerImpl.stop","haxe/ui/backend/TimerImpl.hx",46,0xe2a33786)
...
void TimerImpl_obj::__construct(int delay, ::Dynamic callback){
            	HX_STACKFRAME(&_hx_pos_886b5ec6758f91cf_36_new)
HXLINE(  37)		this->_callback = callback;
HXLINE(  38)		int timer = ::lime::_hx_system::System_obj::getTimer();
HXDLIN(  38)		Float _hx_tmp;
HXDLIN(  38)		if ((timer > 0)) {
HXLINE(  38)			_hx_tmp = (( (Float)(timer) ) / ( (Float)(1000) ));
            		}
            		else {
HXLINE(  38)			_hx_tmp = ( (Float)(0) );
            		}
HXDLIN(  38)		this->_start = (_hx_tmp + (( (Float)(delay) ) / ( (Float)(1000) )));
HXLINE(  39)		::haxe::ui::backend::TimerImpl_obj::_hx___timers->push(::hx::ObjectPtr<OBJ_>(this));
HXLINE(  40)		if ((::haxe::ui::backend::TimerImpl_obj::_hx___timers->length == 1)) {
HXLINE(  41)			::openfl::Lib_obj::get_current()->stage->addEventListener(HX_("enterFrame",f5,03,50,02),::haxe::ui::backend::TimerImpl_obj::update_dyn(),false,10000,null());
            		}
            	}
...
void TimerImpl_obj::stop(){
            	HX_STACKFRAME(&_hx_pos_886b5ec6758f91cf_46_stop)
HXDLIN(  46)		this->_stopped = true;
            	}
...
HXLINE(  16)					timer->_callback();
            				}
            			}
            		}
HXLINE(  20)		while(true){
HXLINE(  20)			count = (count - 1);
HXDLIN(  20)			if (!((count >= 0))) {
HXLINE(  20)				goto _hx_goto_3;
            			}
HXLINE(  21)			 ::haxe::ui::backend::TimerImpl timer = ::haxe::ui::backend::TimerImpl_obj::_hx___timers->__get(count).StaticCast<  ::haxe::ui::backend::TimerImpl >();
HXLINE(  22)			if (timer->_stopped) {
HXLINE(  23)				::haxe::ui::backend::TimerImpl_obj::_hx___timers->remove(timer);
            			}
            		}
            		_hx_goto_3:;
HXLINE(  27)		if ((::haxe::ui::backend::TimerImpl_obj::_hx___timers->length == 0)) {
HXLINE(  28)			::openfl::Lib_obj::get_current()->stage->removeEventListener(HX_("enterFrame",f5,03,50,02),::haxe::ui::backend::TimerImpl_obj::update_dyn(),null());
            		}
            	}
