...
HX_LOCAL_STACK_FRAME(_hx_pos_d6723378fb95a5c6_126__onMappedEvent,"haxe.ui.core.ComponentEvents","_onMappedEvent",0xa2e7d2fe,"haxe.ui.core.ComponentEvents._onMappedEvent","haxe/ui/core/ComponentEvents.hx",126,0x7387fb66)
HX_LOCAL_STACK_FRAME(_hx_pos_d6723378fb95a5c6_137_isInteractiveEvent,"haxe.ui.core.ComponentEvents","isInteractiveEvent",0xa472fb97,"haxe.ui.core.ComponentEvents.isInteractiveEvent","haxe/ui/core/ComponentEvents.hx",137,0x7387fb66)
HX_LOCAL_STACK_FRAME(_hx_pos_d6723378fb95a5c6_142_disableInteractivity,"haxe.ui.core.ComponentEvents","disableInteractivity",0xbb32fdd8,"haxe.ui.core.ComponentEvents.disableInteractivity","haxe/ui/core/ComponentEvents.hx",142,0x7387fb66)
HX_LOCAL_STACK_FRAME(_hx_pos_d6723378fb95a5c6_199_unregisterEvents,"haxe.ui.core.ComponentEvents","unregisterEvents",0x7eeaa76a,"haxe.ui.core.ComponentEvents.unregisterEvents","haxe/ui/core/ComponentEvents.hx",199,0x7387fb66)
HX_LOCAL_STACK_FRAME(_hx_pos_d6723378fb95a5c6_220_pauseEvent,"haxe.ui.core.ComponentEvents","pauseEvent",0x0c3b90f9,"haxe.ui.core.ComponentEvents.pauseEvent","haxe/ui/core/ComponentEvents.hx",220,0x7387fb66)
HX_LOCAL_STACK_FRAME(_hx_pos_d6723378fb95a5c6_261_resumeEvent,"haxe.ui.core.ComponentEvents","resumeEvent",0x63f6add8,"haxe.ui.core.ComponentEvents.resumeEvent","haxe/ui/core/ComponentEvents.hx",261,0x7387fb66)
HX_LOCAL_STACK_FRAME(_hx_pos_d6723378fb95a5c6_248_resumeEvent,"haxe.ui.core.ComponentEvents","resumeEvent",0x63f6add8,"haxe.ui.core.ComponentEvents.resumeEvent","haxe/ui/core/ComponentEvents.hx",248,0x7387fb66)
HX_LOCAL_STACK_FRAME(_hx_pos_d6723378fb95a5c6_276_mapEvent,"haxe.ui.core.ComponentEvents","mapEvent",0xe8cb9c53,"haxe.ui.core.ComponentEvents.mapEvent","haxe/ui/core/ComponentEvents.hx",276,0x7387fb66)
HX_LOCAL_STACK_FRAME(_hx_pos_d6723378fb95a5c6_279_unmapEvent,"haxe.ui.core.ComponentEvents","unmapEvent",0x33c94aec,"haxe.ui.core.ComponentEvents.unmapEvent","haxe/ui/core/ComponentEvents.hx",279,0x7387fb66)
HX_LOCAL_STACK_FRAME(_hx_pos_e6d3650b25edf420_370_registerBehaviours,"haxe.ui.core.ComponentEvents","registerBehaviours",0xd4b8108e,"haxe.ui.core.ComponentEvents.registerBehaviours","haxe/ui/macros/Macros.hx",370,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_8ea004cf0546e5a7_525_cloneComponent,"haxe.ui.core.ComponentEvents","cloneComponent",0xb0cd93d5,"haxe.ui.core.ComponentEvents.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",525,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_e6d3650b25edf420_351_self,"haxe.ui.core.ComponentEvents","self",0x8a225181,"haxe.ui.core.ComponentEvents.self","haxe/ui/macros/Macros.hx",351,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_d6723378fb95a5c6_130_boot,"haxe.ui.core.ComponentEvents","boot",0x7eed4a27,"haxe.ui.core.ComponentEvents.boot","haxe/ui/core/ComponentEvents.hx",130,0x7387fb66)
static const ::String _hx_array_data_a3e25e99_37[] = {
...
HXLINE( 219)		this->_pausedEvents = null();
HXLINE( 141)		this->_interactivityDisabledCounter = 0;
HXLINE( 140)		this->_interactivityDisabled = false;
...
HXDLIN(  44)		if (::hx::TCast<  ::haxe::ui::core::Component >::cast(::hx::ObjectPtr<OBJ_>(this))->hasClass(HX_(":mobile",1c,94,54,2b))) {
...
void ComponentEvents_obj::_onMappedEvent( ::haxe::ui::events::UIEvent event){
            	HX_STACKFRAME(&_hx_pos_d6723378fb95a5c6_126__onMappedEvent)
HXDLIN( 126)		this->dispatch(event);
            	}
...
bool ComponentEvents_obj::isInteractiveEvent(::String type){
            	HX_STACKFRAME(&_hx_pos_d6723378fb95a5c6_137_isInteractiveEvent)
HXDLIN( 137)		return (::haxe::ui::core::ComponentEvents_obj::INTERACTIVE_EVENTS->indexOf(type,null()) != -1);
            	}
...
void ComponentEvents_obj::disableInteractivity(bool disable,::hx::Null< bool >  __o_recursive,::hx::Null< bool >  __o_updateStyle){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_d6723378fb95a5c6_142_disableInteractivity)
HXLINE( 143)		if ((disable == true)) {
HXLINE( 144)			this->_interactivityDisabledCounter++;
            		}
            		else {
HXLINE( 146)			this->_interactivityDisabledCounter--;
            		}
HXLINE( 149)		bool _hx_tmp;
HXDLIN( 149)		if ((this->_interactivityDisabledCounter > 0)) {
HXLINE( 149)			_hx_tmp = (this->_interactivityDisabled == false);
            		}
            		else {
HXLINE( 149)			_hx_tmp = false;
            		}
HXDLIN( 149)		if (_hx_tmp) {
HXLINE( 150)			this->_interactivityDisabled = true;
HXLINE( 151)			if ((updateStyle == true)) {
HXLINE( 152)				::hx::TCast<  ::haxe::ui::core::Component >::cast(::hx::ObjectPtr<OBJ_>(this))->swapClass(HX_(":disabled",b6,0b,b6,46),HX_(":hover",42,d3,17,5c),null(),null());
            			}
HXLINE( 154)			if (::hx::IsNotNull( this->_hx___events )) {
HXLINE( 155)				 ::Dynamic eventType = this->_hx___events->keys();
HXDLIN( 155)				while(( (bool)(eventType->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 155)					::String eventType1 = ( (::String)(eventType->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 156)					if (!(this->isInteractiveEvent(eventType1))) {
HXLINE( 157)						continue;
            					}
HXLINE( 159)					 ::haxe::ui::util::FunctionArray listeners = this->_hx___events->listeners(eventType1);
HXLINE( 160)					if (::hx::IsNotNull( listeners )) {
HXLINE( 161)						 ::Dynamic listener = listeners->copy()->iterator();
HXDLIN( 161)						while(( (bool)(listener->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 161)							 ::haxe::ui::util::_Listener::ListenerInternal listener1 = ( ( ::haxe::ui::util::_Listener::ListenerInternal)(listener->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 162)							if (::hx::IsNull( this->_disabledEvents )) {
HXLINE( 163)								this->_disabledEvents =  ::haxe::ui::util::EventMap_obj::__alloc( HX_CTX );
            							}
HXLINE( 165)							 ::haxe::ui::util::EventMap _hx_tmp = this->_disabledEvents;
HXDLIN( 165)							_hx_tmp->add(eventType1,::haxe::ui::util::_Listener::Listener_Impl__obj::toFunc(listener1),null());
HXLINE( 166)							this->unregisterEvent(eventType1,::haxe::ui::util::_Listener::Listener_Impl__obj::toFunc(listener1));
            						}
            					}
            				}
            			}
HXLINE( 171)			this->dispatch( ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,HX_("disabled",7c,41,04,7c),null(),null()));
            		}
            		else {
HXLINE( 172)			bool _hx_tmp;
HXDLIN( 172)			if ((this->_interactivityDisabledCounter < 1)) {
HXLINE( 172)				_hx_tmp = (this->_interactivityDisabled == true);
            			}
            			else {
HXLINE( 172)				_hx_tmp = false;
            			}
HXDLIN( 172)			if (_hx_tmp) {
HXLINE( 173)				this->_interactivityDisabled = false;
HXLINE( 174)				if ((updateStyle == true)) {
HXLINE( 175)					::hx::TCast<  ::haxe::ui::core::Component >::cast(::hx::ObjectPtr<OBJ_>(this))->removeClass(HX_(":disabled",b6,0b,b6,46),null(),null());
            				}
HXLINE( 177)				if (::hx::IsNotNull( this->_disabledEvents )) {
HXLINE( 178)					{
HXLINE( 178)						 ::Dynamic eventType = this->_disabledEvents->keys();
HXDLIN( 178)						while(( (bool)(eventType->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 178)							::String eventType1 = ( (::String)(eventType->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 179)							 ::haxe::ui::util::FunctionArray listeners = this->_disabledEvents->listeners(eventType1);
HXLINE( 180)							if (::hx::IsNotNull( listeners )) {
HXLINE( 181)								 ::Dynamic listener = listeners->copy()->iterator();
HXDLIN( 181)								while(( (bool)(listener->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 181)									 ::haxe::ui::util::_Listener::ListenerInternal listener1 = ( ( ::haxe::ui::util::_Listener::ListenerInternal)(listener->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 182)									this->registerEvent(eventType1,::haxe::ui::util::_Listener::Listener_Impl__obj::toFunc(listener1),null());
            								}
            							}
            						}
            					}
HXLINE( 186)					this->_disabledEvents = null();
            				}
HXLINE( 188)				this->dispatch( ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,HX_("enabled",81,04,31,7e),null(),null()));
            			}
            		}
HXLINE( 191)		if ((recursive == true)) {
HXLINE( 192)			int _g = 0;
HXDLIN( 192)			::Array< ::Dynamic> _g1;
HXDLIN( 192)			if (::hx::IsNull( this->_children )) {
HXLINE( 192)				_g1 = ::Array_obj< ::Dynamic>::__new(0);
            			}
            			else {
HXLINE( 192)				_g1 = this->_children;
            			}
HXDLIN( 192)			while((_g < _g1->length)){
HXLINE( 192)				 ::haxe::ui::core::Component child = _g1->__get(_g).StaticCast<  ::haxe::ui::core::Component >();
HXDLIN( 192)				_g = (_g + 1);
HXLINE( 193)				child->disableInteractivity(disable,recursive,updateStyle);
            			}
            		}
            	}
...
void ComponentEvents_obj::unregisterEvents(){
            	HX_STACKFRAME(&_hx_pos_d6723378fb95a5c6_199_unregisterEvents)
HXDLIN( 199)		if (::hx::IsNotNull( this->_hx___events )) {
HXLINE( 200)			::Array< ::String > copy = ::Array_obj< ::String >::__new(0);
HXLINE( 201)			{
HXLINE( 201)				 ::Dynamic eventType = this->_hx___events->keys();
HXDLIN( 201)				while(( (bool)(eventType->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 201)					::String eventType1 = ( (::String)(eventType->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 202)					copy->push(eventType1);
            				}
            			}
HXLINE( 204)			{
HXLINE( 204)				int _g = 0;
HXDLIN( 204)				while((_g < copy->length)){
HXLINE( 204)					::String eventType = copy->__get(_g);
HXDLIN( 204)					_g = (_g + 1);
HXLINE( 205)					 ::haxe::ui::util::FunctionArray listeners = this->_hx___events->listeners(eventType);
HXLINE( 206)					if (::hx::IsNotNull( listeners )) {
HXLINE( 207)						 ::Dynamic listener = listeners->iterator();
HXDLIN( 207)						while(( (bool)(listener->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 207)							 ::haxe::ui::util::_Listener::ListenerInternal listener1 = ( ( ::haxe::ui::util::_Listener::ListenerInternal)(listener->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 208)							if (::hx::IsNotNull( listener1 )) {
HXLINE( 209)								 ::haxe::ui::util::EventMap _hx_tmp = this->_hx___events;
HXDLIN( 209)								if ((_hx_tmp->remove(eventType,::haxe::ui::util::_Listener::Listener_Impl__obj::toFunc(listener1)) == true)) {
HXLINE( 210)									this->unmapEvent(eventType,this->_onMappedEvent_dyn());
            								}
            							}
            						}
            					}
...
void ComponentEvents_obj::pauseEvent(::String type,::hx::Null< bool >  __o_recursive){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_d6723378fb95a5c6_220_pauseEvent)
HXLINE( 221)		bool _hx_tmp;
HXDLIN( 221)		if (::hx::IsNotNull( this->_hx___events )) {
HXLINE( 221)			_hx_tmp = (this->_hx___events->contains(type,null()) == false);
            		}
            		else {
...
HXLINE( 225)		if (::hx::IsNull( this->_pausedEvents )) {
HXLINE( 226)			this->_pausedEvents =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            		}
HXLINE( 229)		::Array< ::Dynamic> pausedList = ( (::Array< ::Dynamic>)(this->_pausedEvents->get(type)) );
HXLINE( 230)		if (::hx::IsNull( pausedList )) {
HXLINE( 231)			pausedList = ::Array_obj< ::Dynamic>::__new();
HXLINE( 232)			this->_pausedEvents->set(type,pausedList);
            		}
HXLINE( 235)		 ::haxe::ui::util::FunctionArray listeners = this->_hx___events->listeners(type)->copy();
HXLINE( 236)		{
HXLINE( 236)			 ::Dynamic l = listeners->iterator();
HXDLIN( 236)			while(( (bool)(l->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 236)				 ::haxe::ui::util::_Listener::ListenerInternal l1 = ( ( ::haxe::ui::util::_Listener::ListenerInternal)(l->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 237)				pausedList->push(::haxe::ui::util::_Listener::Listener_Impl__obj::toFunc(l1));
HXLINE( 238)				this->unregisterEvent(type,::haxe::ui::util::_Listener::Listener_Impl__obj::toFunc(l1));
            			}
            		}
HXLINE( 241)		if ((recursive == true)) {
HXLINE( 242)			int _g = 0;
HXDLIN( 242)			::Array< ::Dynamic> _g1;
HXDLIN( 242)			if (::hx::IsNull( this->_children )) {
HXLINE( 242)				_g1 = ::Array_obj< ::Dynamic>::__new(0);
            			}
            			else {
HXLINE( 242)				_g1 = this->_children;
            			}
HXDLIN( 242)			while((_g < _g1->length)){
HXLINE( 242)				 ::haxe::ui::core::Component c = _g1->__get(_g).StaticCast<  ::haxe::ui::core::Component >();
HXDLIN( 242)				_g = (_g + 1);
HXLINE( 243)				c->pauseEvent(type,recursive);
            			}
            		}
            	}
...
void ComponentEvents_obj::resumeEvent(::String type,::hx::Null< bool >  __o_recursive){
            		...
            		void _hx_run(){
            			HX_STACKFRAME(&_hx_pos_d6723378fb95a5c6_261_resumeEvent)
HXLINE( 262)			::Array< ::Dynamic> pausedList = ( (::Array< ::Dynamic>)(_gthis->_pausedEvents->get(type)) );
HXLINE( 263)			{
HXLINE( 263)				int _g = 0;
HXDLIN( 263)				while((_g < pausedList->length)){
HXLINE( 263)					 ::Dynamic l = pausedList->__get(_g);
HXDLIN( 263)					_g = (_g + 1);
HXLINE( 264)					_gthis->registerEvent(type,l,null());
            				}
            			}
HXLINE( 266)			_gthis->_pausedEvents->remove(type);
            		}
            		HX_END_LOCAL_FUNC0((void))

            		bool recursive = __o_recursive.Default(false);
            	HX_STACKFRAME(&_hx_pos_d6723378fb95a5c6_248_resumeEvent)
HXDLIN( 248)		 ::haxe::ui::core::ComponentEvents _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 249)		if (::hx::IsNull( this->_hx___events )) {
HXLINE( 250)			return;
            		}
HXLINE( 253)		if (::hx::IsNull( this->_pausedEvents )) {
HXLINE( 254)			return;
            		}
HXLINE( 257)		if ((this->_pausedEvents->exists(type) == false)) {
HXLINE( 258)			return;
            		}
HXLINE( 261)		::haxe::ui::Toolkit_obj::callLater( ::Dynamic(new _hx_Closure_0(_gthis,type)));
HXLINE( 269)		if ((recursive == true)) {
HXLINE( 270)			int _g = 0;
HXDLIN( 270)			::Array< ::Dynamic> _g1;
HXDLIN( 270)			if (::hx::IsNull( this->_children )) {
HXLINE( 270)				_g1 = ::Array_obj< ::Dynamic>::__new(0);
            			}
            			else {
HXLINE( 270)				_g1 = this->_children;
            			}
HXDLIN( 270)			while((_g < _g1->length)){
HXLINE( 270)				 ::haxe::ui::core::Component c = _g1->__get(_g).StaticCast<  ::haxe::ui::core::Component >();
HXDLIN( 270)				_g = (_g + 1);
HXLINE( 271)				c->resumeEvent(type,recursive);
            			}
            		}
            	}
...
void ComponentEvents_obj::mapEvent(::String type, ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_d6723378fb95a5c6_276_mapEvent)
            	}
...
void ComponentEvents_obj::unmapEvent(::String type, ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_d6723378fb95a5c6_279_unmapEvent)
            	}
...
void ComponentEvents_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_e6d3650b25edf420_370_registerBehaviours)
HXDLIN( 370)		this->super::registerBehaviours();
            	}


 ::haxe::ui::core::ComponentContainer ComponentEvents_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_8ea004cf0546e5a7_525_cloneComponent)
HXLINE( 300)		 ::haxe::ui::core::ComponentEvents c = ( ( ::haxe::ui::core::ComponentEvents)(this->super::cloneComponent()) );
...
HXLINE( 323)		return c;
 ...
 ::haxe::ui::core::ComponentContainer ComponentEvents_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_e6d3650b25edf420_351_self)
HXDLIN( 351)		return  ::haxe::ui::core::ComponentEvents_obj::__alloc( HX_CTX );
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_d6723378fb95a5c6_130_boot)
HXDLIN( 130)		INTERACTIVE_EVENTS = ::Array_obj< ::String >::fromData( _hx_array_data_a3e25e99_37,10);
            	}
}
