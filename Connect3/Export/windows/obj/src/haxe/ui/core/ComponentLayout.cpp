...
HX_LOCAL_STACK_FRAME(_hx_pos_da6395d5bbe3de28_370_registerBehaviours,"haxe.ui.core.ComponentLayout","registerBehaviours",0xd3424f9d,"haxe.ui.core.ComponentLayout.registerBehaviours","haxe/ui/macros/Macros.hx",370,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_3e5439d44c46f422_525_cloneComponent,"haxe.ui.core.ComponentLayout","cloneComponent",0x67c95f64,"haxe.ui.core.ComponentLayout.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",525,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_da6395d5bbe3de28_351_self,"haxe.ui.core.ComponentLayout","self",0x8e1ae450,"haxe.ui.core.ComponentLayout.self","haxe/ui/macros/Macros.hx",351,0x27866361)
namespace haxe{
namespace ui{
namespace core{
...
void ComponentLayout_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_da6395d5bbe3de28_370_registerBehaviours)
HXDLIN( 370)		this->super::registerBehaviours();
            	}


 ::haxe::ui::core::ComponentContainer ComponentLayout_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_3e5439d44c46f422_525_cloneComponent)
HXLINE( 300)		 ::haxe::ui::core::ComponentLayout c = ( ( ::haxe::ui::core::ComponentLayout)(this->super::cloneComponent()) );
...
HXLINE( 323)		return c;
 ...
 ::haxe::ui::core::ComponentContainer ComponentLayout_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_da6395d5bbe3de28_351_self)
HXDLIN( 351)		return  ::haxe::ui::core::ComponentLayout_obj::__alloc( HX_CTX );
            	}
