...
HX_LOCAL_STACK_FRAME(_hx_pos_cf4a4c69f5e67911_111_invalidateComponentData,"haxe.ui.core.ComponentValidation","invalidateComponentData",0x64fb7f57,"haxe.ui.core.ComponentValidation.invalidateComponentData","haxe/ui/core/ComponentValidation.hx",111,0x3e0a56c6)
HX_LOCAL_STACK_FRAME(_hx_pos_cf4a4c69f5e67911_118_invalidateComponentLayout,"haxe.ui.core.ComponentValidation","invalidateComponentLayout",0x708f3d17,"haxe.ui.core.ComponentValidation.invalidateComponentLayout","haxe/ui/core/ComponentValidation.hx",118,0x3e0a56c6)
HX_LOCAL_STACK_FRAME(_hx_pos_cf4a4c69f5e67911_130_invalidateComponentPosition,"haxe.ui.core.ComponentValidation","invalidateComponentPosition",0x70636456,"haxe.ui.core.ComponentValidation.invalidateComponentPosition","haxe/ui/core/ComponentValidation.hx",130,0x3e0a56c6)
HX_LOCAL_STACK_FRAME(_hx_pos_cf4a4c69f5e67911_138_invalidateComponentDisplay,"haxe.ui.core.ComponentValidation","invalidateComponentDisplay",0x7f303b35,"haxe.ui.core.ComponentValidation.invalidateComponentDisplay","haxe/ui/core/ComponentValidation.hx",138,0x3e0a56c6)
HX_LOCAL_STACK_FRAME(_hx_pos_cf4a4c69f5e67911_145_invalidateComponentStyle,"haxe.ui.core.ComponentValidation","invalidateComponentStyle",0xa6a98364,"haxe.ui.core.ComponentValidation.invalidateComponentStyle","haxe/ui/core/ComponentValidation.hx",145,0x3e0a56c6)
HX_LOCAL_STACK_FRAME(_hx_pos_cf4a4c69f5e67911_156_validateComponent,"haxe.ui.core.ComponentValidation","validateComponent",0x8b896752,"haxe.ui.core.ComponentValidation.validateComponent","haxe/ui/core/ComponentValidation.hx",156,0x3e0a56c6)
...
HX_LOCAL_STACK_FRAME(_hx_pos_a570c1d5e8bdaaf4_370_registerBehaviours,"haxe.ui.core.ComponentValidation","registerBehaviours",0x182e476e,"haxe.ui.core.ComponentValidation.registerBehaviours","haxe/ui/macros/Macros.hx",370,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_3f98b65a2d10830f_525_cloneComponent,"haxe.ui.core.ComponentValidation","cloneComponent",0x2d66dab5,"haxe.ui.core.ComponentValidation.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",525,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_a570c1d5e8bdaaf4_351_self,"haxe.ui.core.ComponentValidation","self",0xe4284061,"haxe.ui.core.ComponentValidation.self","haxe/ui/macros/Macros.hx",351,0x27866361)
namespace haxe{
namespace ui{
namespace core{
...
HXLINE(  60)		bool isAlreadyInvalid = this->isComponentInvalid(null());
...
void ComponentValidation_obj::invalidateComponentData(){
            	HX_STACKFRAME(&_hx_pos_cf4a4c69f5e67911_111_invalidateComponentData)
HXDLIN( 111)		this->invalidateComponent(HX_("data",2a,56,63,42));
            	}
...
void ComponentValidation_obj::invalidateComponentLayout(){
            	HX_STACKFRAME(&_hx_pos_cf4a4c69f5e67911_118_invalidateComponentLayout)
HXLINE( 119)		bool _hx_tmp;
HXDLIN( 119)		if (::hx::IsNotNull( this->_layout )) {
HXLINE( 119)			_hx_tmp = (this->_layoutLocked == true);
            		}
            		else {
...
HXLINE( 122)		this->invalidateComponent(HX_("layout",aa,ae,b8,58));
            	}
...
void ComponentValidation_obj::invalidateComponentPosition(){
            	HX_STACKFRAME(&_hx_pos_cf4a4c69f5e67911_130_invalidateComponentPosition)
HXDLIN( 130)		this->invalidateComponent(HX_("position",a9,a0,fa,ca));
            	}
...
void ComponentValidation_obj::invalidateComponentDisplay(){
            	HX_STACKFRAME(&_hx_pos_cf4a4c69f5e67911_138_invalidateComponentDisplay)
HXDLIN( 138)		this->invalidateComponent(HX_("display",42,2a,4a,bb));
            	}
...
void ComponentValidation_obj::invalidateComponentStyle(::hx::Null< bool >  __o_force){
            	...
            	HX_STACKFRAME(&_hx_pos_cf4a4c69f5e67911_145_invalidateComponentStyle)
HXLINE( 146)		this->invalidateComponent(HX_("style",31,a5,1d,84));
HXLINE( 147)		if ((force == true)) {
HXLINE( 148)			this->_style = null();
            		}
            	}
...
void ComponentValidation_obj::validateComponent(::hx::Null< bool >  __o_nextFrame){
            	...
            	HX_STACKFRAME(&_hx_pos_cf4a4c69f5e67911_156_validateComponent)
HXLINE( 157)		bool _hx_tmp;
HXDLIN( 157)		bool _hx_tmp1;
HXDLIN( 157)		bool _hx_tmp2;
HXDLIN( 157)		if ((this->_ready != false)) {
HXLINE( 157)			_hx_tmp2 = (this->_isDisposed == true);
            		}
            		else {
HXLINE( 157)			_hx_tmp2 = true;
            		}
HXDLIN( 157)		if (!(_hx_tmp2)) {
HXLINE( 157)			_hx_tmp1 = (this->_isValidating == true);
            		}
            		else {
HXLINE( 157)			_hx_tmp1 = true;
            		}
HXDLIN( 157)		if (!(_hx_tmp1)) {
HXLINE( 157)			_hx_tmp = (this->isComponentInvalid(null()) == false);
            		}
            		else {
...
HXLINE( 164)		bool isInitialized = this->_isInitialized;
HXLINE( 165)		if ((isInitialized == false)) {
HXLINE( 166)			this->initializeComponent();
            		}
HXLINE( 169)		this->_isValidating = true;
HXLINE( 171)		this->validateComponentInternal(nextFrame);
HXLINE( 172)		this->validateInitialSize(isInitialized);
HXLINE( 174)		this->_invalidationFlags->clear();
HXLINE( 176)		this->_isAllInvalid = false;
HXLINE( 178)		{
HXLINE( 178)			 ::Dynamic flag = this->_delayedInvalidationFlags->keys();
HXDLIN( 178)			while(( (bool)(flag->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 178)				::String flag1 = ( (::String)(flag->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 179)				if ((flag1 == HX_("all",21,f9,49,00))) {
HXLINE( 180)					this->_isAllInvalid = true;
            				}
            				else {
HXLINE( 182)					this->_invalidationFlags->set(flag1,true);
            				}
            			}
            		}
HXLINE( 185)		this->_delayedInvalidationFlags->clear();
...
HXLINE( 216)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("The syncValidation returned too many times during validation. This may be an infinite loop. Try to avoid doing anything that calls invalidate() during validation.",be,8a,53,63)));
            			}
            		}
            	}
...
void ComponentValidation_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_a570c1d5e8bdaaf4_370_registerBehaviours)
HXDLIN( 370)		this->super::registerBehaviours();
            	}


 ::haxe::ui::core::ComponentContainer ComponentValidation_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_3f98b65a2d10830f_525_cloneComponent)
HXLINE( 300)		 ::haxe::ui::core::ComponentValidation c = ( ( ::haxe::ui::core::ComponentValidation)(this->super::cloneComponent()) );
...
HXLINE( 323)		return c;
 ...
 ::haxe::ui::core::ComponentContainer ComponentValidation_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_a570c1d5e8bdaaf4_351_self)
HXDLIN( 351)		return  ::haxe::ui::core::ComponentValidation_obj::__alloc( HX_CTX );
            	}
