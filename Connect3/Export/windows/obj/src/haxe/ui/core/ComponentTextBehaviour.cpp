...
HX_DEFINE_STACK_FRAME(_hx_pos_6471ceeb46000777_179_new,"haxe.ui.core.ComponentTextBehaviour","new",0xeb4d7142,"haxe.ui.core.ComponentTextBehaviour.new","haxe/ui/core/ComponentContainer.hx",179,0x0bbfc49c)
HX_LOCAL_STACK_FRAME(_hx_pos_6471ceeb46000777_180_set,"haxe.ui.core.ComponentTextBehaviour","set",0xeb513c84,"haxe.ui.core.ComponentTextBehaviour.set","haxe/ui/core/ComponentContainer.hx",180,0x0bbfc49c)
namespace haxe{
namespace ui{
namespace core{

void ComponentTextBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_6471ceeb46000777_179_new)
HXDLIN( 179)		super::__construct(component);
            	}
...
void ComponentTextBehaviour_obj::set( ::haxe::ui::util::VariantType value){
            	HX_STACKFRAME(&_hx_pos_6471ceeb46000777_180_set)
HXLINE( 181)		if (::haxe::ui::util::_Variant::Variant_Impl__obj::eq(value,this->_value)) {
HXLINE( 182)			return;
            		}
HXLINE( 185)		this->_value = value;
HXLINE( 187)		this->super::set(value);
            	}
