...
HX_DEFINE_STACK_FRAME(_hx_pos_1a995493925ebe68_263_new,"haxe.ui.core.ComponentToolTipRendererBehaviour","new",0x0f2c2009,"haxe.ui.core.ComponentToolTipRendererBehaviour.new","haxe/ui/core/ComponentContainer.hx",263,0x0bbfc49c)
HX_LOCAL_STACK_FRAME(_hx_pos_1a995493925ebe68_265_validateData,"haxe.ui.core.ComponentToolTipRendererBehaviour","validateData",0xd8b24917,"haxe.ui.core.ComponentToolTipRendererBehaviour.validateData","haxe/ui/core/ComponentContainer.hx",265,0x0bbfc49c)
namespace haxe{
namespace ui{
namespace core{

void ComponentToolTipRendererBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_1a995493925ebe68_263_new)
HXDLIN( 263)		super::__construct(component);
            	}
...
void ComponentToolTipRendererBehaviour_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_1a995493925ebe68_265_validateData)
HXDLIN( 265)		bool _hx_tmp;
HXDLIN( 265)		if (::hx::IsNotNull( this->_value )) {
HXDLIN( 265)			_hx_tmp = ::haxe::ui::util::_Variant::Variant_Impl__obj::get_isNull(this->_value);
            		}
            		else {
HXDLIN( 265)			_hx_tmp = true;
            		}
HXDLIN( 265)		if (_hx_tmp) {
HXLINE( 266)			::haxe::ui::tooltips::ToolTipManager_obj::get_instance()->updateTooltipRenderer(this->_component,null());
            		}
            		else {
HXLINE( 268)			 ::haxe::ui::tooltips::ToolTipManager _hx_tmp = ::haxe::ui::tooltips::ToolTipManager_obj::get_instance();
HXDLIN( 268)			 ::haxe::ui::core::Component _hx_tmp1 = this->_component;
HXDLIN( 268)			_hx_tmp->updateTooltipRenderer(_hx_tmp1,( ( ::haxe::ui::core::ItemRenderer)(::haxe::ui::util::_Variant::Variant_Impl__obj::toComponent(this->_value)) ));
            		}
            	}
