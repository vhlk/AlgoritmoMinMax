...
HX_DEFINE_STACK_FRAME(_hx_pos_a874a404e2c0a6ca_194_new,"haxe.ui.core.ComponentDisabledBehaviour","new",0x494b2713,"haxe.ui.core.ComponentDisabledBehaviour.new","haxe/ui/core/ComponentContainer.hx",194,0x0bbfc49c)
HX_LOCAL_STACK_FRAME(_hx_pos_a874a404e2c0a6ca_200_validateData,"haxe.ui.core.ComponentDisabledBehaviour","validateData",0x6ee310cd,"haxe.ui.core.ComponentDisabledBehaviour.validateData","haxe/ui/core/ComponentContainer.hx",200,0x0bbfc49c)
namespace haxe{
namespace ui{
namespace core{

void ComponentDisabledBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_a874a404e2c0a6ca_194_new)
HXLINE( 195)		super::__construct(component);
HXLINE( 196)		this->_value = ::haxe::ui::util::_Variant::Variant_Impl__obj::fromBool(false);
            	}
...
void ComponentDisabledBehaviour_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_a874a404e2c0a6ca_200_validateData)
HXDLIN( 200)		bool _hx_tmp;
HXDLIN( 200)		if (::hx::IsNotNull( this->_value )) {
HXDLIN( 200)			_hx_tmp = (::haxe::ui::util::_Variant::Variant_Impl__obj::get_isNull(this->_value) == false);
            		}
            		else {
HXDLIN( 200)			_hx_tmp = false;
            		}
HXDLIN( 200)		if (_hx_tmp) {
HXLINE( 201)			 ::haxe::ui::core::Component _hx_tmp = this->_component;
HXDLIN( 201)			_hx_tmp->disableInteractivity(::haxe::ui::util::_Variant::Variant_Impl__obj::toBool(this->_value),true,true);
            		}
            	}
