...
HX_DEFINE_STACK_FRAME(_hx_pos_dd22093398f84280_229_new,"haxe.ui.core.ComponentToolTipBehaviour","new",0xc29c7e4c,"haxe.ui.core.ComponentToolTipBehaviour.new","haxe/ui/core/ComponentContainer.hx",229,0x0bbfc49c)
HX_LOCAL_STACK_FRAME(_hx_pos_dd22093398f84280_231_validateData,"haxe.ui.core.ComponentToolTipBehaviour","validateData",0xe2c38a74,"haxe.ui.core.ComponentToolTipBehaviour.validateData","haxe/ui/core/ComponentContainer.hx",231,0x0bbfc49c)
HX_LOCAL_STACK_FRAME(_hx_pos_dd22093398f84280_242_setDynamic,"haxe.ui.core.ComponentToolTipBehaviour","setDynamic",0xf14ceb91,"haxe.ui.core.ComponentToolTipBehaviour.setDynamic","haxe/ui/core/ComponentContainer.hx",242,0x0bbfc49c)
HX_LOCAL_STACK_FRAME(_hx_pos_dd22093398f84280_252_getDynamic,"haxe.ui.core.ComponentToolTipBehaviour","getDynamic",0xedcf4d1d,"haxe.ui.core.ComponentToolTipBehaviour.getDynamic","haxe/ui/core/ComponentContainer.hx",252,0x0bbfc49c)
namespace haxe{
namespace ui{
namespace core{

void ComponentToolTipBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_dd22093398f84280_229_new)
...
void ComponentToolTipBehaviour_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_dd22093398f84280_231_validateData)
HXDLIN( 231)		bool _hx_tmp;
HXDLIN( 231)		if (::hx::IsNotNull( this->_value )) {
HXDLIN( 231)			_hx_tmp = ::haxe::ui::util::_Variant::Variant_Impl__obj::get_isNull(this->_value);
            		}
            		else {
HXDLIN( 231)			_hx_tmp = true;
            		}
HXDLIN( 231)		if (_hx_tmp) {
HXLINE( 232)			::haxe::ui::tooltips::ToolTipManager_obj::get_instance()->unregisterTooltip(this->_component);
            		}
            		else {
HXLINE( 234)			 ::haxe::ui::tooltips::ToolTipManager _hx_tmp = ::haxe::ui::tooltips::ToolTipManager_obj::get_instance();
HXDLIN( 234)			 ::haxe::ui::core::Component _hx_tmp1 = this->_component;
HXLINE( 235)			 ::Dynamic _hx_tmp2 = ::haxe::ui::util::_Variant::Variant_Impl__obj::toDynamic(this->_value);
HXLINE( 234)			_hx_tmp->registerTooltip(_hx_tmp1, ::Dynamic(::hx::Anon_obj::Create(2)
...
void ComponentToolTipBehaviour_obj::setDynamic( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_dd22093398f84280_242_setDynamic)
HXDLIN( 242)		if (::hx::IsNull( value )) {
...
HXDLIN( 245)			_hx_tmp->registerTooltip(_hx_tmp1, ::Dynamic(::hx::Anon_obj::Create(2)
            				->setFixed(0,HX_("renderer",43,c5,db,b2),( ( ::haxe::ui::core::ItemRenderer)(this->_component->get_tooltipRenderer()) ))
 ...
 ::Dynamic ComponentToolTipBehaviour_obj::getDynamic(){
            	HX_STACKFRAME(&_hx_pos_dd22093398f84280_252_getDynamic)
HXLINE( 253)		 ::Dynamic options = ::haxe::ui::tooltips::ToolTipManager_obj::get_instance()->getTooltipOptions(this->_component);
HXLINE( 254)		if (::hx::IsNull( options )) {
HXLINE( 255)			return null();
            		}
HXLINE( 257)		return  ::Dynamic(options->__Field(HX_("tipData",25,2d,50,7d),::hx::paccDynamic));
            	}
