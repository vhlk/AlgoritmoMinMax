...
HX_LOCAL_STACK_FRAME(_hx_pos_5f2f5f31431489cc_124_invalidateComponent,"haxe.ui.core.ImageDisplay","invalidateComponent",0x6be417b8,"haxe.ui.core.ImageDisplay.invalidateComponent","haxe/ui/core/ImageDisplay.hx",124,0x68d1df99)
HX_LOCAL_STACK_FRAME(_hx_pos_5f2f5f31431489cc_133_validateComponent,"haxe.ui.core.ImageDisplay","validateComponent",0xe8891bbd,"haxe.ui.core.ImageDisplay.validateComponent","haxe/ui/core/ImageDisplay.hx",133,0x68d1df99)
HX_LOCAL_STACK_FRAME(_hx_pos_5f2f5f31431489cc_151_handleValidate,"haxe.ui.core.ImageDisplay","handleValidate",0x5ba51428,"haxe.ui.core.ImageDisplay.handleValidate","haxe/ui/core/ImageDisplay.hx",151,0x68d1df99)
namespace haxe{
namespace ui{
namespace core{
...
void ImageDisplay_obj::invalidateComponent(::String __o_flag){
            		::String flag = __o_flag;
            		if (::hx::IsNull(__o_flag)) flag = HX_("all",21,f9,49,00);
            	HX_STACKFRAME(&_hx_pos_5f2f5f31431489cc_124_invalidateComponent)
HXDLIN( 124)		if ((flag == HX_("all",21,f9,49,00))) {
HXLINE( 125)			this->_isAllInvalid = true;
HXLINE( 126)			this->parentComponent->invalidateComponent(HX_("imageDisplay",27,a4,12,ab));
            		}
            		else {
HXLINE( 127)			if (!(this->_invalidationFlags->exists(flag))) {
HXLINE( 128)				this->_invalidationFlags->set(flag,true);
HXLINE( 129)				this->parentComponent->invalidateComponent(HX_("imageDisplay",27,a4,12,ab));
            			}
            		}
            	}
...
void ImageDisplay_obj::validateComponent(){
            	HX_STACKFRAME(&_hx_pos_5f2f5f31431489cc_133_validateComponent)
HXLINE( 134)		bool _hx_tmp;
HXDLIN( 134)		if ((this->_isValidating != true)) {
HXLINE( 134)			_hx_tmp = (this->isComponentInvalid(null()) == false);
            		}
            		else {
...
HXLINE( 139)		this->_isValidating = true;
HXLINE( 141)		this->handleValidate();
HXLINE( 143)		{
HXLINE( 143)			 ::Dynamic flag = this->_invalidationFlags->keys();
HXDLIN( 143)			while(( (bool)(flag->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 143)				::String flag1 = ( (::String)(flag->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 144)				this->_invalidationFlags->remove(flag1);
            			}
            		}
HXLINE( 147)		this->_isAllInvalid = false;
HXLINE( 148)		this->_isValidating = false;
            	}
...
void ImageDisplay_obj::handleValidate(){
            	HX_STACKFRAME(&_hx_pos_5f2f5f31431489cc_151_handleValidate)
HXLINE( 152)		bool dataInvalid = this->isComponentInvalid(HX_("data",2a,56,63,42));
HXLINE( 153)		bool positionInvalid = this->isComponentInvalid(HX_("position",a9,a0,fa,ca));
HXLINE( 154)		bool displayInvalid = this->isComponentInvalid(HX_("display",42,2a,4a,bb));
HXLINE( 156)		if (dataInvalid) {
HXLINE( 157)			this->validateData();
            		}
HXLINE( 160)		if (positionInvalid) {
HXLINE( 161)			this->validatePosition();
            		}
HXLINE( 164)		if (displayInvalid) {
HXLINE( 165)			this->validateDisplay();
            		}
            	}
