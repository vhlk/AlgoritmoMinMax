...
HX_DEFINE_STACK_FRAME(_hx_pos_d3bd601ce1a83b1a_208_new,"haxe.ui.core.ComponentValueBehaviour","new",0xf4e182fe,"haxe.ui.core.ComponentValueBehaviour.new","haxe/ui/core/ComponentContainer.hx",208,0x0bbfc49c)
HX_LOCAL_STACK_FRAME(_hx_pos_d3bd601ce1a83b1a_209_set,"haxe.ui.core.ComponentValueBehaviour","set",0xf4e54e40,"haxe.ui.core.ComponentValueBehaviour.set","haxe/ui/core/ComponentContainer.hx",209,0x0bbfc49c)
HX_LOCAL_STACK_FRAME(_hx_pos_d3bd601ce1a83b1a_219_get,"haxe.ui.core.ComponentValueBehaviour","get",0xf4dc3334,"haxe.ui.core.ComponentValueBehaviour.get","haxe/ui/core/ComponentContainer.hx",219,0x0bbfc49c)
HX_LOCAL_STACK_FRAME(_hx_pos_d3bd601ce1a83b1a_223_getDynamic,"haxe.ui.core.ComponentValueBehaviour","getDynamic",0x4d0622ab,"haxe.ui.core.ComponentValueBehaviour.getDynamic","haxe/ui/core/ComponentContainer.hx",223,0x0bbfc49c)
namespace haxe{
namespace ui{
namespace core{

void ComponentValueBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_d3bd601ce1a83b1a_208_new)
...
void ComponentValueBehaviour_obj::set( ::haxe::ui::util::VariantType value){
            	HX_STACKFRAME(&_hx_pos_d3bd601ce1a83b1a_209_set)
HXLINE( 210)		if (::haxe::ui::util::_Variant::Variant_Impl__obj::eq(value,this->_value)) {
HXLINE( 211)			return;
            		}
HXLINE( 214)		this->_value = value;
HXLINE( 215)		 ::haxe::ui::core::Component _hx_tmp = this->_component;
HXDLIN( 215)		_hx_tmp->set_text(::haxe::ui::util::_Variant::Variant_Impl__obj::toString(value));
            	}


 ::haxe::ui::util::VariantType ComponentValueBehaviour_obj::get(){
            	HX_STACKFRAME(&_hx_pos_d3bd601ce1a83b1a_219_get)
HXDLIN( 219)		return this->_value;
            	}


 ::Dynamic ComponentValueBehaviour_obj::getDynamic(){
            	HX_STACKFRAME(&_hx_pos_d3bd601ce1a83b1a_223_getDynamic)
HXDLIN( 223)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::toDynamic(this->_value);
            	}
