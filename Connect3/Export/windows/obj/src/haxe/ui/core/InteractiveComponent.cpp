...
HX_LOCAL_STACK_FRAME(_hx_pos_d4c0c1aa57b56fd7_369_registerBehaviours,"haxe.ui.core.InteractiveComponent","registerBehaviours",0xc7eaadcf,"haxe.ui.core.InteractiveComponent.registerBehaviours","haxe/ui/macros/Macros.hx",369,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_d4c0c1aa57b56fd7_388_get_allowInteraction,"haxe.ui.core.InteractiveComponent","get_allowInteraction",0x40b7aa48,"haxe.ui.core.InteractiveComponent.get_allowInteraction","haxe/ui/macros/Macros.hx",388,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_d4c0c1aa57b56fd7_431_set_allowInteraction,"haxe.ui.core.InteractiveComponent","set_allowInteraction",0x0d6f61bc,"haxe.ui.core.InteractiveComponent.set_allowInteraction","haxe/ui/macros/Macros.hx",431,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_a1a44ffe085454d1_525_cloneComponent,"haxe.ui.core.InteractiveComponent","cloneComponent",0x5e363c96,"haxe.ui.core.InteractiveComponent.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",525,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_d4c0c1aa57b56fd7_351_self,"haxe.ui.core.InteractiveComponent","self",0xf900af02,"haxe.ui.core.InteractiveComponent.self","haxe/ui/macros/Macros.hx",351,0x27866361)
namespace haxe{
namespace ui{
namespace core{
...
void InteractiveComponent_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_d4c0c1aa57b56fd7_369_registerBehaviours)
HXLINE( 370)		this->super::registerBehaviours();
HXLINE( 451)		 ::haxe::ui::behaviours::Behaviours _hx_tmp = this->behaviours;
HXDLIN( 451)		_hx_tmp->_hx_register(HX_("allowInteraction",c9,55,84,63),::hx::ClassOf< ::haxe::ui::behaviours::DefaultBehaviour >(),::haxe::ui::util::_Variant::Variant_Impl__obj::fromBool(true));
            	}


bool InteractiveComponent_obj::get_allowInteraction(){
            	HX_STACKFRAME(&_hx_pos_d4c0c1aa57b56fd7_388_get_allowInteraction)
HXDLIN( 388)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::toBool(this->behaviours->get(HX_("allowInteraction",c9,55,84,63)));
            	}
...
bool InteractiveComponent_obj::set_allowInteraction(bool value){
            	HX_GC_STACKFRAME(&_hx_pos_d4c0c1aa57b56fd7_431_set_allowInteraction)
HXLINE( 432)		 ::haxe::ui::behaviours::Behaviours _hx_tmp = this->behaviours;
HXDLIN( 432)		_hx_tmp->set(HX_("allowInteraction",c9,55,84,63),::haxe::ui::util::_Variant::Variant_Impl__obj::fromBool(value));
HXLINE( 433)		this->dispatch( ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,HX_("propertyChange",a5,bb,45,6a),null(),HX_("allowInteraction",c9,55,84,63)));
HXLINE( 244)		::haxe::ui::binding::BindingManager_obj::get_instance()->componentPropChanged(( ( ::haxe::ui::core::Component)(::hx::ObjectPtr<OBJ_>(this)) ),HX_("allowInteraction",c9,55,84,63));
...
HX_DEFINE_DYNAMIC_FUNC1(InteractiveComponent_obj,set_allowInteraction,return )
 ...
 ::haxe::ui::core::ComponentContainer InteractiveComponent_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_a1a44ffe085454d1_525_cloneComponent)
HXLINE( 300)		 ::haxe::ui::core::InteractiveComponent c = ( ( ::haxe::ui::core::InteractiveComponent)(this->super::cloneComponent()) );
HXLINE( 311)		c->set_allowInteraction(this->get_allowInteraction());
...
HXLINE( 323)		return c;
 ...
 ::haxe::ui::core::ComponentContainer InteractiveComponent_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_d4c0c1aa57b56fd7_351_self)
HXDLIN( 351)		return  ::haxe::ui::core::InteractiveComponent_obj::__alloc( HX_CTX );
            	}
