...
HXLINE( 271)						 ::Dynamic _hx_tmp1 = child->get_left();
HXDLIN( 271)						_hx_tmp = ((_hx_tmp1 + child->get_componentWidth()) > x2);
            					}
            					else {
...
HXLINE( 280)						 ::Dynamic _hx_tmp1 = child->get_top();
HXDLIN( 280)						_hx_tmp = ((_hx_tmp1 + child->get_componentHeight()) > y2);
            					}
            					else {
...
HXLINE( 296)		if (::Std_obj::isOfType(::hx::ObjectPtr<OBJ_>(this),::hx::ClassOf< ::haxe::ui::layouts::AbsoluteLayout >())) {
HXLINE( 297)			w1 = (w1 + x1);
HXLINE( 298)			h1 = (h1 + y1);
            		}
