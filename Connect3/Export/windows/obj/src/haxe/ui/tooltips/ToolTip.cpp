...
HX_LOCAL_STACK_FRAME(_hx_pos_e9aa94cb32746db5_370_registerBehaviours,"haxe.ui.tooltips.ToolTip","registerBehaviours",0x269f6670,"haxe.ui.tooltips.ToolTip.registerBehaviours","haxe/ui/macros/Macros.hx",370,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_766e39e3e38d89c6_525_cloneComponent,"haxe.ui.tooltips.ToolTip","cloneComponent",0x4a57d0b7,"haxe.ui.tooltips.ToolTip.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",525,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_e9aa94cb32746db5_351_self,"haxe.ui.tooltips.ToolTip","self",0x1ce1ffe3,"haxe.ui.tooltips.ToolTip.self","haxe/ui/macros/Macros.hx",351,0x27866361)
namespace haxe{
namespace ui{
namespace tooltips{
...
void ToolTip_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_e9aa94cb32746db5_370_registerBehaviours)
HXDLIN( 370)		this->super::registerBehaviours();
            	}


 ::haxe::ui::core::ComponentContainer ToolTip_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_766e39e3e38d89c6_525_cloneComponent)
HXLINE( 300)		 ::haxe::ui::tooltips::ToolTip c = ( ( ::haxe::ui::tooltips::ToolTip)(this->super::cloneComponent()) );
...
HXLINE( 323)		return c;
 ...
 ::haxe::ui::core::ComponentContainer ToolTip_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_e9aa94cb32746db5_351_self)
HXDLIN( 351)		return  ::haxe::ui::tooltips::ToolTip_obj::__alloc( HX_CTX );
            	}
