...
void StyleSheet_obj::removeAllRules(){
            	HX_STACKFRAME(&_hx_pos_c9f3dffb44669258_65_removeAllRules)
HXDLIN(  65)		this->_rules = ::Array_obj< ::Dynamic>::__new(0);
            	}
...
HXLINE(  70)		this->_imports = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  71)		this->_mediaQueries = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  72)		this->_animations =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            	}
...
void StyleSheet_obj::merge( ::haxe::ui::styles::StyleSheet styleSheet){
            	HX_STACKFRAME(&_hx_pos_c9f3dffb44669258_101_merge)
HXLINE( 102)		this->_imports = this->_imports->concat(styleSheet->_imports);
HXLINE( 103)		this->_rules = this->_rules->concat(styleSheet->_rules);
HXLINE( 104)		this->_mediaQueries = this->_mediaQueries->concat(styleSheet->_mediaQueries);
HXLINE( 105)		{
...
HXLINE( 112)			style =  ::haxe::ui::styles::Style_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
            		}
HXLINE( 114)		{
HXLINE( 114)			int _g = 0;
