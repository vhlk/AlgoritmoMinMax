...
HX_DEFINE_STACK_FRAME(_hx_pos_28943a1499ce47e8_12_new,"haxe.ui.styles.animation.util.ActuatorOptions","new",0x7f42982f,"haxe.ui.styles.animation.util.ActuatorOptions.new","haxe/ui/styles/animation/util/Actuator.hx",12,0xdc64e2fe)
namespace haxe{
namespace ui{
namespace styles{
namespace animation{
...
void ActuatorOptions_obj::__construct( ::Dynamic delay, ::haxe::ui::styles::EasingFunction easingFunction, ::Dynamic onComplete, ::Dynamic onUpdate){
            	HX_STACKFRAME(&_hx_pos_28943a1499ce47e8_12_new)
HXDLIN(  12)		this->delay = delay;
HXDLIN(  12)		this->easingFunction = easingFunction;
HXDLIN(  12)		this->onComplete = onComplete;
HXDLIN(  12)		this->onUpdate = onUpdate;
            	}
