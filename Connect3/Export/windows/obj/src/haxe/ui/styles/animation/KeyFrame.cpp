...
void KeyFrame_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_a8d5c98c92ede0c6_7_new)
HXLINE(  10)		this->delay = ((Float)0);
HXLINE(   9)		this->time = ((Float)0);
HXLINE(   8)		this->directives = ::Array_obj< ::Dynamic>::__new(0);
            	}
...
void KeyFrame_obj::stop(){
            	HX_STACKFRAME(&_hx_pos_a8d5c98c92ede0c6_19_stop)
HXDLIN(  19)		if (::hx::IsNotNull( this->_actuator )) {
HXLINE(  20)			this->_actuator->stop();
HXLINE(  21)			this->_actuator = null();
            		}
            	}
...
void KeyFrame_obj::run( ::Dynamic target, ::Dynamic cb){
            		...
            		void _hx_run(){
            			HX_STACKFRAME(&_hx_pos_a8d5c98c92ede0c6_38_run)
HXLINE(  39)			_gthis->_actuator = null();
HXLINE(  40)			cb();
            		}
...
HXDLIN(  35)		this->_actuator =  ::haxe::ui::styles::animation::util::Actuator_obj::__alloc( HX_CTX ,target,properties,_hx_tmp, ::haxe::ui::styles::animation::util::ActuatorOptions_obj::__alloc( HX_CTX ,this->delay,this->easingFunction, ::Dynamic(new _hx_Closure_0(_gthis,cb)),null()));
