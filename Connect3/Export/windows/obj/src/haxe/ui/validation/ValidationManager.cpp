...
HX_LOCAL_STACK_FRAME(_hx_pos_4cd6909a403eb58f_104_process,"haxe.ui.validation.ValidationManager","process",0xbb7dd8b2,"haxe.ui.validation.ValidationManager.process","haxe/ui/validation/ValidationManager.hx",104,0xc7e02f8e)
HX_LOCAL_STACK_FRAME(_hx_pos_4cd6909a403eb58f_143_queueSortFunction,"haxe.ui.validation.ValidationManager","queueSortFunction",0xbeec53ca,"haxe.ui.validation.ValidationManager.queueSortFunction","haxe/ui/validation/ValidationManager.hx",143,0xc7e02f8e)
...
void ValidationManager_obj::process(){
            	HX_GC_STACKFRAME(&_hx_pos_4cd6909a403eb58f_104_process)
HXLINE( 105)		bool _hx_tmp;
HXDLIN( 105)		if ((this->isValidating != true)) {
HXLINE( 105)			_hx_tmp = (this->isPending == false);
            		}
            		else {
...
HXLINE( 109)		int queueLength = this->_queue->length;
HXLINE( 110)		if ((queueLength == 0)) {
HXLINE( 111)			this->isPending = false;
HXLINE( 112)			return;
            		}
HXLINE( 115)		this->isValidating = true;
HXLINE( 116)		if ((queueLength > 1)) {
HXLINE( 117)			this->_queue->sort(this->queueSortFunction_dyn());
            		}
HXLINE( 120)		this->dispatch( ::haxe::ui::events::ValidationEvent_obj::__alloc( HX_CTX ,HX_("ValidationStart",49,f1,63,8d)));
HXLINE( 123)		while((this->_queue->length > 0)){
HXLINE( 124)			::Dynamic item = this->_queue->shift();
HXLINE( 125)			if ((::haxe::ui::validation::IValidating_obj::get_depth(item) < 0)) {
HXLINE( 126)				continue;
            			}
HXLINE( 128)			::haxe::ui::validation::IValidating_obj::validateComponent(item,null());
            		}
HXLINE( 131)		{
HXLINE( 131)			int _g = 0;
HXDLIN( 131)			int _g1 = this->_displayQueue->length;
HXDLIN( 131)			while((_g < _g1)){
HXLINE( 131)				_g = (_g + 1);
HXDLIN( 131)				int i = (_g - 1);
HXLINE( 132)				 ::haxe::ui::core::Component item = this->_displayQueue->__get(i).StaticCast<  ::haxe::ui::core::Component >();
HXLINE( 133)				item->updateComponentDisplay();
            			}
            		}
HXLINE( 135)		this->_displayQueue->removeRange(0,this->_displayQueue->length);
HXLINE( 137)		this->isValidating = false;
HXLINE( 138)		this->isPending = false;
HXLINE( 140)		this->dispatch( ::haxe::ui::events::ValidationEvent_obj::__alloc( HX_CTX ,HX_("ValidationStop",fb,cc,c4,5e)));
            	}
...
int ValidationManager_obj::queueSortFunction(::Dynamic first,::Dynamic second){
            	HX_STACKFRAME(&_hx_pos_4cd6909a403eb58f_143_queueSortFunction)
HXLINE( 144)		int difference = ::haxe::ui::validation::IValidating_obj::get_depth(second);
HXDLIN( 144)		int difference1 = (difference - ::haxe::ui::validation::IValidating_obj::get_depth(first));
HXLINE( 146)		if ((difference1 > 0)) {
HXLINE( 146)			return 1;
            		}
            		else {
HXLINE( 146)			if ((difference1 < 0)) {
