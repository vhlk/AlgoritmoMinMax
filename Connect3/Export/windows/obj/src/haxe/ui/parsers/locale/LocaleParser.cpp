...
HX_LOCAL_STACK_FRAME(_hx_pos_d63ac6a12e620884_36_register,"haxe.ui.parsers.locale.LocaleParser","register",0xa5a6ef70,"haxe.ui.parsers.locale.LocaleParser.register","haxe/ui/parsers/locale/LocaleParser.hx",36,0x8f81ecdd)
namespace haxe{
namespace ui{
namespace parsers{
namespace locale{
...
HXDLIN(  30)		if (::hx::IsNull( ::haxe::ui::parsers::locale::LocaleParser_obj::_parsers )) {
HXLINE(  31)			::haxe::ui::parsers::locale::LocaleParser_obj::_hx_register(HX_("properties",f3,fb,0e,61),::hx::ClassOf< ::haxe::ui::parsers::locale::PropertiesParser >());
HXLINE(  32)			::haxe::ui::parsers::locale::LocaleParser_obj::_hx_register(HX_("po",ff,61,00,00),::hx::ClassOf< ::haxe::ui::parsers::locale::PoParser >());
            		}
            	}
...
void LocaleParser_obj::_hx_register(::String extension,::hx::Class cls){
            	HX_GC_STACKFRAME(&_hx_pos_d63ac6a12e620884_36_register)
HXLINE(  37)		if (::hx::IsNull( ::haxe::ui::parsers::locale::LocaleParser_obj::_parsers )) {
HXLINE(  38)			::haxe::ui::parsers::locale::LocaleParser_obj::_parsers =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            		}
HXLINE(  40)		::haxe::ui::parsers::locale::LocaleParser_obj::_parsers->set(extension,cls);
            	}
