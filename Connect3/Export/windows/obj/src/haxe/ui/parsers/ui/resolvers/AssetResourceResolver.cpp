...
HX_DEFINE_STACK_FRAME(_hx_pos_69e0556202e040b5_9_new,"haxe.ui.parsers.ui.resolvers.AssetResourceResolver","new",0x783b1dc7,"haxe.ui.parsers.ui.resolvers.AssetResourceResolver.new","haxe/ui/parsers/ui/resolvers/AssetResourceResolver.hx",9,0x3a16768a)
HX_LOCAL_STACK_FRAME(_hx_pos_69e0556202e040b5_20_getResourceData,"haxe.ui.parsers.ui.resolvers.AssetResourceResolver","getResourceData",0xd949ffb5,"haxe.ui.parsers.ui.resolvers.AssetResourceResolver.getResourceData","haxe/ui/parsers/ui/resolvers/AssetResourceResolver.hx",20,0x3a16768a)
namespace haxe{
namespace ui{
namespace parsers{
namespace ui{
...
void AssetResourceResolver_obj::__construct(::String rootFile, ::haxe::ds::StringMap params){
            	HX_STACKFRAME(&_hx_pos_69e0556202e040b5_9_new)
HXLINE(  10)		super::__construct(params);
HXLINE(  11)		this->_rootFile = rootFile;
HXLINE(  12)		::Array< ::String > arr = this->_rootFile.split(HX_("/",2f,00,00,00));
HXLINE(  13)		arr->pop();
HXLINE(  14)		this->_rootDir = arr->join(HX_("/",2f,00,00,00));
HXLINE(  15)		if ((arr->length > 1)) {
HXLINE(  16)			 ::haxe::ui::parsers::ui::resolvers::AssetResourceResolver _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  16)			_hx_tmp->_rootDir = (_hx_tmp->_rootDir + HX_("/",2f,00,00,00));
            		}
            	}
...
bool AssetResourceResolver_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x3e9c4b73) {
		return inClassId==(int)0x00000001 || inClassId==(int)0x3e9c4b73;
	} else {
		return inClassId==(int)0x4cf8d425;
	}
}

::String AssetResourceResolver_obj::getResourceData(::String r){
            	HX_STACKFRAME(&_hx_pos_69e0556202e040b5_20_getResourceData)
HXLINE(  21)		::String f = ::haxe::io::Path_obj::normalize((this->_rootDir + r));
HXLINE(  22)		return ::haxe::ui::ToolkitAssets_obj::get_instance()->getText(f);
            	}
