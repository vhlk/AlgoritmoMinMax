...
HX_DEFINE_STACK_FRAME(_hx_pos_c8939703bfe92536_15_new,"haxe.ui.focus.FocusInfo","new",0xf0315150,"haxe.ui.focus.FocusInfo.new","haxe/ui/focus/FocusManager.hx",15,0xe315a5e0)
namespace haxe{
namespace ui{
namespace focus{
...
bool FocusInfo_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x33af674c;
}
