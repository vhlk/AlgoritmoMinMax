...
bool ConditionEvaluator_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x55a7384d;
}
...
HXLINE(  18)		::haxe::ui::scripting::ConditionEvaluator_obj::_interp->variables->set(HX_("Backend",f4,e3,d8,c8),( ( ::Dynamic)(::hx::ClassOf< ::haxe::ui::Backend >()) ));
HXLINE(  19)		{
