...
HX_DEFINE_STACK_FRAME(_hx_pos_d4054368603de3d5_71_new,"haxe.http.HttpBase","new",0x98384fa9,"haxe.http.HttpBase.new","D:\\Victor\\Haxe\\haxe\\std/haxe/http/HttpBase.hx",71,0x176868ac)
HX_LOCAL_STACK_FRAME(_hx_pos_d4054368603de3d5_196___default_onData,"haxe.http.HttpBase","__default_onData",0xb2f8141e,"haxe.http.HttpBase.__default_onData","D:\\Victor\\Haxe\\haxe\\std/haxe/http/HttpBase.hx",196,0x176868ac)
HX_LOCAL_STACK_FRAME(_hx_pos_d4054368603de3d5_205___default_onBytes,"haxe.http.HttpBase","__default_onBytes",0xcf297ff7,"haxe.http.HttpBase.__default_onBytes","D:\\Victor\\Haxe\\haxe\\std/haxe/http/HttpBase.hx",205,0x176868ac)
HX_LOCAL_STACK_FRAME(_hx_pos_d4054368603de3d5_214___default_onError,"haxe.http.HttpBase","__default_onError",0x84bb4354,"haxe.http.HttpBase.__default_onError","D:\\Victor\\Haxe\\haxe\\std/haxe/http/HttpBase.hx",214,0x176868ac)
HX_LOCAL_STACK_FRAME(_hx_pos_d4054368603de3d5_223___default_onStatus,"haxe.http.HttpBase","__default_onStatus",0x53b30a26,"haxe.http.HttpBase.__default_onStatus","D:\\Victor\\Haxe\\haxe\\std/haxe/http/HttpBase.hx",223,0x176868ac)
HX_LOCAL_STACK_FRAME(_hx_pos_d4054368603de3d5_229_hasOnData,"haxe.http.HttpBase","hasOnData",0xc242adec,"haxe.http.HttpBase.hasOnData","D:\\Victor\\Haxe\\haxe\\std/haxe/http/HttpBase.hx",229,0x176868ac)
HX_LOCAL_STACK_FRAME(_hx_pos_d4054368603de3d5_232_success,"haxe.http.HttpBase","success",0xfe1e7d8c,"haxe.http.HttpBase.success","D:\\Victor\\Haxe\\haxe\\std/haxe/http/HttpBase.hx",232,0x176868ac)
HX_LOCAL_STACK_FRAME(_hx_pos_d4054368603de3d5_241_get_responseData,"haxe.http.HttpBase","get_responseData",0x92ecd8eb,"haxe.http.HttpBase.get_responseData","D:\\Victor\\Haxe\\haxe\\std/haxe/http/HttpBase.hx",241,0x176868ac)
namespace haxe{
namespace http{

void HttpBase_obj::__construct(::String url){
            	HX_STACKFRAME(&_hx_pos_d4054368603de3d5_71_new)
...
void _hx_run(::String data){
            	HX_STACKFRAME(&_hx_pos_d4054368603de3d5_196___default_onData)
            	}
...
void _hx_run( ::haxe::io::Bytes data){
            	HX_STACKFRAME(&_hx_pos_d4054368603de3d5_205___default_onBytes)
            	}
HX_END_LOCAL_FUNC1((void))
HX_END_DEFAULT_FUNC
...
void _hx_run(::String msg){
            	HX_STACKFRAME(&_hx_pos_d4054368603de3d5_214___default_onError)
            	}
HX_END_LOCAL_FUNC1((void))
HX_END_DEFAULT_FUNC
...
void _hx_run(int status){
            	HX_STACKFRAME(&_hx_pos_d4054368603de3d5_223___default_onStatus)
            	}
HX_END_LOCAL_FUNC1((void))
HX_END_DEFAULT_FUNC

bool HttpBase_obj::hasOnData(){
            	HX_STACKFRAME(&_hx_pos_d4054368603de3d5_229_hasOnData)
...
void HttpBase_obj::success( ::haxe::io::Bytes data){
            	HX_STACKFRAME(&_hx_pos_d4054368603de3d5_232_success)
...
::String HttpBase_obj::get_responseData(){
            	HX_STACKFRAME(&_hx_pos_d4054368603de3d5_241_get_responseData)
