...
HX_DEFINE_STACK_FRAME(_hx_pos_0106f0cb25922a75_5_new,"haxe.Exception","new",0xa32fba59,"haxe.Exception.new","D:\\Victor\\Haxe\\haxe\\std/cpp/_std/haxe/Exception.hx",5,0xbb1ed9b4)
HX_LOCAL_STACK_FRAME(_hx_pos_0106f0cb25922a75_49_unwrap,"haxe.Exception","unwrap",0x6c26184a,"haxe.Exception.unwrap","D:\\Victor\\Haxe\\haxe\\std/cpp/_std/haxe/Exception.hx",49,0xbb1ed9b4)
HX_LOCAL_STACK_FRAME(_hx_pos_0106f0cb25922a75_53_toString,"haxe.Exception","toString",0x11a32013,"haxe.Exception.toString","D:\\Victor\\Haxe\\haxe\\std/cpp/_std/haxe/Exception.hx",53,0xbb1ed9b4)
HX_LOCAL_STACK_FRAME(_hx_pos_0106f0cb25922a75_67_get_message,"haxe.Exception","get_message",0x7b47a0d7,"haxe.Exception.get_message","D:\\Victor\\Haxe\\haxe\\std/cpp/_std/haxe/Exception.hx",67,0xbb1ed9b4)
HX_LOCAL_STACK_FRAME(_hx_pos_0106f0cb25922a75_75_get_native,"haxe.Exception","get_native",0xdd187087,"haxe.Exception.get_native","D:\\Victor\\Haxe\\haxe\\std/cpp/_std/haxe/Exception.hx",75,0xbb1ed9b4)
HX_LOCAL_STACK_FRAME(_hx_pos_0106f0cb25922a75_19_caught,"haxe.Exception","caught",0xbc294f23,"haxe.Exception.caught","D:\\Victor\\Haxe\\haxe\\std/cpp/_std/haxe/Exception.hx",19,0xbb1ed9b4)
HX_LOCAL_STACK_FRAME(_hx_pos_0106f0cb25922a75_27_thrown,"haxe.Exception","thrown",0x8e12fc2f,"haxe.Exception.thrown","D:\\Victor\\Haxe\\haxe\\std/cpp/_std/haxe/Exception.hx",27,0xbb1ed9b4)
namespace haxe{

void Exception_obj::__construct(::String message, ::haxe::Exception previous, ::Dynamic native){
            	HX_STACKFRAME(&_hx_pos_0106f0cb25922a75_5_new)
...
bool Exception_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Exception_obj::unwrap(){
            	HX_STACKFRAME(&_hx_pos_0106f0cb25922a75_49_unwrap)
...
::String Exception_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_0106f0cb25922a75_53_toString)
...
::String Exception_obj::get_message(){
            	HX_STACKFRAME(&_hx_pos_0106f0cb25922a75_67_get_message)
...
HX_DEFINE_DYNAMIC_FUNC0(Exception_obj,get_message,return )
 ...
 ::Dynamic Exception_obj::get_native(){
            	HX_STACKFRAME(&_hx_pos_0106f0cb25922a75_75_get_native)
...
HX_DEFINE_DYNAMIC_FUNC0(Exception_obj,get_native,return )
 ...
 ::haxe::Exception Exception_obj::caught( ::Dynamic value){
            	HX_GC_STACKFRAME(&_hx_pos_0106f0cb25922a75_19_caught)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Exception_obj,caught,return )
 ...
 ::Dynamic Exception_obj::thrown( ::Dynamic value){
            	HX_GC_STACKFRAME(&_hx_pos_0106f0cb25922a75_27_thrown)
