...
HX_DEFINE_STACK_FRAME(_hx_pos_b3644ee7837c4748_512_new,"haxe._Unserializer.DefaultResolver","new",0xe2809ead,"haxe._Unserializer.DefaultResolver.new","D:\\Victor\\Haxe\\haxe\\std/haxe/Unserializer.hx",512,0xc3a648a5)
HX_LOCAL_STACK_FRAME(_hx_pos_b3644ee7837c4748_515_resolveClass,"haxe._Unserializer.DefaultResolver","resolveClass",0xbc0d3dbf,"haxe._Unserializer.DefaultResolver.resolveClass","D:\\Victor\\Haxe\\haxe\\std/haxe/Unserializer.hx",515,0xc3a648a5)
HX_LOCAL_STACK_FRAME(_hx_pos_b3644ee7837c4748_518_resolveEnum,"haxe._Unserializer.DefaultResolver","resolveEnum",0x8198f35a,"haxe._Unserializer.DefaultResolver.resolveEnum","D:\\Victor\\Haxe\\haxe\\std/haxe/Unserializer.hx",518,0xc3a648a5)
namespace haxe{
namespace _Unserializer{

void DefaultResolver_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_b3644ee7837c4748_512_new)
            	}
...
::hx::Class DefaultResolver_obj::resolveClass(::String name){
            	HX_STACKFRAME(&_hx_pos_b3644ee7837c4748_515_resolveClass)
...
::hx::Class DefaultResolver_obj::resolveEnum(::String name){
            	HX_STACKFRAME(&_hx_pos_b3644ee7837c4748_518_resolveEnum)
