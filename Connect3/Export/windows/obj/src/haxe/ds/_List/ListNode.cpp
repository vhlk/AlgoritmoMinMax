...
HX_DEFINE_STACK_FRAME(_hx_pos_7a2ff262274d5e9d_266_new,"haxe.ds._List.ListNode","new",0x5847787a,"haxe.ds._List.ListNode.new","D:\\Victor\\Haxe\\haxe\\std/haxe/ds/List.hx",266,0xb36e092e)
namespace haxe{
namespace ds{
namespace _List{

void ListNode_obj::__construct( ::Dynamic item, ::haxe::ds::_List::ListNode next){
            	HX_STACKFRAME(&_hx_pos_7a2ff262274d5e9d_266_new)
