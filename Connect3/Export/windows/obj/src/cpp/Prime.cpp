...
HX_LOCAL_STACK_FRAME(_hx_pos_d3d1d1dc7cfaa304_34__loadPrime,"cpp.Prime","_loadPrime",0xdd360794,"cpp.Prime._loadPrime","D:\\Victor\\Haxe\\haxe\\std/cpp/Prime.hx",34,0xebe22a26)
namespace cpp{
...
bool Prime_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Prime_obj::_loadPrime(::String lib,::String prim,::String signature,::hx::Null< bool >  __o_quietFail){
            	...
            	HX_STACKFRAME(&_hx_pos_d3d1d1dc7cfaa304_34__loadPrime)
