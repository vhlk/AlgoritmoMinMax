...
HX_LOCAL_STACK_FRAME(_hx_pos_efe3fd5d2a0c04cf_30_getContent,"sys.io.File","getContent",0xb28b4a0e,"sys.io.File.getContent","D:\\Victor\\Haxe\\haxe\\std/cpp/_std/sys/io/File.hx",30,0x93382dbf)
HX_LOCAL_STACK_FRAME(_hx_pos_efe3fd5d2a0c04cf_33_getBytes,"sys.io.File","getBytes",0xbe457600,"sys.io.File.getBytes","D:\\Victor\\Haxe\\haxe\\std/cpp/_std/sys/io/File.hx",33,0x93382dbf)
HX_LOCAL_STACK_FRAME(_hx_pos_efe3fd5d2a0c04cf_51_read,"sys.io.File","read",0x203d07e1,"sys.io.File.read","D:\\Victor\\Haxe\\haxe\\std/cpp/_std/sys/io/File.hx",51,0x93382dbf)
namespace sys{
namespace io{
...
::String File_obj::getContent(::String path){
            	HX_STACKFRAME(&_hx_pos_efe3fd5d2a0c04cf_30_getContent)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(File_obj,getContent,return )
 ...
 ::haxe::io::Bytes File_obj::getBytes(::String path){
            	HX_STACKFRAME(&_hx_pos_efe3fd5d2a0c04cf_33_getBytes)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(File_obj,getBytes,return )
 ...
 ::sys::io::FileInput File_obj::read(::String path,::hx::Null< bool >  __o_binary){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_efe3fd5d2a0c04cf_51_read)
