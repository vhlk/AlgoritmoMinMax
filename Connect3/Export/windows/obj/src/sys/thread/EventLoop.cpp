...
HX_DEFINE_STACK_FRAME(_hx_pos_eba3afe5e96bf5a3_24_new,"sys.thread.EventLoop","new",0xafe12fcd,"sys.thread.EventLoop.new","D:\\Victor\\Haxe\\haxe\\std/sys/thread/EventLoop.hx",24,0x1f760ec8)
HX_LOCAL_STACK_FRAME(_hx_pos_eba3afe5e96bf5a3_147_loop,"sys.thread.EventLoop","loop",0x33ddc657,"sys.thread.EventLoop.loop","D:\\Victor\\Haxe\\haxe\\std/sys/thread/EventLoop.hx",147,0x1f760ec8)
namespace sys{
namespace thread{

void EventLoop_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_eba3afe5e96bf5a3_24_new)
...
void EventLoop_obj::loop(){
            	HX_STACKFRAME(&_hx_pos_eba3afe5e96bf5a3_147_loop)
