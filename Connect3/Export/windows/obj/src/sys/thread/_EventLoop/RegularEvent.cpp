...
HX_DEFINE_STACK_FRAME(_hx_pos_afedbd938a05bbc5_240_new,"sys.thread._EventLoop.RegularEvent","new",0x9d3b475c,"sys.thread._EventLoop.RegularEvent.new","D:\\Victor\\Haxe\\haxe\\std/sys/thread/EventLoop.hx",240,0x1f760ec8)
namespace sys{
namespace thread{
namespace _EventLoop{

void RegularEvent_obj::__construct( ::Dynamic run,Float nextRunTime,Float interval){
            	HX_STACKFRAME(&_hx_pos_afedbd938a05bbc5_240_new)
