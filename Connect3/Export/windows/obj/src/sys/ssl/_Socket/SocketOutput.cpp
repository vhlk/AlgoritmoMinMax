...
HX_DEFINE_STACK_FRAME(_hx_pos_e5326bf3fabe9ada_82_new,"sys.ssl._Socket.SocketOutput","new",0xc0bfe785,"sys.ssl._Socket.SocketOutput.new","D:\\Victor\\Haxe\\haxe\\std/cpp/_std/sys/ssl/Socket.hx",82,0x8a302ac2)
HX_LOCAL_STACK_FRAME(_hx_pos_e5326bf3fabe9ada_85_writeByte,"sys.ssl._Socket.SocketOutput","writeByte",0x9388946c,"sys.ssl._Socket.SocketOutput.writeByte","D:\\Victor\\Haxe\\haxe\\std/cpp/_std/sys/ssl/Socket.hx",85,0x8a302ac2)
HX_LOCAL_STACK_FRAME(_hx_pos_e5326bf3fabe9ada_100_writeBytes,"sys.ssl._Socket.SocketOutput","writeBytes",0x83f94a87,"sys.ssl._Socket.SocketOutput.writeBytes","D:\\Victor\\Haxe\\haxe\\std/cpp/_std/sys/ssl/Socket.hx",100,0x8a302ac2)
HX_LOCAL_STACK_FRAME(_hx_pos_e5326bf3fabe9ada_111_close,"sys.ssl._Socket.SocketOutput","close",0x0d5f021d,"sys.ssl._Socket.SocketOutput.close","D:\\Victor\\Haxe\\haxe\\std/cpp/_std/sys/ssl/Socket.hx",111,0x8a302ac2)
namespace sys{
namespace ssl{
namespace _Socket{

void SocketOutput_obj::__construct( ::sys::ssl::Socket s){
            	HX_STACKFRAME(&_hx_pos_e5326bf3fabe9ada_82_new)
...
void SocketOutput_obj::writeByte(int c){
            	HX_STACKFRAME(&_hx_pos_e5326bf3fabe9ada_85_writeByte)
...
int SocketOutput_obj::writeBytes( ::haxe::io::Bytes buf,int pos,int len){
            	HX_STACKFRAME(&_hx_pos_e5326bf3fabe9ada_100_writeBytes)
HXDLIN( 100)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
...
void SocketOutput_obj::close(){
            	HX_STACKFRAME(&_hx_pos_e5326bf3fabe9ada_111_close)
