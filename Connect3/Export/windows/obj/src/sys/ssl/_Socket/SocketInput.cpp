...
HX_DEFINE_STACK_FRAME(_hx_pos_1ac989ddd3a62beb_36_new,"sys.ssl._Socket.SocketInput","new",0x0d9c972a,"sys.ssl._Socket.SocketInput.new","D:\\Victor\\Haxe\\haxe\\std/cpp/_std/sys/ssl/Socket.hx",36,0x8a302ac2)
HX_LOCAL_STACK_FRAME(_hx_pos_1ac989ddd3a62beb_40_readByte,"sys.ssl._Socket.SocketInput","readByte",0xa45b5674,"sys.ssl._Socket.SocketInput.readByte","D:\\Victor\\Haxe\\haxe\\std/cpp/_std/sys/ssl/Socket.hx",40,0x8a302ac2)
HX_LOCAL_STACK_FRAME(_hx_pos_1ac989ddd3a62beb_53_readBytes,"sys.ssl._Socket.SocketInput","readBytes",0x2b904f7f,"sys.ssl._Socket.SocketInput.readBytes","D:\\Victor\\Haxe\\haxe\\std/cpp/_std/sys/ssl/Socket.hx",53,0x8a302ac2)
HX_LOCAL_STACK_FRAME(_hx_pos_1ac989ddd3a62beb_71_close,"sys.ssl._Socket.SocketInput","close",0xce82a502,"sys.ssl._Socket.SocketInput.close","D:\\Victor\\Haxe\\haxe\\std/cpp/_std/sys/ssl/Socket.hx",71,0x8a302ac2)
namespace sys{
namespace ssl{
namespace _Socket{

void SocketInput_obj::__construct( ::sys::ssl::Socket s){
            	HX_STACKFRAME(&_hx_pos_1ac989ddd3a62beb_36_new)
...
int SocketInput_obj::readByte(){
            	HX_GC_STACKFRAME(&_hx_pos_1ac989ddd3a62beb_40_readByte)
HXDLIN(  40)		try {
...
int SocketInput_obj::readBytes( ::haxe::io::Bytes buf,int pos,int len){
            	HX_GC_STACKFRAME(&_hx_pos_1ac989ddd3a62beb_53_readBytes)
HXLINE(  54)		int r;
...
void SocketInput_obj::close(){
            	HX_STACKFRAME(&_hx_pos_1ac989ddd3a62beb_71_close)
