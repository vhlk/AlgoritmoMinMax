...
HX_DEFINE_STACK_FRAME(_hx_pos_0b47de36a3ac0ac4_48_new,"sys.Http","new",0xa5e0041b,"sys.Http.new","D:\\Victor\\Haxe\\haxe\\std/sys/Http.hx",48,0xa7fdcab9)
HX_LOCAL_STACK_FRAME(_hx_pos_0b47de36a3ac0ac4_60_request,"sys.Http","request",0xbb950c8a,"sys.Http.request","D:\\Victor\\Haxe\\haxe\\std/sys/Http.hx",60,0xa7fdcab9)
HX_LOCAL_STACK_FRAME(_hx_pos_0b47de36a3ac0ac4_56_request,"sys.Http","request",0xbb950c8a,"sys.Http.request","D:\\Victor\\Haxe\\haxe\\std/sys/Http.hx",56,0xa7fdcab9)
static const bool _hx_array_data_00b75aa9_3[] = {
	0,
};
HX_LOCAL_STACK_FRAME(_hx_pos_0b47de36a3ac0ac4_90_customRequest,"sys.Http","customRequest",0xecf59319,"sys.Http.customRequest","D:\\Victor\\Haxe\\haxe\\std/sys/Http.hx",90,0xa7fdcab9)
...
HX_LOCAL_STACK_FRAME(_hx_pos_0b47de36a3ac0ac4_209_customRequest,"sys.Http","customRequest",0xecf59319,"sys.Http.customRequest","D:\\Victor\\Haxe\\haxe\\std/sys/Http.hx",209,0xa7fdcab9)
HX_LOCAL_STACK_FRAME(_hx_pos_0b47de36a3ac0ac4_255_writeBody,"sys.Http","writeBody",0xc731a11c,"sys.Http.writeBody","D:\\Victor\\Haxe\\haxe\\std/sys/Http.hx",255,0xa7fdcab9)
HX_LOCAL_STACK_FRAME(_hx_pos_0b47de36a3ac0ac4_280_readHttpResponse,"sys.Http","readHttpResponse",0xd67be204,"sys.Http.readHttpResponse","D:\\Victor\\Haxe\\haxe\\std/sys/Http.hx",280,0xa7fdcab9)
HX_LOCAL_STACK_FRAME(_hx_pos_0b47de36a3ac0ac4_422_readChunk,"sys.Http","readChunk",0x940c4532,"sys.Http.readChunk","D:\\Victor\\Haxe\\haxe\\std/sys/Http.hx",422,0xa7fdcab9)
HX_LOCAL_STACK_FRAME(_hx_pos_0b47de36a3ac0ac4_46_boot,"sys.Http","boot",0x763c9417,"sys.Http.boot","D:\\Victor\\Haxe\\haxe\\std/sys/Http.hx",46,0xa7fdcab9)
namespace sys{

void Http_obj::__construct(::String url){
            	HX_STACKFRAME(&_hx_pos_0b47de36a3ac0ac4_48_new)
...
void Http_obj::request( ::Dynamic post){
            		...
            		void _hx_run(::String e){
            			HX_GC_STACKFRAME(&_hx_pos_0b47de36a3ac0ac4_60_request)
...
HXLINE(  65)			_gthis->onError(e);
            	...
            	HX_GC_STACKFRAME(&_hx_pos_0b47de36a3ac0ac4_56_request)
...
void Http_obj::customRequest(bool post, ::haxe::io::Output api, ::sys::net::Socket sock,::String method){
            	HX_GC_STACKFRAME(&_hx_pos_0b47de36a3ac0ac4_90_customRequest)
...
HXDLIN( 209)				if (!(multipart)) {
            					...
            					bool _hx_run( ::Dynamic h){
            						HX_GC_STACKFRAME(&_hx_pos_0b47de36a3ac0ac4_209_customRequest)
...
void Http_obj::writeBody( ::haxe::io::BytesOutput body, ::haxe::io::Input fileInput,int fileSize,::String boundary, ::sys::net::Socket sock){
            	HX_STACKFRAME(&_hx_pos_0b47de36a3ac0ac4_255_writeBody)
...
void Http_obj::readHttpResponse( ::haxe::io::Output api, ::sys::net::Socket sock){
            	HX_GC_STACKFRAME(&_hx_pos_0b47de36a3ac0ac4_280_readHttpResponse)
...
bool Http_obj::readChunk( ::EReg chunk_re, ::haxe::io::Output api, ::haxe::io::Bytes buf,int len){
            	HX_GC_STACKFRAME(&_hx_pos_0b47de36a3ac0ac4_422_readChunk)
...
{
{
            	HX_STACKFRAME(&_hx_pos_0b47de36a3ac0ac4_46_boot)
