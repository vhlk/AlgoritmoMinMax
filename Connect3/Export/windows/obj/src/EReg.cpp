...
HX_DEFINE_STACK_FRAME(_hx_pos_8e4dc39e6a5d0581_28_new,"EReg","new",0x8b859e81,"EReg.new","D:\\Victor\\Haxe\\haxe\\std/cpp/_std/EReg.hx",28,0xa1d0620b)
HX_LOCAL_STACK_FRAME(_hx_pos_8e4dc39e6a5d0581_36_match,"EReg","match",0x18fda1a6,"EReg.match","D:\\Victor\\Haxe\\haxe\\std/cpp/_std/EReg.hx",36,0xa1d0620b)
HX_LOCAL_STACK_FRAME(_hx_pos_8e4dc39e6a5d0581_45_matched,"EReg","matched",0x8ce62f85,"EReg.matched","D:\\Victor\\Haxe\\haxe\\std/cpp/_std/EReg.hx",45,0xa1d0620b)
HX_LOCAL_STACK_FRAME(_hx_pos_8e4dc39e6a5d0581_62_matchedPos,"EReg","matchedPos",0x7007a70f,"EReg.matchedPos","D:\\Victor\\Haxe\\haxe\\std/cpp/_std/EReg.hx",62,0xa1d0620b)
HX_LOCAL_STACK_FRAME(_hx_pos_8e4dc39e6a5d0581_65_matchSub,"EReg","matchSub",0xbc75cb7a,"EReg.matchSub","D:\\Victor\\Haxe\\haxe\\std/cpp/_std/EReg.hx",65,0xa1d0620b)
HX_LOCAL_STACK_FRAME(_hx_pos_8e4dc39e6a5d0581_74_split,"EReg","split",0x9749433b,"EReg.split","D:\\Victor\\Haxe\\haxe\\std/cpp/_std/EReg.hx",74,0xa1d0620b)
HX_LOCAL_STACK_FRAME(_hx_pos_8e4dc39e6a5d0581_98_replace,"EReg","replace",0xae923ad5,"EReg.replace","D:\\Victor\\Haxe\\haxe\\std/cpp/_std/EReg.hx",98,0xa1d0620b)
...
HX_LOCAL_STACK_FRAME(_hx_pos_8e4dc39e6a5d0581_149_map,"EReg","map",0x8b84d8bd,"EReg.map","D:\\Victor\\Haxe\\haxe\\std/cpp/_std/EReg.hx",149,0xa1d0620b)

void EReg_obj::__construct(::String r,::String opt){
            	HX_STACKFRAME(&_hx_pos_8e4dc39e6a5d0581_28_new)
...
bool EReg_obj::match(::String s){
            	HX_STACKFRAME(&_hx_pos_8e4dc39e6a5d0581_36_match)
...
::String EReg_obj::matched(int n){
            	HX_STACKFRAME(&_hx_pos_8e4dc39e6a5d0581_45_matched)
...
HX_DEFINE_DYNAMIC_FUNC1(EReg_obj,matched,return )
 ...
 ::Dynamic EReg_obj::matchedPos(){
            	HX_STACKFRAME(&_hx_pos_8e4dc39e6a5d0581_62_matchedPos)
...
bool EReg_obj::matchSub(::String s,int pos,::hx::Null< int >  __o_len){
            	...
            	HX_STACKFRAME(&_hx_pos_8e4dc39e6a5d0581_65_matchSub)
HXLINE(  66)		int p;
HXDLIN(  66)		if ((len < 0)) {
...
::Array< ::String > EReg_obj::split(::String s){
            	HX_STACKFRAME(&_hx_pos_8e4dc39e6a5d0581_74_split)
HXLINE(  75)		int pos = 0;
...
::String EReg_obj::replace(::String s,::String by){
            	HX_GC_STACKFRAME(&_hx_pos_8e4dc39e6a5d0581_98_replace)
...
::String EReg_obj::map(::String s, ::Dynamic f){
            	HX_GC_STACKFRAME(&_hx_pos_8e4dc39e6a5d0581_149_map)
